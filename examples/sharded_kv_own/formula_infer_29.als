...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT6->T2) + (PT2->T2) + (PT8->T3) + (PT1->T2) + (NT1->T2)

	path = (PT6 -> (T0->ReshardK1V2N2N1 + T1->RecvTransferMsgN1K1V2 + T2->OwnN1K1)) +
		(PT2 -> (T0->ReshardK1V1N1N1 + T1->RecvTransferMsgN1K1V1 + T2->OwnN1K1)) +
		(PT8 -> (T0->ReshardK1V1N1N1 + T1->ReshardK2V1N1N1 + T2->RecvTransferMsgN1K1V1 + T3->OwnN1K1)) +
		(PT1 -> (T0->OwnN1K1 + T1->ReshardK1V1N1N2 + T2->OwnN1K2)) +
