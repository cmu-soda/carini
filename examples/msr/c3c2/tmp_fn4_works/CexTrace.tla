...
CONSTANTS n1, n2, Server, n3, Quorums, NUM2, NUM3, NUM4, NUM0, NUM1, _n2n3_, _n1n2n3_, FinNat, _n1n3_, _n1n2_

VARIABLES err, log, Fluent25_13, Fluent2, Fluent26_13, cexTraceIdx

vars == <<err, log, Fluent25_13, Fluent2, Fluent26_13, cexTraceIdx>>

NoErr == err = FALSE

CandSep == (\A var0 \in FinNat : (\A var1 \in FinNat : (~(Fluent25_13[var0]) => (Fluent26_13[var1] => var1 <= var0))))
...
/\ UNCHANGED <<Fluent25_13,Fluent26_13>>
/\ CandSep'
/\ UNCHANGED <<Fluent2>>
/\ CandSep'
...
/\ cexTraceIdx = 1 => BecomeLeader(n2,{n2, n3},0) /\ err' = err
/\ cexTraceIdx = 2 => ClientRequest(n2,0) /\ err' = err
/\ cexTraceIdx = 3 => GetEntries(n3,n2) /\ err' = err
/\ cexTraceIdx = 4 => CommitEntry(n2,{n2, n3},1,0,0) /\ err' = err
/\ cexTraceIdx = 5 => BecomeLeader(n2,{n1, n2},1) /\ err' = err
/\ cexTraceIdx = 6 => ClientRequest(n1,1) /\ err' = err
/\ cexTraceIdx = 7 => RollbackEntries(n2,n1) /\ err' = err
/\ cexTraceIdx = 8 => GetEntries(n2,n1) /\ err' = err
/\ cexTraceIdx = 9 => CommitEntry(n2,{n1, n2},1,1,0) /\ err' = TRUE
