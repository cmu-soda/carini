...
do
    ...
    echo "Committed run $i: $elapsed seconds"
done

avg=$(echo "scale=4; $total_time / $num_runs" | bc)
echo "Average time for run_Committed.sh: $avg seconds"
echo "Max time for run_Committed.sh: $max_time seconds"
