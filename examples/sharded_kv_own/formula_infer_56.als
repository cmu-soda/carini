...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT10->T3) + (PT9->T2) + (PT6->T2) + (PT8->T2) + (PT1->T4) + (NT1->T4)

	path = (PT10 -> (T0->ReshardK1V1N1N1 + T1->ReshardK2V1N1N1 + T2->ReshardK2V1N1N2 + T3->RecvTransferMsgN1K1V1)) +
		(PT9 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V1N2N2 + T2->RecvTransferMsgN1K1V1)) +
		(PT6 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V2N2N2 + T2->RecvTransferMsgN1K1V1)) +
		(PT8 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V1N2N2 + T2->RecvTransferMsgN1K2V1)) +
