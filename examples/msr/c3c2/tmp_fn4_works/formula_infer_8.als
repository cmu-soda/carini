...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT20->T2) + (PT5->T1) + (PT15->T2) + (PT1->T6) + (PT6->T2) + (PT22->T2) + (PT21->T2) + (NT1->T6)
	...
	path = (PT20 -> (T0->GetEntriesn1n1 + T1->BecomeLeadern1_n1n2_NUM1 + T2->CommitEntryn1_n1n2_NUM1NUM1NUM1)) +
		...
		(PT6 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->CommitEntryn1_n1n2_NUM1NUM1NUM1)) +
		(PT22 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->GetEntriesn2n1 + T2->CommitEntryn1_n1n2_NUM1NUM1NUM1)) +
