...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT10->T3) + (PT14->T3) + (PT9->T3) + (PT1->T5) + (PT2->T2) + (PT12->T3) + (PT15->T3) + (NT1->T5)

	path = (PT10 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V1N1N2 + T2->RecvTransferMsgN1K1V1 + T3->OwnN1K2)) +
		(PT14 -> (T0->ReshardK2V1N1N1 + T1->ReshardK2V1N1N2 + T2->RecvTransferMsgN1K2V1 + T3->OwnN1K1)) +
		(PT9 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V1N1N1 + T2->ReshardK1V1N1N2 + T3->RecvTransferMsgN1K1V1)) +
		...
		(PT12 -> (T0->ReshardK2V1N1N1 + T1->ReshardK2V1N1N2 + T2->RecvTransferMsgN1K2V1 + T3->PutN1K2V1)) +
		(PT15 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V1N1N2 + T2->RecvTransferMsgN1K1V1 + T3->PutN1K1V1)) +
