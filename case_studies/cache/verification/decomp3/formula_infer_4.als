...
fun envVarTypes : set(Var->Sort) {
	var2->Core + var1->Value + var0->Address
}
...
one sig var2toc1var1tov1var0toa2 extends Env {} {}
one sig var2toc1var0toa1var1tov2 extends Env {} {}
one sig var2toc2var1tov1var0toa1 extends Env {} {}
one sig var2toc1var1tov2var0toa2 extends Env {} {}
one sig var2toc2var1tov1var0toa2 extends Env {} {}
one sig var2toc2var0toa1var1tov2 extends Env {} {}
one sig var2toc2var1tov2var0toa2 extends Env {} {}
...
one sig var2toc1var1tov1var0toa1 extends Env {} {}
one sig var0toa2 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT34->T4) + (PT1->T8) + (PT11->T4) + (PT42->T4) + (PT13->T4) + (PT38->T5) + (PT28->T6) + (PT27->T7) + (PT39->T7) + (PT51->T5) + (PT37->T5) + (PT26->T3) + (PT23->T3) + (PT8->T6) + (PT31->T4) + (PT36->T4) + (PT18->T4) + (PT44->T5) + (PT21->T5) + (PT50->T6) + (PT48->T5) + (PT6->T3) + (PT12->T3) + (PT40->T7) + (PT32->T5) + (PT33->T5) + (PT9->T4) + (PT45->T5) + (PT49->T6) + (PT14->T3) + (PT35->T6) + (PT46->T5) + (PT10->T4) + (PT17->T4) + (PT19->T4) + (PT43->T5) + (NT1->T8)
	...
	path = (PT34 -> (T0->issue_proc_write_sharedc1a1v1 + T1->complete_proc_write_invalidc1a1v1 + T2->evict_modifiedc1a1 + T3->issue_proc_write_sharedc1a1v2 + T4->complete_proc_write_invalidc1a1v2)) +
		...
		(PT49 -> (T0->issue_proc_write_invalidc1a1v1 + T1->complete_proc_write_sharedc1a1v1 + T2->issue_proc_write_sharedc2a1v1 + T3->do_bus_read_for_ownership_invalidc2a1 + T4->complete_proc_write_invalidc2a1v1 + T5->issue_proc_read_invalidc1a2 + T6->do_bus_read_invalidc2a2)) +
	...
	maps = var2toc1var1tov1var0toa2->(var2->c1 + var1->v1 + var0->a2) +
		var2toc1var0toa1var1tov2->(var2->c1 + var0->a1 + var1->v2) +
		var2toc2var1tov1var0toa1->(var2->c2 + var1->v1 + var0->a1) +
		var2toc1var1tov2var0toa2->(var2->c1 + var1->v2 + var0->a2) +
		var2toc2var1tov1var0toa2->(var2->c2 + var1->v1 + var0->a2) +
		var2toc2var0toa1var1tov2->(var2->c2 + var0->a1 + var1->v2) +
		var2toc2var1tov2var0toa2->(var2->c2 + var1->v2 + var0->a2) +
		...
		var0toa1->(var0->a1) +
		var2toc1var1tov1var0toa1->(var2->c1 + var1->v1 + var0->a1) +
		var0toa2->(var0->a2)
