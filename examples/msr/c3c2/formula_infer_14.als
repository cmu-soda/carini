...
one sig CommitEntryn1_n1n2_NUM1NUM0 extends Act {} {
	params = (P0->n1 + P1->_n1n2_ + P2->NUM1 + P3->NUM0)
}
...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT3->T1) + (PT1->T0) + (PT2->T1) + (NT1->T2)

	path = (PT3 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1)) +
		(PT1 -> (T0->BecomeLeadern1_n1n3_NUM1)) +
		(PT2 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->CommitEntryn1_n1n2_NUM1NUM1)) +
		(NT1 -> (T0->ClientRequestn2NUM0 + T1->GetEntriesn1n2 + T2->CommitEntryn1_n1n2_NUM1NUM0))
	...
	baseName = BecomeLeadern1_n1n2_NUM1->BecomeLeader +
		CommitEntryn1_n1n2_NUM1NUM0->CommitEntry +
