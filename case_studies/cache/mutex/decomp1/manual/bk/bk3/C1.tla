...
VARIABLES modified, exclusive, shared, invalid, bus_mode, upgrading, upgraded, state, owning, owned

vars == <<modified, exclusive, shared, invalid, bus_mode, upgrading, upgraded, state, owning, owned>>
...
do_bus_read_invalid(c, a) ==
    /\ invalid[c][a]
    /\ UNCHANGED<<modified, exclusive, shared, invalid>>
    /\ UNCHANGED<<bus_mode, upgrading, upgraded, state, owning, owned>>
    /\ CandSep'
