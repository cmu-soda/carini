...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT25->T3) + (PT27->T4) + (NT1->T5) + (PT23->T4) + (PT26->T4) + (PT28->T4) + (PT24->T3) + (PT22->T3) + (PT29->T2)
	...
	path = (PT25 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->BecomeLeadern2_n2n3_NUM2 + T3->CommitEntryn1_n1n2_NUM1NUM1)) +
		...
		(PT23 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->BecomeLeadern2_n1n2_NUM2 + T3->ClientRequestn2NUM2 + T4->CommitEntryn2_n1n2_NUM1NUM2)) +
		...
		(PT22 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->BecomeLeadern2_n2n3_NUM2 + T2->CommitEntryn1_n1n3_NUM1NUM1 + T3->CommitEntryn2_n1n2_NUM1NUM2)) +
