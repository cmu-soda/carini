...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT1->T6) + (NT1->T9)

	path = (PT1 -> (T0->Phase1ba1NUM0 + T1->Phase1ba1NUM1 + T2->Phase1ba2NUM0 + T3->Phase1ba2NUM1 + T4->Phase2aNUM0v1a1 + T5->Phase2aNUM1v2a2 + T6->Phase2ba3NUM0v1)) +
		(NT1 -> (T0->Phase1ba1NUM0 + T1->Phase1ba1NUM1 + T2->Phase1ba2NUM0 + T3->Phase1ba2NUM1 + T4->Phase2aNUM0v1a1 + T5->Phase2aNUM1v2a2 + T6->Phase2ba1NUM0v1 + T7->Phase2ba1NUM0v2 + T8->Phase2ba2NUM0v1 + T9->Phase2ba2NUM0v2))
