...
fun envVarTypes : set(Var->Sort) {
	var3->Value + var2->Node + var1->Value + var0->Node
}
...
one sig var3toV1var0toN2var1toV2var2toN1 extends Env {} {}
one sig var3toV1var0toN2var2toN2var1toV1 extends Env {} {}
one sig var3toV1var2toN2var1toV2var0toN1 extends Env {} {}
one sig var0toN2var1toV1var2toN1var3toV2 extends Env {} {}
one sig var1toV2var0toN1var2toN1var3toV2 extends Env {} {}
one sig var2toN2var1toV1var0toN1var3toV2 extends Env {} {}
one sig var3toV1var0toN2var2toN2var1toV2 extends Env {} {}
one sig var0toN2var1toV2var2toN1var3toV2 extends Env {} {}
one sig var0toN2var2toN2var1toV1var3toV2 extends Env {} {}
one sig var2toN2var1toV2var0toN1var3toV2 extends Env {} {}
one sig var0toN2var2toN2var1toV2var3toV2 extends Env {} {}
one sig var0toN2var2toN2var1toV2 extends Env {} {}
one sig var0toN2 extends Env {} {}
one sig var0toN2var1toV2var2toN1 extends Env {} {}
one sig var0toN2var2toN2var1toV1 extends Env {} {}
one sig var2toN2var1toV2var0toN1 extends Env {} {}
one sig var0toN1 extends Env {} {}
one sig var0toN2var1toV1var2toN1 extends Env {} {}
one sig var1toV2var0toN1var2toN1 extends Env {} {}
one sig var2toN2var1toV1var0toN1 extends Env {} {}
one sig var1toV1var0toN1var2toN1 extends Env {} {}
one sig var0toN2var1toV2 extends Env {} {}
one sig var3toV1var1toV1var0toN1var2toN1 extends Env {} {}
one sig var1toV1var0toN1 extends Env {} {}
one sig var3toV1var0toN2var1toV1var2toN1 extends Env {} {}
one sig var3toV1var1toV2var0toN1var2toN1 extends Env {} {}
one sig var3toV1var2toN2var1toV1var0toN1 extends Env {} {}
one sig var1toV1var0toN1var2toN1var3toV2 extends Env {} {}
one sig var0toN2var1toV1 extends Env {} {}
one sig var1toV2var0toN1 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT3->T2) + (PT7->T2) + (PT4->T2) + (PT5->T2) + (PT1->T4) + (NT1->T4)

	path = (PT3 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V1N2N2 + T2->RecvTransferMsgN1K1V1)) +
		(PT7 -> (T0->ReshardK1V1N1N1 + T1->ReshardK2V1N1N1 + T2->RecvTransferMsgN1K1V1)) +
		(PT4 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V2N2N1 + T2->RecvTransferMsgN1K1V1)) +
		(PT5 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V1N2N2 + T2->RecvTransferMsgN1K2V1)) +
	...
	maps = var3toV1var0toN2var1toV2var2toN1->(var3->V1 + var0->N2 + var1->V2 + var2->N1) +
		var3toV1var0toN2var2toN2var1toV1->(var3->V1 + var0->N2 + var2->N2 + var1->V1) +
		var3toV1var2toN2var1toV2var0toN1->(var3->V1 + var2->N2 + var1->V2 + var0->N1) +
		var0toN2var1toV1var2toN1var3toV2->(var0->N2 + var1->V1 + var2->N1 + var3->V2) +
		var1toV2var0toN1var2toN1var3toV2->(var1->V2 + var0->N1 + var2->N1 + var3->V2) +
		var2toN2var1toV1var0toN1var3toV2->(var2->N2 + var1->V1 + var0->N1 + var3->V2) +
		var3toV1var0toN2var2toN2var1toV2->(var3->V1 + var0->N2 + var2->N2 + var1->V2) +
		var0toN2var1toV2var2toN1var3toV2->(var0->N2 + var1->V2 + var2->N1 + var3->V2) +
		var0toN2var2toN2var1toV1var3toV2->(var0->N2 + var2->N2 + var1->V1 + var3->V2) +
		var2toN2var1toV2var0toN1var3toV2->(var2->N2 + var1->V2 + var0->N1 + var3->V2) +
		var0toN2var2toN2var1toV2var3toV2->(var0->N2 + var2->N2 + var1->V2 + var3->V2) +
		var0toN2var2toN2var1toV2->(var0->N2 + var2->N2 + var1->V2) +
		var0toN2->(var0->N2) +
		var0toN2var1toV2var2toN1->(var0->N2 + var1->V2 + var2->N1) +
		var0toN2var2toN2var1toV1->(var0->N2 + var2->N2 + var1->V1) +
		var2toN2var1toV2var0toN1->(var2->N2 + var1->V2 + var0->N1) +
		var0toN1->(var0->N1) +
		var0toN2var1toV1var2toN1->(var0->N2 + var1->V1 + var2->N1) +
		var1toV2var0toN1var2toN1->(var1->V2 + var0->N1 + var2->N1) +
		var2toN2var1toV1var0toN1->(var2->N2 + var1->V1 + var0->N1) +
		var1toV1var0toN1var2toN1->(var1->V1 + var0->N1 + var2->N1) +
		var0toN2var1toV2->(var0->N2 + var1->V2) +
		var3toV1var1toV1var0toN1var2toN1->(var3->V1 + var1->V1 + var0->N1 + var2->N1) +
		var1toV1var0toN1->(var1->V1 + var0->N1) +
		var3toV1var0toN2var1toV1var2toN1->(var3->V1 + var0->N2 + var1->V1 + var2->N1) +
		var3toV1var1toV2var0toN1var2toN1->(var3->V1 + var1->V2 + var0->N1 + var2->N1) +
		var3toV1var2toN2var1toV1var0toN1->(var3->V1 + var2->N2 + var1->V1 + var0->N1) +
		var1toV1var0toN1var2toN1var3toV2->(var1->V1 + var0->N1 + var2->N1 + var3->V2) +
		var0toN2var1toV1->(var0->N2 + var1->V1) +
		var1toV2var0toN1->(var1->V2 + var0->N1)
