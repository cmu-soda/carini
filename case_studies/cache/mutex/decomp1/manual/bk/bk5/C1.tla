...
VARIABLES modified, exclusive, shared, invalid, bus_mode, upgrading, upgraded, state, owning, owned, transfer

vars == <<modified, exclusive, shared, invalid, bus_mode, upgrading, upgraded, state, owning, owned, transfer>>
