...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT23->T2) + (PT28->T2) + (PT21->T2) + (PT1->T3) + (PT16->T2) + (PT27->T2) + (PT25->T2) + (PT13->T1) + (PT10->T1) + (PT22->T1) + (PT14->T1) + (PT6->T1) + (PT5->T1) + (PT20->T2) + (PT4->T1) + (PT24->T2) + (PT31->T3) + (PT19->T2) + (PT3->T1) + (PT12->T1) + (PT7->T1) + (PT11->T1) + (PT17->T2) + (PT18->T2) + (PT15->T2) + (PT26->T2) + (PT29->T1) + (PT30->T2) + (NT1->T3)

	path = (PT23 -> (T0->Phase2ba1NUM0v1 + T1->Phase2aNUM1v1a1 + T2->Phase2ba2NUM1v1)) +
		(PT28 -> (T0->Phase2aNUM0v2a1 + T1->Phase2aNUM1v1a1 + T2->Phase2ba2NUM1v1)) +
		...
		(PT10 -> (T0->Phase2aNUM1v1a1 + T1->Phase2aNUM1v2a1)) +
	...
	maps = var1toNUM0var0tov1var2toa1->(var1->NUM0 + var0->v1 + var2->a1) +
		var0tov1->(var0->v1) +
		var0tov2->(var0->v2) +
