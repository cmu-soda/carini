...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT35->T2) + (PT13->T1) + (PT7->T1) + (PT25->T2) + (PT30->T2) + (PT17->T2) + (PT36->T2) + (PT11->T1) + (PT23->T2) + (PT20->T3) + (PT15->T1) + (PT34->T2) + (PT24->T2) + (PT29->T2) + (PT10->T1) + (PT1->T2) + (PT33->T2) + (PT26->T3) + (PT21->T3) + (PT8->T0) + (PT22->T3) + (PT14->T1) + (NT1->T3)

	path = (PT35 -> (T0->Phase2aNUM0v1a2 + T1->Phase2aNUM0v1a1 + T2->Phase2ba1NUM0v1)) +
		(PT13 -> (T0->Phase2aNUM0v1a1 + T1->Phase2ba1NUM0v2)) +
		(PT7 -> (T0->Phase2aNUM2v1a1 + T1->Phase2ba1NUM2v1)) +
