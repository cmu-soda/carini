...
abstract sig Trace {
    ...
    all e : Env, i : Idx, s : FlSymAction | e->i->s in initiates iff
        let a = i.path |
        let isInitAct = some s and concreteMatchesSymAction[e,a,s] and e->i->s.target in satisfies |
        let isTermAct = some s and concreteMatchesSymAction[e,a,s] and e->i->s.target not in satisfies |
	...
	all e : Env, i : Idx, f : FluentWrapper | e->i->f in satisfies iff
        let a = i.path |
...
fact PartialInstance {
	lastIdx = (PT1->T5) + (PT11->T4) + (PT16->T5) + (PT17->T4) + (PT12->T4) + (PT15->T4) + (PT24->T6) + (PT14->T4) + (PT21->T6) + (PT22->T3) + (PT20->T4) + (PT23->T3) + (NT1->T4)

	path = (PT1 -> (T0->ReshardK1V1N1N1 + T1->RecvTransferMsgN1K1V1 + T2->ReshardK1V1N1N2 + T3->RecvTransferMsgN2K1V1 + T4->ReshardK1V1N1N1)) +
		(PT11 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V2N2N1 + T2->RecvTransferMsgN1K1V2 + T3->RecvTransferMsgN1K1V1)) +
		(PT16 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V2N2N1 + T2->ReshardK2V1N1N1 + T3->RecvTransferMsgN1K1V1 + T4->RecvTransferMsgN1K2V1)) +
		(PT17 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V1N1N1 + T2->RecvTransferMsgN1K1V1 + T3->RecvTransferMsgN1K2V1)) +
		(PT12 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V2N2N1 + T2->RecvTransferMsgN1K1V1 + T3->RecvTransferMsgN1K1V2)) +
		(PT15 -> (T0->ReshardK2V2N1N1 + T1->ReshardK1V1N1N1 + T2->RecvTransferMsgN1K1V1 + T3->RecvTransferMsgN1K2V2)) +
		(PT24 -> (T0->ReshardK1V2N2N1 + T1->ReshardK1V1N1N1 + T2->ReshardK1V1N2N2 + T3->RecvTransferMsgN1K1V1 + T4->RecvTransferMsgN2K1V1 + T5->RecvTransferMsgN1K1V2)) +
		(PT14 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V2N2N1 + T2->RecvTransferMsgN1K2V1 + T3->RecvTransferMsgN1K1V2)) +
		(PT21 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V1N1N1 + T2->ReshardK2V1N1N2 + T3->RecvTransferMsgN1K1V1 + T4->RecvTransferMsgN1K2V1 + T5->RecvTransferMsgN2K2V1)) +
		(PT22 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V1N1N2 + T2->RecvTransferMsgN1K2V1)) +
		(PT20 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V1N2N2 + T2->RecvTransferMsgN2K1V1 + T3->RecvTransferMsgN1K1V1)) +
		(PT23 -> (T0->ReshardK1V2N1N1 + T1->ReshardK1V1N1N2 + T2->RecvTransferMsgN1K1V2)) +
		(NT1 -> (T0->ReshardK1V1N1N1 + T1->RecvTransferMsgN1K1V1 + T2->ReshardK1V1N1N2 + T3->RecvTransferMsgN1K1V1))

	maps = var1toN1var0toV2var2toK1->(var1->N1 + var0->V2 + var2->K1) +
