...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT88->T5) + (PT89->T5) + (PT64->T4) + (PT92->T5) + (PT62->T4) + (PT95->T6) + (PT90->T5) + (PT71->T5) + (PT77->T5) + (PT91->T4) + (PT93->T5) + (PT87->T5) + (PT82->T6) + (PT81->T4) + (PT94->T7) + (PT85->T4) + (PT86->T5) + (PT80->T6) + (PT61->T4) + (PT72->T3) + (PT65->T3) + (PT84->T5) + (PT73->T3) + (PT66->T4) + (PT74->T6) + (PT70->T4) + (PT54->T2) + (PT83->T5) + (PT1->T6) + (PT67->T4) + (PT75->T5) + (PT76->T4) + (NT1->T6)

	path = (PT88 -> (T0->ReshardK1V1N1N1 + T1->ReshardK2V1N1N1 + T2->RecvTransferMsgN1K1V1 + T3->PutN1K1V1 + T4->ReshardK2V1N1N2 + T5->RecvTransferMsgN1K2V1)) +
		...
		(PT70 -> (T0->OwnN1K1 + T1->ReshardK1V1N1N1 + T2->ReshardK1V1N2N2 + T3->RecvTransferMsgN1K1V1 + T4->RecvTransferMsgN2K1V1)) +
