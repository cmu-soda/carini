...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT12->T3) + (PT1->T8) + (PT22->T4) + (PT24->T4) + (PT11->T4) + (PT13->T4) + (PT7->T4) + (PT15->T5) + (PT9->T4) + (PT26->T3) + (PT23->T3) + (PT8->T6) + (PT31->T4) + (PT10->T4) + (PT18->T4) + (PT21->T5) + (PT19->T4) + (NT1->T8)

	path = (PT12 -> (T0->evict_modifiedc1a2 + T1->issue_proc_write_invalidc1a1v1 + T2->do_bus_read_for_ownership_invalidc2a1 + T3->complete_proc_write_invalidc1a1v1)) +
		...
		(PT22 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_invalidc2a1 + T2->complete_proc_read_invalid_exclusivec1a1v1 + T3->issue_proc_write_sharedc1a2v2 + T4->complete_proc_write_invalidc1a2v2)) +
		(PT24 -> (T0->issue_proc_write_sharedc1a1v1 + T1->complete_proc_write_invalidc1a1v1 + T2->issue_proc_read_invalidc1a2 + T3->do_bus_read_invalidc2a2 + T4->complete_proc_read_invalid_exclusivec1a2v2)) +
