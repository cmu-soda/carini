...
one sig complete_proc_read_invalid_exclusivec2a1v1 extends Act {} {
	params = (P0->c2 + P1->a1 + P2->v1)
}
one sig complete_proc_read_invalid_exclusivec1a1v1 extends Act {} {
	params = (P0->c1 + P1->a1 + P2->v1)
}
one sig complete_proc_read_invalid_exclusivec1a2v1 extends Act {} {
...
one sig proc_write_exclusivec2a1v2 extends Act {} {
	params = (P0->c2 + P1->a1 + P2->v2)
}
one sig proc_write_exclusivec1a1v2 extends Act {} {
	params = (P0->c1 + P1->a1 + P2->v2)
}
one sig proc_write_exclusivec1a1v1 extends Act {} {
	params = (P0->c1 + P1->a1 + P2->v1)
}
...
fact {
	...
	complete_proc_read_invalid_exclusive in FlSymAction.baseName // the final base name in the neg trace must appear in the sep formula
}


fun envVarTypes : set(Var->Sort) {
	var2->Address + var1->Value + var0->Address
}
...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT1->T10) + (PT6->T4) + (PT3->T3) + (PT8->T3) + (NT1->T10)

	path = (PT1 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_invalidc2a1 + T2->complete_proc_read_invalid_exclusivec1a1v1 + T3->evict_exclusive_or_sharedc1a1 + T4->issue_proc_read_invalidc2a1 + T5->do_bus_read_invalidc1a1 + T6->complete_proc_read_invalid_exclusivec2a1v1 + T7->proc_write_exclusivec2a1v2 + T8->issue_proc_read_invalidc1a2 + T9->do_bus_read_invalidc2a2 + T10->complete_proc_read_invalid_exclusivec1a2v1)) +
		(PT6 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_invalidc2a1 + T2->complete_proc_read_invalid_exclusivec1a1v1 + T3->issue_proc_read_invalidc1a2 + T4->do_bus_read_invalidc2a2)) +
		(PT3 -> (T0->proc_write_exclusivec1a1v2 + T1->issue_proc_read_invalidc1a1 + T2->do_bus_read_invalidc2a1 + T3->complete_proc_read_invalid_exclusivec1a1v1)) +
		(PT8 -> (T0->proc_write_exclusivec1a1v1 + T1->issue_proc_read_invalidc1a1 + T2->do_bus_read_invalidc2a1 + T3->complete_proc_read_invalid_exclusivec1a1v1)) +
		(NT1 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_invalidc2a1 + T2->complete_proc_read_invalid_exclusivec1a1v1 + T3->evict_exclusive_or_sharedc1a1 + T4->issue_proc_read_invalidc2a1 + T5->do_bus_read_invalidc1a1 + T6->complete_proc_read_invalid_exclusivec2a1v1 + T7->proc_write_exclusivec2a1v2 + T8->issue_proc_read_invalidc1a2 + T9->do_bus_read_invalidc2a2 + T10->complete_proc_read_invalid_exclusivec1a1v1))
	...
	baseName = do_bus_read_invalidc2a2->do_bus_read_invalid +
		do_bus_read_invalidc2a1->do_bus_read_invalid +
		issue_proc_read_invalidc1a1->issue_proc_read_invalid +
		proc_write_exclusivec1a1v2->proc_write_exclusive +
		proc_write_exclusivec2a1v2->proc_write_exclusive +
		proc_write_exclusivec1a1v1->proc_write_exclusive +
		complete_proc_read_invalid_exclusivec2a1v1->complete_proc_read_invalid_exclusive +
		complete_proc_read_invalid_exclusivec1a1v1->complete_proc_read_invalid_exclusive +
		complete_proc_read_invalid_exclusivec1a2v1->complete_proc_read_invalid_exclusive +
