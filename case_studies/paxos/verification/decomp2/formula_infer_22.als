...
fun envVarTypes : set(Var->Sort) {
	var2->Quorum + var1->Value + var0->Value
}
...
one sig var2to_a1a2_var0tov2var1tov2 extends Env {} {}
one sig var2to_a1a2a3_var1tov1var0tov2 extends Env {} {}
one sig var2to_a1a2a3_var0tov1var1tov2 extends Env {} {}
one sig var2to_a1a2a3_var0tov2var1tov2 extends Env {} {}
one sig var0tov1 extends Env {} {}
one sig var1tov1var0tov1var2to_a2a3_ extends Env {} {}
one sig var0tov2 extends Env {} {}
one sig var1tov1var0tov1 extends Env {} {}
one sig var2to_a1a3_var1tov1var0tov2 extends Env {} {}
one sig var2to_a1a3_var0tov1var1tov2 extends Env {} {}
one sig var2to_a2a3_var0tov2var1tov2 extends Env {} {}
one sig var1tov1var0tov2 extends Env {} {}
one sig var0tov1var1tov2 extends Env {} {}
one sig var2to_a1a2_var1tov1var0tov1 extends Env {} {}
one sig var2to_a1a3_var1tov1var0tov1 extends Env {} {}
one sig var1tov1var2to_a2a3_var0tov2 extends Env {} {}
one sig var0tov1var2to_a2a3_var1tov2 extends Env {} {}
one sig var0tov2var1tov2 extends Env {} {}
one sig var2to_a1a3_var0tov2var1tov2 extends Env {} {}
one sig var2to_a1a2a3_var1tov1var0tov1 extends Env {} {}
one sig var2to_a1a2_var1tov1var0tov2 extends Env {} {}
one sig var2to_a1a2_var0tov1var1tov2 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT1->T1) + (PT19->T1) + (PT7->T1) + (PT17->T2) + (PT13->T1) + (PT16->T2) + (PT18->T2) + (PT10->T0) + (NT1->T2)
	...
	maps = var2to_a1a2_var0tov2var1tov2->(var2->_a1a2_ + var0->v2 + var1->v2) +
		var2to_a1a2a3_var1tov1var0tov2->(var2->_a1a2a3_ + var1->v1 + var0->v2) +
		var2to_a1a2a3_var0tov1var1tov2->(var2->_a1a2a3_ + var0->v1 + var1->v2) +
		var2to_a1a2a3_var0tov2var1tov2->(var2->_a1a2a3_ + var0->v2 + var1->v2) +
		var0tov1->(var0->v1) +
		var1tov1var0tov1var2to_a2a3_->(var1->v1 + var0->v1 + var2->_a2a3_) +
		var0tov2->(var0->v2) +
		var1tov1var0tov1->(var1->v1 + var0->v1) +
		var2to_a1a3_var1tov1var0tov2->(var2->_a1a3_ + var1->v1 + var0->v2) +
		var2to_a1a3_var0tov1var1tov2->(var2->_a1a3_ + var0->v1 + var1->v2) +
		var2to_a2a3_var0tov2var1tov2->(var2->_a2a3_ + var0->v2 + var1->v2) +
		var1tov1var0tov2->(var1->v1 + var0->v2) +
		var0tov1var1tov2->(var0->v1 + var1->v2) +
		var2to_a1a2_var1tov1var0tov1->(var2->_a1a2_ + var1->v1 + var0->v1) +
		var2to_a1a3_var1tov1var0tov1->(var2->_a1a3_ + var1->v1 + var0->v1) +
		var1tov1var2to_a2a3_var0tov2->(var1->v1 + var2->_a2a3_ + var0->v2) +
		var0tov1var2to_a2a3_var1tov2->(var0->v1 + var2->_a2a3_ + var1->v2) +
		var0tov2var1tov2->(var0->v2 + var1->v2) +
		var2to_a1a3_var0tov2var1tov2->(var2->_a1a3_ + var0->v2 + var1->v2) +
		var2to_a1a2a3_var1tov1var0tov1->(var2->_a1a2a3_ + var1->v1 + var0->v1) +
		var2to_a1a2_var1tov1var0tov2->(var2->_a1a2_ + var1->v1 + var0->v2) +
		var2to_a1a2_var0tov1var1tov2->(var2->_a1a2_ + var0->v1 + var1->v2)
