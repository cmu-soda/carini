...
one sig Phase2ba2NUM2v2 extends Act {} {
	params = (P0->a2 + P1->NUM2 + P2->v2)
}
...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT13->T4) + (PT15->T4) + (PT22->T5) + (PT16->T3) + (PT23->T4) + (PT24->T4) + (PT32->T3) + (PT11->T4) + (PT1->T7) + (PT21->T4) + (PT8->T4) + (PT17->T3) + (PT33->T5) + (PT29->T4) + (PT12->T3) + (PT26->T2) + (PT30->T5) + (PT3->T2) + (PT27->T6) + (PT20->T4) + (PT28->T4) + (PT9->T3) + (PT6->T1) + (PT25->T4) + (PT19->T5) + (PT14->T2) + (PT7->T4) + (PT31->T4) + (PT4->T2) + (NT1->T9)
	...
	path = (PT13 -> (T0->Phase2aNUM0v1a1 + T1->Phase1ba1NUM0 + T2->Phase2aNUM1v2a3 + T3->Phase2ba2NUM0v1 + T4->Phase2ba2NUM1v2)) +
		...
		(PT32 -> (T0->Phase1ba1NUM1 + T1->Phase2aNUM1v1a1 + T2->Phase2ba1NUM1v1 + T3->Phase1ba1NUM2)) +
		...
		(PT33 -> (T0->Phase1ba1NUM0 + T1->Phase1ba1NUM1 + T2->Phase2aNUM0v1a2 + T3->Phase2aNUM1v2a1 + T4->Phase2ba2NUM0v1 + T5->Phase2ba1NUM1v2)) +
		(PT29 -> (T0->Phase1ba1NUM0 + T1->Phase2aNUM0v1a1 + T2->Phase2aNUM1v2a1 + T3->Phase2ba1NUM0v1 + T4->Phase2ba1NUM1v2)) +
		...
		(PT30 -> (T0->Phase1ba1NUM0 + T1->Phase1ba1NUM2 + T2->Phase2aNUM0v1a1 + T3->Phase2aNUM2v2a2 + T4->Phase2ba2NUM0v1 + T5->Phase2ba2NUM2v2)) +
		(PT3 -> (T0->Phase1ba1NUM0 + T1->Phase2aNUM0v1a2 + T2->Phase2ba1NUM0v1)) +
		(PT27 -> (T0->Phase2aNUM0v1a1 + T1->Phase2aNUM1v2a3 + T2->Phase2aNUM2v1a1 + T3->Phase2ba1NUM0v1 + T4->Phase2ba1NUM1v2 + T5->Phase2ba2NUM1v2 + T6->Phase2ba2NUM2v1)) +
		(PT20 -> (T0->Phase2aNUM0v1a1 + T1->Phase2aNUM1v2a3 + T2->Phase2ba1NUM0v1 + T3->Phase2ba1NUM1v2 + T4->Phase2ba2NUM0v1)) +
		(PT28 -> (T0->Phase1ba1NUM1 + T1->Phase2aNUM1v1a1 + T2->Phase2ba1NUM1v1 + T3->Phase2aNUM2v2a1 + T4->Phase2ba1NUM2v2)) +
		...
		(PT31 -> (T0->Phase1ba1NUM0 + T1->Phase2aNUM0v1a1 + T2->Phase2aNUM1v2a1 + T3->Phase2ba1NUM0v1 + T4->Phase2ba1NUM1v2)) +
