...
one sig n1, n2, k1, k2, NUM2, v1, v2, NUM1 extends Atom {}
...
one sig recv_ack_msg extends BaseName {} {
	paramIdxs = P0 + P1 + P2
	paramTypes = P0->Node + P1->Node + P2->Seqnum
}
...
fact {
	...
	recv_transfer_msg in FlSymAction.baseName // the final base name in the neg trace must appear in the sep formula
}
...
fact PartialInstance {
	...
	path = (PT1 -> (T0->reshardn1n1k1v1NUM1 + T1->recv_transfer_msgn1n1k1v1NUM1)) +
		(NT1 -> (T0->reshardn1n1k1v1NUM1 + T1->recv_transfer_msgn1n1k1v1NUM1 + T2->recv_transfer_msgn1n1k1v1NUM1))
	...
	baseName = reshardn1n1k1v1NUM1->reshard +
