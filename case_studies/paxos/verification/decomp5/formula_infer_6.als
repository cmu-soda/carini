...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT30->T5) + (PT23->T4) + (PT32->T3) + (PT1->T7) + (PT6->T1) + (PT21->T4) + (PT8->T4) + (PT25->T4) + (PT19->T5) + (PT17->T3) + (PT14->T2) + (PT33->T5) + (PT29->T4) + (PT26->T2) + (NT1->T9)

	path = (PT30 -> (T0->Phase1ba1NUM0 + T1->Phase1ba1NUM2 + T2->Phase2aNUM0v1a1 + T3->Phase2aNUM2v2a2 + T4->Phase2ba2NUM0v1 + T5->Phase2ba2NUM2v2)) +
