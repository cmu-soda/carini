...
fun envVarTypes : set(Var->Sort) {
	var2->Value + var1->Acceptor + var0->Value
}
...
one sig var1toa3var0tov2var2tov2 extends Env {} {}
...
one sig var1toa3var0tov1var2tov1 extends Env {} {}
...
one sig var1toa3var2tov1var0tov2 extends Env {} {}
one sig var0tov2var2tov2var1toa2 extends Env {} {}
one sig var1toa3var0tov1var2tov2 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT7->T2) + (PT6->T2) + (PT11->T2) + (PT5->T2) + (PT9->T2) + (PT1->T2) + (NT1->T2)

	path = (PT7 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2ba1NUM0v1)) +
	...
	maps = var1toa3var0tov2->(var1->a3 + var0->v2) +
		var1toa3var0tov2var2tov2->(var1->a3 + var0->v2 + var2->v2) +
		var0tov1var1toa1var2tov1->(var0->v1 + var1->a1 + var2->v1) +
		var0tov1->(var0->v1) +
		var0tov2->(var0->v2) +
		...
		var1toa3var0tov1var2tov1->(var1->a3 + var0->v1 + var2->v1) +
		...
		var1toa3var2tov1var0tov2->(var1->a3 + var2->v1 + var0->v2) +
		var0tov2var2tov2var1toa2->(var0->v2 + var2->v2 + var1->a2) +
		var1toa3var0tov1var2tov2->(var1->a3 + var0->v1 + var2->v2)
