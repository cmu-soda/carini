...
fun envVarTypes : set(Var->Sort) {
	var2->Key + var1->Value + var0->Seqnum
}
...
one sig var2tok1var1tov1var0toNUM2 extends Env {} {}
one sig var2tok1var0toNUM1var1tov2 extends Env {} {}
one sig var2tok2var1tov1var0toNUM1 extends Env {} {}
one sig var2tok1var1tov1var0toNUM1 extends Env {} {}
one sig var0toNUM1 extends Env {} {}
one sig var0toNUM2 extends Env {} {}
one sig var1tov1var0toNUM1 extends Env {} {}
one sig var0toNUM2var2tok3var1tov2 extends Env {} {}
one sig var2tok2var0toNUM2var1tov2 extends Env {} {}
one sig var1tov1var0toNUM2var2tok3 extends Env {} {}
one sig var0toNUM1var2tok3var1tov2 extends Env {} {}
one sig var1tov1var0toNUM2 extends Env {} {}
one sig var0toNUM1var1tov2 extends Env {} {}
one sig var2tok1var0toNUM2var1tov2 extends Env {} {}
one sig var2tok2var1tov1var0toNUM2 extends Env {} {}
one sig var2tok2var0toNUM1var1tov2 extends Env {} {}
one sig var1tov1var0toNUM1var2tok3 extends Env {} {}
one sig var0toNUM2var1tov2 extends Env {} {}


fact PartialInstance {
	maps = var2tok1var1tov1var0toNUM2->(var2->k1 + var1->v1 + var0->NUM2) +
		var2tok1var0toNUM1var1tov2->(var2->k1 + var0->NUM1 + var1->v2) +
		var2tok2var1tov1var0toNUM1->(var2->k2 + var1->v1 + var0->NUM1) +
		var2tok1var1tov1var0toNUM1->(var2->k1 + var1->v1 + var0->NUM1) +
		var0toNUM1->(var0->NUM1) +
		var0toNUM2->(var0->NUM2) +
		var1tov1var0toNUM1->(var1->v1 + var0->NUM1) +
		var0toNUM2var2tok3var1tov2->(var0->NUM2 + var2->k3 + var1->v2) +
		var2tok2var0toNUM2var1tov2->(var2->k2 + var0->NUM2 + var1->v2) +
		var1tov1var0toNUM2var2tok3->(var1->v1 + var0->NUM2 + var2->k3) +
		var0toNUM1var2tok3var1tov2->(var0->NUM1 + var2->k3 + var1->v2) +
		var1tov1var0toNUM2->(var1->v1 + var0->NUM2) +
		var0toNUM1var1tov2->(var0->NUM1 + var1->v2) +
		var2tok1var0toNUM2var1tov2->(var2->k1 + var0->NUM2 + var1->v2) +
		var2tok2var1tov1var0toNUM2->(var2->k2 + var1->v1 + var0->NUM2) +
		var2tok2var0toNUM1var1tov2->(var2->k2 + var0->NUM1 + var1->v2) +
		var1tov1var0toNUM1var2tok3->(var1->v1 + var0->NUM1 + var2->k3) +
