...
VARIABLES memory, cache, exclusive, proc_read, proc_write, bus_in_use, bus_read, bus_read_for_ownership, bus_upgrade, bus_transfer

vars == <<memory, cache, exclusive, proc_read, proc_write, bus_in_use, bus_read, bus_read_for_ownership, bus_upgrade, bus_transfer>>
...
issue_proc_read_invalid(c, a) ==
    ...
    /\ UNCHANGED<<memory, cache, exclusive, proc_write, bus_read_for_ownership, bus_upgrade, bus_transfer>>

do_bus_read_invalid(c, a) ==
    /\ bus_read[c][a]
    /\ bus_read' = [bus_read EXCEPT![c][a] = FALSE]
    /\ UNCHANGED<<memory, cache, exclusive, proc_read, proc_write, bus_in_use, bus_read_for_ownership, bus_upgrade, bus_transfer>>
...
complete_proc_read_invalid_shared(c, a, v) ==
    ...
    /\ UNCHANGED<<memory, exclusive, proc_write, bus_read, bus_read_for_ownership, bus_upgrade>>
...
issue_proc_write_invalid(c, a, v) ==
    ...
    /\ UNCHANGED<<memory, cache, exclusive, proc_read, bus_read, bus_upgrade, bus_transfer>>
...
complete_proc_write_invalid(c, a, v) ==
    ...
    /\ UNCHANGED<<memory, exclusive, proc_read, bus_read, bus_read_for_ownership, bus_upgrade>>
...
do_bus_read_for_ownership_invalid(c, a) ==
    ...
    /\ UNCHANGED<<memory, cache, exclusive, proc_read, proc_write, bus_in_use, bus_read, bus_upgrade, bus_transfer>>
...
evict_modified(c, a) ==
    ...
    /\ UNCHANGED<<cache, exclusive, proc_read, proc_write, bus_in_use, bus_read, bus_read_for_ownership, bus_upgrade, bus_transfer>>
...
issue_proc_write_shared(c, a, v) ==
    ...
    /\ UNCHANGED<<memory, cache, exclusive, proc_read, bus_read, bus_read_for_ownership, bus_transfer>>
...
complete_proc_write_shared(c, a, v) ==
    ...
    /\ proc_write' = [proc_write EXCEPT![c][a][v] = FALSE]
    /\ bus_in_use' = FALSE
    /\ UNCHANGED<<memory, exclusive, proc_read, bus_read, bus_read_for_ownership, bus_upgrade, bus_transfer>>
...
do_bus_upgrade(c, a) ==
    ...
    /\ UNCHANGED<<memory, cache, exclusive, proc_read, proc_write, bus_in_use, bus_read, bus_read_for_ownership, bus_transfer>>
