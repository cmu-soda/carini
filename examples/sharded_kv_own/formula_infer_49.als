...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT7->T3) + (PT2->T1) + (PT11->T3) + (PT8->T3) + (PT4->T1) + (PT5->T3) + (PT3->T2) + (PT1->T3) + (NT1->T3)

	path = (PT7 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V1N2N2 + T2->RecvTransferMsgN1K2V1 + T3->RecvTransferMsgN2K1V1)) +
		(PT2 -> (T0->ReshardK1V1N1N1 + T1->RecvTransferMsgN1K1V1)) +
		(PT11 -> (T0->ReshardK1V2N2N1 + T1->ReshardK1V1N2N2 + T2->RecvTransferMsgN2K1V1 + T3->RecvTransferMsgN1K1V2)) +
		(PT8 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V1N2N2 + T2->RecvTransferMsgN2K1V1 + T3->RecvTransferMsgN1K2V1)) +
		(PT4 -> (T0->ReshardK2V1N1N1 + T1->RecvTransferMsgN1K2V1)) +
		(PT5 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V1N2N2 + T2->RecvTransferMsgN1K1V1 + T3->RecvTransferMsgN2K1V1)) +
		(PT3 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V2N2N1 + T2->RecvTransferMsgN1K2V1)) +
		(PT1 -> (T0->OwnN1K1 + T1->ReshardK1V1N1N1 + T2->RecvTransferMsgN1K1V1 + T3->ReshardK1V1N1N1)) +
		(NT1 -> (T0->OwnN1K1 + T1->ReshardK1V1N1N1 + T2->RecvTransferMsgN1K1V1 + T3->RecvTransferMsgN2K1V1))
