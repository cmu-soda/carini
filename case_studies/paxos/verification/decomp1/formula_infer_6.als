...
fun envVarTypes : set(Var->Sort) {
	var2->Ballot + var1->Ballot + var0->Ballot
}
...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT31->T3) + (PT21->T2) + (PT35->T3) + (PT1->T3) + (PT42->T2) + (PT37->T3) + (PT45->T2) + (PT43->T2) + (PT10->T1) + (PT11->T1) + (PT33->T2) + (PT22->T1) + (PT17->T2) + (PT18->T2) + (PT48->T1) + (PT15->T2) + (PT47->T2) + (PT32->T2) + (PT36->T3) + (PT26->T2) + (PT29->T1) + (PT20->T2) + (PT46->T2) + (PT30->T2) + (NT1->T3)

	path = (PT31 -> (T0->Phase2aNUM1v1a1 + T1->Phase2ba1NUM1v1 + T2->Phase2aNUM1v2a2 + T3->Phase2ba2NUM1v1)) +
	...
	maps = var1toNUM0var2toNUM0var0toNUM1->(var1->NUM0 + var2->NUM0 + var0->NUM1) +
