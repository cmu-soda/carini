...
one sig Phase2ba3NUM1v1 extends Act {} {
	params = (P0->a3 + P1->NUM1 + P2->v1)
}
...
one sig Phase2ba2NUM2v1 extends Act {} {
	params = (P0->a2 + P1->NUM2 + P2->v1)
}
...
one sig Phase2aNUM2v1a2 extends Act {} {
	params = (P0->NUM2 + P1->v1 + P2->a2)
}
...
one sig Phase2aNUM2v2a1 extends Act {} {
	params = (P0->NUM2 + P1->v2 + P2->a1)
}
...
fun envVarTypes : set(Var->Sort) {
	var2->Acceptor + var1->Acceptor + var0->Ballot
}
...
one sig var2toa2var1toa3var0toNUM2 extends Env {} {}
one sig var2toa3var0toNUM2var1toa2 extends Env {} {}
one sig var2toa3var1toa3var0toNUM1 extends Env {} {}
one sig var2toa3var1toa3var0toNUM2 extends Env {} {}
one sig var0toNUM1 extends Env {} {}
one sig var0toNUM2 extends Env {} {}
one sig var1toa3var2toa1var0toNUM2 extends Env {} {}
one sig var2toa2var0toNUM2var1toa2 extends Env {} {}
one sig var2toa2var1toa3var0toNUM1 extends Env {} {}
one sig var2toa3var1toa1var0toNUM2 extends Env {} {}
one sig var2toa3var0toNUM1var1toa2 extends Env {} {}
one sig var0toNUM0var2toa3var1toa3 extends Env {} {}
...
one sig var1toa1var2toa1var0toNUM2 extends Env {} {}
one sig var0toNUM1var2toa1var1toa2 extends Env {} {}
one sig var0toNUM0var1toa3var2toa1 extends Env {} {}
one sig var2toa2var0toNUM1var1toa1 extends Env {} {}
one sig var2toa2var0toNUM0var1toa2 extends Env {} {}
one sig var0toNUM0var2toa3var1toa1 extends Env {} {}
one sig var0toNUM0 extends Env {} {}
one sig var2toa1var0toNUM2var1toa2 extends Env {} {}
one sig var1toa3var0toNUM1var2toa1 extends Env {} {}
one sig var2toa2var1toa1var0toNUM2 extends Env {} {}
one sig var2toa2var0toNUM1var1toa2 extends Env {} {}
one sig var2toa2var0toNUM0var1toa3 extends Env {} {}
one sig var2toa3var0toNUM1var1toa1 extends Env {} {}
one sig var0toNUM0var2toa3var1toa2 extends Env {} {}
one sig var0toNUM0var1toa1var2toa1 extends Env {} {}
one sig var0toNUM1var1toa1var2toa1 extends Env {} {}
one sig var0toNUM0var2toa1var1toa2 extends Env {} {}
one sig var2toa2var0toNUM0var1toa1 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT31->T2) + (PT19->T1) + (PT25->T2) + (PT18->T1) + (PT27->T2) + (PT32->T1) + (PT17->T2) + (PT36->T2) + (PT23->T2) + (PT24->T2) + (PT29->T2) + (PT1->T2) + (PT21->T3) + (PT8->T0) + (PT22->T3) + (PT35->T2) + (PT30->T2) + (PT11->T1) + (PT20->T3) + (PT15->T1) + (PT34->T2) + (PT10->T1) + (PT33->T2) + (PT26->T3) + (PT14->T1) + (PT5->T0) + (NT1->T3)

	path = (PT31 -> (T0->Phase2aNUM1v1a1 + T1->Phase2aNUM2v2a2 + T2->Phase2ba3NUM1v1)) +
		(PT19 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba1NUM1v1)) +
		(PT25 -> (T0->Phase2ba1NUM0v1 + T1->Phase2ba1NUM1v1 + T2->Phase2ba1NUM2v1)) +
		(PT18 -> (T0->Phase2aNUM1v1a1 + T1->Phase2ba1NUM1v1)) +
		(PT27 -> (T0->Phase2aNUM0v2a1 + T1->Phase2aNUM2v2a2 + T2->Phase2ba3NUM0v1)) +
		(PT32 -> (T0->Phase2aNUM1v1a1 + T1->Phase2ba3NUM0v1)) +
		(PT17 -> (T0->Phase2aNUM0v1a1 + T1->Phase2aNUM0v2a1 + T2->Phase2ba1NUM0v1)) +
		(PT36 -> (T0->Phase2aNUM0v1a1 + T1->Phase2aNUM1v1a1 + T2->Phase2aNUM2v1a1)) +
		(PT23 -> (T0->Phase2aNUM1v1a1 + T1->Phase2aNUM1v1a2 + T2->Phase2ba1NUM1v1)) +
		(PT24 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba1NUM0v1 + T2->Phase2aNUM0v1a2)) +
		(PT29 -> (T0->Phase2aNUM2v1a1 + T1->Phase2aNUM2v2a2 + T2->Phase2ba2NUM2v1)) +
		(PT1 -> (T0->Phase2aNUM0v1a1 + T1->Phase2aNUM1v2a3 + T2->Phase2aNUM2v1a1)) +
		(PT21 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba1NUM2v1 + T2->Phase2aNUM1v1a2 + T3->Phase2aNUM2v1a2)) +
		(PT8 -> (T0->Phase2ba1NUM0v1)) +
		(PT22 -> (T0->Phase2aNUM0v2a1 + T1->Phase2aNUM1v1a1 + T2->Phase2aNUM2v2a2 + T3->Phase2ba1NUM2v1)) +
		(PT35 -> (T0->Phase2aNUM0v1a2 + T1->Phase2aNUM0v1a1 + T2->Phase2ba1NUM0v1)) +
		(PT30 -> (T0->Phase2aNUM0v1a1 + T1->Phase2aNUM1v1a2 + T2->Phase2aNUM2v1a1)) +
		(PT11 -> (T0->Phase2aNUM1v1a2 + T1->Phase2ba2NUM1v1)) +
		(PT20 -> (T0->Phase2aNUM0v2a1 + T1->Phase2aNUM1v1a1 + T2->Phase2aNUM2v2a2 + T3->Phase2ba1NUM2v1)) +
		(PT15 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba2NUM0v1)) +
		(PT34 -> (T0->Phase2aNUM2v1a1 + T1->Phase2aNUM2v2a1 + T2->Phase2ba2NUM2v1)) +
		(PT10 -> (T0->Phase2aNUM1v1a1 + T1->Phase2ba1NUM1v1)) +
		(PT33 -> (T0->Phase2aNUM2v1a2 + T1->Phase2aNUM2v2a1 + T2->Phase2ba1NUM2v1)) +
		(PT26 -> (T0->Phase2aNUM0v2a1 + T1->Phase2aNUM1v2a3 + T2->Phase2ba1NUM2v1 + T3->Phase2aNUM2v1a2)) +
		(PT14 -> (T0->Phase2aNUM2v1a1 + T1->Phase2ba2NUM2v1)) +
		(PT5 -> (T0->Phase2ba1NUM0v1)) +
		(NT1 -> (T0->Phase2aNUM0v1a1 + T1->Phase2aNUM1v2a3 + T2->Phase2aNUM2v1a1 + T3->Phase2ba1NUM1v2))

	maps = var2toa2var1toa3var0toNUM2->(var2->a2 + var1->a3 + var0->NUM2) +
		var2toa3var0toNUM2var1toa2->(var2->a3 + var0->NUM2 + var1->a2) +
		var2toa3var1toa3var0toNUM1->(var2->a3 + var1->a3 + var0->NUM1) +
		var2toa3var1toa3var0toNUM2->(var2->a3 + var1->a3 + var0->NUM2) +
		var0toNUM1->(var0->NUM1) +
		var0toNUM2->(var0->NUM2) +
		var1toa3var2toa1var0toNUM2->(var1->a3 + var2->a1 + var0->NUM2) +
		var2toa2var0toNUM2var1toa2->(var2->a2 + var0->NUM2 + var1->a2) +
		var2toa2var1toa3var0toNUM1->(var2->a2 + var1->a3 + var0->NUM1) +
		var2toa3var1toa1var0toNUM2->(var2->a3 + var1->a1 + var0->NUM2) +
		var2toa3var0toNUM1var1toa2->(var2->a3 + var0->NUM1 + var1->a2) +
		var0toNUM0var2toa3var1toa3->(var0->NUM0 + var2->a3 + var1->a3) +
		...
		var1toa1var2toa1var0toNUM2->(var1->a1 + var2->a1 + var0->NUM2) +
		var0toNUM1var2toa1var1toa2->(var0->NUM1 + var2->a1 + var1->a2) +
		var0toNUM0var1toa3var2toa1->(var0->NUM0 + var1->a3 + var2->a1) +
		var2toa2var0toNUM1var1toa1->(var2->a2 + var0->NUM1 + var1->a1) +
		var2toa2var0toNUM0var1toa2->(var2->a2 + var0->NUM0 + var1->a2) +
		var0toNUM0var2toa3var1toa1->(var0->NUM0 + var2->a3 + var1->a1) +
		var0toNUM0->(var0->NUM0) +
		var2toa1var0toNUM2var1toa2->(var2->a1 + var0->NUM2 + var1->a2) +
		var1toa3var0toNUM1var2toa1->(var1->a3 + var0->NUM1 + var2->a1) +
		var2toa2var1toa1var0toNUM2->(var2->a2 + var1->a1 + var0->NUM2) +
		var2toa2var0toNUM1var1toa2->(var2->a2 + var0->NUM1 + var1->a2) +
		var2toa2var0toNUM0var1toa3->(var2->a2 + var0->NUM0 + var1->a3) +
		var2toa3var0toNUM1var1toa1->(var2->a3 + var0->NUM1 + var1->a1) +
		var0toNUM0var2toa3var1toa2->(var0->NUM0 + var2->a3 + var1->a2) +
		var0toNUM0var1toa1var2toa1->(var0->NUM0 + var1->a1 + var2->a1) +
		var0toNUM1var1toa1var2toa1->(var0->NUM1 + var1->a1 + var2->a1) +
		var0toNUM0var2toa1var1toa2->(var0->NUM0 + var2->a1 + var1->a2) +
		var2toa2var0toNUM0var1toa1->(var2->a2 + var0->NUM0 + var1->a1)

	baseName = Phase2aNUM2v1a1->Phase2a +
		Phase2aNUM2v1a2->Phase2a +
		Phase2aNUM2v2a1->Phase2a +
		...
		Phase2ba2NUM2v1->Phase2b +
		Phase2ba3NUM0v1->Phase2b +
		Phase2ba3NUM1v1->Phase2b
}
