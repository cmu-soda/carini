...
/\ Fluent33_5 \in [FinNat -> BOOLEAN]
/\ Fluent55_6 \in [Server -> BOOLEAN]
/\ Fluent32_5 \in [FinNat -> BOOLEAN]
/\ Fluent39_1 \in [FinNat -> [Server -> BOOLEAN]]
/\ Fluent56_6 \in [Server -> BOOLEAN]
/\ Fluent40_1 \in [FinNat -> [Server -> BOOLEAN]]
/\ Fluent45_0 \in [FinNat -> BOOLEAN]
/\ Fluent42_3 \in [FinNat -> [Server -> BOOLEAN]]
/\ Fluent46_0 \in [FinNat -> BOOLEAN]
/\ Fluent52_4 \in [Server -> [FinNat -> BOOLEAN]]
/\ Fluent51_4 \in [Server -> [FinNat -> BOOLEAN]]
/\ Fluent41_3 \in [FinNat -> [Server -> BOOLEAN]]
/\ Fluent21_2 \in [FinNat -> [FinNat -> BOOLEAN]]

FinSeq(S) == UNION {[1..n -> S] : n \in FinNat}
TypeOKRand ==
/\ log        \in RandomSubset(4, [Server -> FinSeq(FinNat)])
/\ Fluent33_5 \in RandomSubset(3, [FinNat -> BOOLEAN])
/\ Fluent55_6 \in RandomSubset(3, [Server -> BOOLEAN])
/\ Fluent32_5 \in RandomSubset(3, [FinNat -> BOOLEAN])
/\ Fluent56_6 \in RandomSubset(3, [Server -> BOOLEAN])
/\ Fluent45_0 \in RandomSubset(3, [FinNat -> BOOLEAN])
/\ Fluent46_0 \in RandomSubset(3, [FinNat -> BOOLEAN])
/\ Fluent39_1 \in RandomSubset(3, [FinNat -> [Server -> BOOLEAN]])
/\ Fluent40_1 \in RandomSubset(3, [FinNat -> [Server -> BOOLEAN]])
/\ Fluent42_3 \in RandomSubset(3, [FinNat -> [Server -> BOOLEAN]])
/\ Fluent52_4 \in RandomSubset(3, [Server -> [FinNat -> BOOLEAN]])
/\ Fluent51_4 \in RandomSubset(3, [Server -> [FinNat -> BOOLEAN]])
/\ Fluent41_3 \in RandomSubset(3, [FinNat -> [Server -> BOOLEAN]])
/\ Fluent21_2 \in RandomSubset(3, [FinNat -> [FinNat -> BOOLEAN]])
