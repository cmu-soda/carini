...
fun envVarTypes : set(Var->Sort) {
	var3->Node + var2->Value + var1->Value + var0->Node
}
...
one sig var0toN2var2toV1var1toV2var3toN1 extends Env {} {}
one sig var0toN2var1toV1var2toV2var3toN1 extends Env {} {}
one sig var2toV2var1toV2var0toN1var3toN1 extends Env {} {}
one sig var0toN2var2toV1var1toV1var3toN2 extends Env {} {}
one sig var2toV1var1toV2var0toN1var3toN2 extends Env {} {}
one sig var1toV1var2toV2var0toN1var3toN2 extends Env {} {}
one sig var0toN2var2toV2var1toV2var3toN1 extends Env {} {}
one sig var0toN2var2toV1var1toV2var3toN2 extends Env {} {}
one sig var0toN2var1toV1var2toV2var3toN2 extends Env {} {}
one sig var2toV2var1toV2var0toN1var3toN2 extends Env {} {}
one sig var0toN2var2toV2var1toV2var3toN2 extends Env {} {}
one sig var0toN2 extends Env {} {}
one sig var0toN2var2toV1var1toV2 extends Env {} {}
one sig var0toN2var1toV1var2toV2 extends Env {} {}
one sig var2toV2var1toV2var0toN1 extends Env {} {}
one sig var0toN2var2toV1var1toV1 extends Env {} {}
one sig var2toV1var1toV2var0toN1 extends Env {} {}
one sig var1toV1var2toV2var0toN1 extends Env {} {}
one sig var0toN1 extends Env {} {}
one sig var0toN2var2toV2var1toV2 extends Env {} {}
one sig var0toN2var1toV2 extends Env {} {}
one sig var2toV1var1toV1var0toN1 extends Env {} {}
one sig var2toV1var1toV1var0toN1var3toN1 extends Env {} {}
one sig var1toV1var0toN1 extends Env {} {}
one sig var0toN2var2toV1var1toV1var3toN1 extends Env {} {}
one sig var2toV1var1toV2var0toN1var3toN1 extends Env {} {}
one sig var1toV1var2toV2var0toN1var3toN1 extends Env {} {}
one sig var2toV1var1toV1var0toN1var3toN2 extends Env {} {}
...
fact PartialInstance {
	...
	maps = var0toN2var2toV1var1toV2var3toN1->(var0->N2 + var2->V1 + var1->V2 + var3->N1) +
		var0toN2var1toV1var2toV2var3toN1->(var0->N2 + var1->V1 + var2->V2 + var3->N1) +
		var2toV2var1toV2var0toN1var3toN1->(var2->V2 + var1->V2 + var0->N1 + var3->N1) +
		var0toN2var2toV1var1toV1var3toN2->(var0->N2 + var2->V1 + var1->V1 + var3->N2) +
		var2toV1var1toV2var0toN1var3toN2->(var2->V1 + var1->V2 + var0->N1 + var3->N2) +
		var1toV1var2toV2var0toN1var3toN2->(var1->V1 + var2->V2 + var0->N1 + var3->N2) +
		var0toN2var2toV2var1toV2var3toN1->(var0->N2 + var2->V2 + var1->V2 + var3->N1) +
		var0toN2var2toV1var1toV2var3toN2->(var0->N2 + var2->V1 + var1->V2 + var3->N2) +
		var0toN2var1toV1var2toV2var3toN2->(var0->N2 + var1->V1 + var2->V2 + var3->N2) +
		var2toV2var1toV2var0toN1var3toN2->(var2->V2 + var1->V2 + var0->N1 + var3->N2) +
		var0toN2var2toV2var1toV2var3toN2->(var0->N2 + var2->V2 + var1->V2 + var3->N2) +
		var0toN2->(var0->N2) +
		var0toN2var2toV1var1toV2->(var0->N2 + var2->V1 + var1->V2) +
		var0toN2var1toV1var2toV2->(var0->N2 + var1->V1 + var2->V2) +
		var2toV2var1toV2var0toN1->(var2->V2 + var1->V2 + var0->N1) +
		var0toN2var2toV1var1toV1->(var0->N2 + var2->V1 + var1->V1) +
		var2toV1var1toV2var0toN1->(var2->V1 + var1->V2 + var0->N1) +
		var1toV1var2toV2var0toN1->(var1->V1 + var2->V2 + var0->N1) +
		var0toN1->(var0->N1) +
		var0toN2var2toV2var1toV2->(var0->N2 + var2->V2 + var1->V2) +
		var0toN2var1toV2->(var0->N2 + var1->V2) +
		var2toV1var1toV1var0toN1->(var2->V1 + var1->V1 + var0->N1) +
		var2toV1var1toV1var0toN1var3toN1->(var2->V1 + var1->V1 + var0->N1 + var3->N1) +
		var1toV1var0toN1->(var1->V1 + var0->N1) +
		var0toN2var2toV1var1toV1var3toN1->(var0->N2 + var2->V1 + var1->V1 + var3->N1) +
		var2toV1var1toV2var0toN1var3toN1->(var2->V1 + var1->V2 + var0->N1 + var3->N1) +
		var1toV1var2toV2var0toN1var3toN1->(var1->V1 + var2->V2 + var0->N1 + var3->N1) +
		var2toV1var1toV1var0toN1var3toN2->(var2->V1 + var1->V1 + var0->N1 + var3->N2) +
