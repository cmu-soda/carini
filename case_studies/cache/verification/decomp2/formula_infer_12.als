...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT1->T9) + (NT1->T9)

	path = (PT1 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_invalidc2a1 + T2->complete_proc_read_invalid_exclusivec1a1v1 + T3->evict_exclusive_or_sharedc1a1 + T4->issue_proc_read_invalidc2a1 + T5->do_bus_read_invalidc1a1 + T6->complete_proc_read_invalid_exclusivec2a1v1 + T7->issue_proc_read_invalidc1a2 + T8->do_bus_read_invalidc2a2 + T9->complete_proc_read_invalid_exclusivec1a2v1)) +
		(NT1 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_invalidc2a1 + T2->complete_proc_read_invalid_exclusivec1a1v1 + T3->evict_exclusive_or_sharedc1a1 + T4->issue_proc_read_invalidc2a1 + T5->do_bus_read_invalidc1a1 + T6->complete_proc_read_invalid_exclusivec2a1v1 + T7->issue_proc_read_invalidc1a2 + T8->do_bus_read_invalidc2a2 + T9->complete_proc_read_invalid_exclusivec1a1v1))
