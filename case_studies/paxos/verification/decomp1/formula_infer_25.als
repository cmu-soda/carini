...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT12->T1) + (PT21->T2) + (PT1->T3) + (PT7->T1) + (PT11->T1) + (PT18->T2) + (PT19->T2) + (PT14->T1) + (PT6->T1) + (PT20->T2) + (PT4->T1) + (NT1->T3)

	path = (PT12 -> (T0->Phase2ba1NUM1v1 + T1->Phase2aNUM1v1a2)) +
