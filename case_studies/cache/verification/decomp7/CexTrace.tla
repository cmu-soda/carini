...
VARIABLES Fluent41_6, Fluent42_6, bus_read_for_ownership, bus_transfer, bus_read, bus_upgrade, cexTraceIdx, bus_in_use

vars == <<Fluent41_6, Fluent42_6, bus_read_for_ownership, bus_transfer, bus_read, bus_upgrade, cexTraceIdx, bus_in_use>>

TraceConstraint ==
/\ cexTraceIdx = 0 =>
  /\ bus_transfer = (v1 :> FALSE @@ v2 :> FALSE)
  /\ Fluent41_6 = (c1 :> FALSE @@ c2 :> FALSE @@ c3 :> FALSE)
  /\ bus_read_for_ownership = ( c1 :> (a1 :> FALSE @@ a2 :> FALSE) @@
    c2 :> (a1 :> FALSE @@ a2 :> FALSE) @@
    c3 :> (a1 :> FALSE @@ a2 :> FALSE) )
  /\ bus_in_use = FALSE
  /\ Fluent42_6 = ( c1 :> (a1 :> FALSE @@ a2 :> FALSE) @@
    c2 :> (a1 :> FALSE @@ a2 :> FALSE) @@
    c3 :> (a1 :> FALSE @@ a2 :> FALSE) )
...
/\ cexTraceIdx = 3 =>
  /\ bus_transfer = (v1 :> FALSE @@ v2 :> FALSE)
  /\ Fluent41_6 = (c1 :> FALSE @@ c2 :> TRUE @@ c3 :> FALSE)
  /\ bus_read_for_ownership = ( c1 :> (a1 :> FALSE @@ a2 :> FALSE) @@
    c2 :> (a1 :> FALSE @@ a2 :> FALSE) @@
    c3 :> (a1 :> TRUE @@ a2 :> FALSE) )
  /\ bus_in_use = FALSE
...
CandSep == (\A var0 \in Core : (\E var1 \in Address : (Fluent41_6[var0] => ~(Fluent42_6[var0][var1]))))
