...
one sig BecomeLeadern3_n2n3_NUM2 extends Act {} {
	params = (P0->n3 + P1->_n2n3_ + P2->NUM2)
}
...
one sig CommitEntryn1_n1n3_NUM3NUM1 extends Act {} {
	params = (P0->n1 + P1->_n1n3_ + P2->NUM3 + P3->NUM1)
}
...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT21->T2) + (NT1->T5) + (PT17->T3) + (PT18->T2) + (PT20->T4) + (PT23->T3) + (PT24->T4) + (PT19->T3) + (PT25->T4) + (PT22->T4)

	path = (PT21 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->CommitEntryn1_n1n2_NUM1NUM1)) +
		...
		(PT17 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->BecomeLeadern2_n2n3_NUM2 + T3->ClientRequestn2NUM2)) +
		(PT18 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->CommitEntryn1_n1n3_NUM1NUM1 + T2->BecomeLeadern2_n1n2_NUM2)) +
		(PT20 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->BecomeLeadern2_n1n2_NUM2 + T3->ClientRequestn2NUM2 + T4->CommitEntryn2_n1n2_NUM1NUM2)) +
		(PT23 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->BecomeLeadern2_n2n3_NUM2 + T2->ClientRequestn2NUM2 + T3->CommitEntryn1_n1n2_NUM1NUM1)) +
		(PT24 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->BecomeLeadern2_n2n3_NUM2 + T3->CommitEntryn1_n1n3_NUM2NUM1 + T4->CommitEntryn2_n1n2_NUM1NUM2)) +
		(PT19 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->BecomeLeadern2_n2n3_NUM2 + T2->CommitEntryn1_n1n3_NUM1NUM1 + T3->CommitEntryn2_n1n2_NUM1NUM2)) +
		(PT25 -> (T0->BecomeLeadern1_n1n3_NUM1 + T1->ClientRequestn1NUM1 + T2->BecomeLeadern3_n2n3_NUM2 + T3->ClientRequestn3NUM2 + T4->CommitEntryn1_n1n2_NUM1NUM1)) +
		(PT22 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->BecomeLeadern2_n2n3_NUM2 + T3->CommitEntryn1_n1n3_NUM3NUM1 + T4->ClientRequestn2NUM2))
	...
	baseName = ClientRequestn3NUM2->ClientRequest +
		...
		BecomeLeadern3_n2n3_NUM2->BecomeLeader +
		CommitEntryn1_n1n3_NUM3NUM1->CommitEntry +
