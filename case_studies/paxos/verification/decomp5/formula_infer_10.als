...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT1->T3) + (NT1->T7)

	path = (PT1 -> (T0->Phase1ba1NUM1 + T1->Phase1ba2NUM1 + T2->Phase2aNUM1v1a1 + T3->Phase2aNUM2v2a2)) +
		(NT1 -> (T0->Phase1ba1NUM1 + T1->Phase1ba2NUM1 + T2->Phase2aNUM1v1a1 + T3->Phase2aNUM1v2a2 + T4->Phase2ba1NUM0v2 + T5->Phase2ba1NUM0v1 + T6->Phase2ba2NUM0v1 + T7->Phase2ba2NUM0v2))
