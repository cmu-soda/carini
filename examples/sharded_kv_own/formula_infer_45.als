...
fun envVarTypes : set(Var->Sort) {
	var3->Value + var2->Node + var1->Node + var0->Value
}
...
one sig var3toV1var1toN2var0toV2var2toN1 extends Env {} {}
one sig var3toV1var2toN2var1toN1var0toV2 extends Env {} {}
one sig var3toV1var2toN2var1toN2var0toV1 extends Env {} {}
one sig var1toN1var0toV2var2toN1var3toV2 extends Env {} {}
one sig var1toN2var0toV1var2toN1var3toV2 extends Env {} {}
one sig var2toN2var0toV1var1toN1var3toV2 extends Env {} {}
one sig var3toV1var2toN2var1toN2var0toV2 extends Env {} {}
one sig var1toN2var0toV2var2toN1var3toV2 extends Env {} {}
one sig var2toN2var1toN1var0toV2var3toV2 extends Env {} {}
one sig var2toN2var1toN2var0toV1var3toV2 extends Env {} {}
one sig var2toN2var1toN2var0toV2var3toV2 extends Env {} {}
one sig var2toN2var1toN2var0toV2 extends Env {} {}
one sig var1toN2var0toV2var2toN1 extends Env {} {}
one sig var0toV1 extends Env {} {}
one sig var2toN2var1toN1var0toV2 extends Env {} {}
one sig var2toN2var1toN2var0toV1 extends Env {} {}
one sig var1toN1var0toV2var2toN1 extends Env {} {}
one sig var1toN2var0toV1var2toN1 extends Env {} {}
one sig var0toV2 extends Env {} {}
one sig var2toN2var0toV1var1toN1 extends Env {} {}
one sig var0toV1var1toN1var2toN1 extends Env {} {}
one sig var1toN2var0toV2 extends Env {} {}
one sig var3toV1var0toV1var1toN1var2toN1 extends Env {} {}
one sig var0toV1var1toN1 extends Env {} {}
one sig var3toV1var1toN1var0toV2var2toN1 extends Env {} {}
one sig var3toV1var1toN2var0toV1var2toN1 extends Env {} {}
one sig var3toV1var2toN2var0toV1var1toN1 extends Env {} {}
one sig var0toV1var1toN1var2toN1var3toV2 extends Env {} {}
...
fact PartialInstance {
	...
	maps = var3toV1var1toN2var0toV2var2toN1->(var3->V1 + var1->N2 + var0->V2 + var2->N1) +
		var3toV1var2toN2var1toN1var0toV2->(var3->V1 + var2->N2 + var1->N1 + var0->V2) +
		var3toV1var2toN2var1toN2var0toV1->(var3->V1 + var2->N2 + var1->N2 + var0->V1) +
		var1toN1var0toV2var2toN1var3toV2->(var1->N1 + var0->V2 + var2->N1 + var3->V2) +
		var1toN2var0toV1var2toN1var3toV2->(var1->N2 + var0->V1 + var2->N1 + var3->V2) +
		var2toN2var0toV1var1toN1var3toV2->(var2->N2 + var0->V1 + var1->N1 + var3->V2) +
		var3toV1var2toN2var1toN2var0toV2->(var3->V1 + var2->N2 + var1->N2 + var0->V2) +
		var1toN2var0toV2var2toN1var3toV2->(var1->N2 + var0->V2 + var2->N1 + var3->V2) +
		var2toN2var1toN1var0toV2var3toV2->(var2->N2 + var1->N1 + var0->V2 + var3->V2) +
		var2toN2var1toN2var0toV1var3toV2->(var2->N2 + var1->N2 + var0->V1 + var3->V2) +
		var2toN2var1toN2var0toV2var3toV2->(var2->N2 + var1->N2 + var0->V2 + var3->V2) +
		var2toN2var1toN2var0toV2->(var2->N2 + var1->N2 + var0->V2) +
		var1toN2var0toV2var2toN1->(var1->N2 + var0->V2 + var2->N1) +
		var0toV1->(var0->V1) +
		var2toN2var1toN1var0toV2->(var2->N2 + var1->N1 + var0->V2) +
		var2toN2var1toN2var0toV1->(var2->N2 + var1->N2 + var0->V1) +
		var1toN1var0toV2var2toN1->(var1->N1 + var0->V2 + var2->N1) +
		var1toN2var0toV1var2toN1->(var1->N2 + var0->V1 + var2->N1) +
		var0toV2->(var0->V2) +
		var2toN2var0toV1var1toN1->(var2->N2 + var0->V1 + var1->N1) +
		var0toV1var1toN1var2toN1->(var0->V1 + var1->N1 + var2->N1) +
		var1toN2var0toV2->(var1->N2 + var0->V2) +
		var3toV1var0toV1var1toN1var2toN1->(var3->V1 + var0->V1 + var1->N1 + var2->N1) +
		var0toV1var1toN1->(var0->V1 + var1->N1) +
		var3toV1var1toN1var0toV2var2toN1->(var3->V1 + var1->N1 + var0->V2 + var2->N1) +
		var3toV1var1toN2var0toV1var2toN1->(var3->V1 + var1->N2 + var0->V1 + var2->N1) +
		var3toV1var2toN2var0toV1var1toN1->(var3->V1 + var2->N2 + var0->V1 + var1->N1) +
		var0toV1var1toN1var2toN1var3toV2->(var0->V1 + var1->N1 + var2->N1 + var3->V2) +
