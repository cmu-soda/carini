...
VARIABLES bus_in_use, memory, cache, modified, invalid, exclusive, shared, proc_read, proc_write

vars == <<bus_in_use, memory, cache, modified, invalid, exclusive, shared, proc_read, proc_write>>
