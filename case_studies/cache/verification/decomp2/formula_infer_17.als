...
fun envVarTypes : set(Var->Sort) {
	var2->Value + var1->Core + var0->Core
}
...
one sig var0toc2var1toc2 extends Env {} {}
one sig var0toc2var1toc2var2tov2 extends Env {} {}
one sig var0toc2var1toc1 extends Env {} {}
one sig var1toc2var0toc1 extends Env {} {}
one sig var0toc1 extends Env {} {}
one sig var0toc2var1toc1var2tov1 extends Env {} {}
one sig var1toc2var0toc1var2tov1 extends Env {} {}
one sig var1toc1var0toc1var2tov2 extends Env {} {}
one sig var0toc2 extends Env {} {}
one sig var1toc1var0toc1 extends Env {} {}
one sig var1toc1var0toc1var2tov1 extends Env {} {}
one sig var0toc2var1toc2var2tov1 extends Env {} {}
one sig var0toc2var1toc1var2tov2 extends Env {} {}
one sig var1toc2var0toc1var2tov2 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT52->T5) + (PT46->T4) + (PT55->T6) + (PT32->T4) + (PT42->T2) + (PT1->T9) + (PT58->T4) + (PT62->T5) + (PT64->T5) + (PT66->T3) + (PT35->T4) + (PT68->T7) + (PT34->T4) + (PT36->T4) + (PT53->T4) + (PT57->T6) + (PT51->T4) + (PT22->T4) + (PT63->T4) + (PT48->T6) + (PT12->T3) + (NT1->T9)

	path = (PT52 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_invalidc2a1 + T2->complete_proc_read_invalid_exclusivec1a1v1 + T3->issue_proc_write_sharedc1a1v1 + T4->do_bus_upgradec2a1 + T5->complete_proc_write_sharedc1a1v1)) +
		(PT46 -> (T0->issue_proc_write_sharedc1a1v1 + T1->complete_proc_write_invalidc1a1v1 + T2->issue_proc_write_sharedc1a1v1 + T3->do_bus_upgradec2a1 + T4->complete_proc_write_sharedc1a1v1)) +
		...
		(PT42 -> (T0->issue_proc_write_invalidc1a1v1 + T1->do_bus_read_for_ownership_invalidc2a1 + T2->complete_proc_write_sharedc1a1v1)) +
		...
		(PT58 -> (T0->issue_proc_write_invalidc1a1v1 + T1->complete_proc_write_sharedc1a1v1 + T2->issue_proc_write_invalidc1a1v1 + T3->do_bus_read_for_ownership_validc2a1v1 + T4->complete_proc_write_invalidc1a1v1)) +
		...
		(PT66 -> (T0->issue_proc_write_invalidc1a1v1 + T1->complete_proc_write_sharedc1a1v1 + T2->issue_proc_write_invalidc1a1v2 + T3->complete_proc_write_sharedc1a1v2)) +
		...
		(PT68 -> (T0->issue_proc_write_invalidc1a1v1 + T1->complete_proc_write_sharedc1a1v1 + T2->issue_proc_read_invalidc1a1 + T3->do_bus_read_validc2a1v1 + T4->complete_proc_read_invalid_sharedc1a1v1 + T5->issue_proc_write_invalidc1a1v1 + T6->do_bus_read_for_ownership_invalidc2a1 + T7->complete_proc_write_invalidc1a1v1)) +
		(PT34 -> (T0->issue_proc_write_invalidc1a1v1 + T1->complete_proc_write_sharedc1a1v1 + T2->issue_proc_write_invalidc1a1v2 + T3->do_bus_read_for_ownership_validc2a1v1 + T4->complete_proc_write_invalidc1a1v2)) +
		...
		(PT51 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_validc2a1v1 + T2->complete_proc_read_invalid_sharedc1a1v1 + T3->issue_proc_write_invalidc1a1v2 + T4->complete_proc_write_sharedc1a1v2)) +
		...
		(PT63 -> (T0->issue_proc_write_invalidc1a1v1 + T1->do_bus_read_for_ownership_invalidc2a1 + T2->complete_proc_write_invalidc1a1v1 + T3->issue_proc_write_invalidc1a1v2 + T4->complete_proc_write_sharedc1a1v2)) +
	...
	maps = var0toc2var1toc2->(var0->c2 + var1->c2) +
		var0toc2var1toc2var2tov2->(var0->c2 + var1->c2 + var2->v2) +
		var0toc2var1toc1->(var0->c2 + var1->c1) +
		var1toc2var0toc1->(var1->c2 + var0->c1) +
		var0toc1->(var0->c1) +
		var0toc2var1toc1var2tov1->(var0->c2 + var1->c1 + var2->v1) +
		var1toc2var0toc1var2tov1->(var1->c2 + var0->c1 + var2->v1) +
		var1toc1var0toc1var2tov2->(var1->c1 + var0->c1 + var2->v2) +
		var0toc2->(var0->c2) +
		var1toc1var0toc1->(var1->c1 + var0->c1) +
		var1toc1var0toc1var2tov1->(var1->c1 + var0->c1 + var2->v1) +
		var0toc2var1toc2var2tov1->(var0->c2 + var1->c2 + var2->v1) +
		var0toc2var1toc1var2tov2->(var0->c2 + var1->c1 + var2->v2) +
		var1toc2var0toc1var2tov2->(var1->c2 + var0->c1 + var2->v2)
