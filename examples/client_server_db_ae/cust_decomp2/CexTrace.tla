...
VARIABLES Fluent11, Fluent9, Fluent8, Fluent7, request_sent, Fluent6, Fluent10, Fluent5, response_sent, Fluent4, match, Fluent3, response_received, Fluent2, Fluent1, Fluent0, cexTraceIdx

vars == <<Fluent11, Fluent9, Fluent8, Fluent7, request_sent, Fluent6, Fluent10, Fluent5, response_sent, Fluent4, match, Fluent3, response_received, Fluent2, Fluent1, Fluent0, cexTraceIdx>>
...
/\ cexTraceIdx = 4 =>
  ...
  /\ Fluent5 = ( id1 :> (resp1 :> FALSE @@ resp2 :> FALSE @@ resp3 :> FALSE) @@
    id2 :> (resp1 :> FALSE @@ resp2 :> FALSE @@ resp3 :> FALSE) )
  /\ Fluent6 = ( id1 :> (n1 :> TRUE @@ n2 :> FALSE @@ n3 :> TRUE) @@
    id2 :> (n1 :> FALSE @@ n2 :> FALSE @@ n3 :> FALSE) )
  /\ Fluent7 = ( n1 :> (id1 :> FALSE @@ id2 :> FALSE) @@
    n2 :> (id1 :> FALSE @@ id2 :> FALSE) @@
    n3 :> (id1 :> FALSE @@ id2 :> FALSE) )
...
/\ cexTraceIdx = 5 =>
  ...
  /\ Fluent7 = ( n1 :> (id1 :> FALSE @@ id2 :> FALSE) @@
    n2 :> (id1 :> FALSE @@ id2 :> FALSE) @@
    n3 :> (id1 :> FALSE @@ id2 :> FALSE) )
  /\ Fluent8 = ( id1 :> (req1 :> FALSE @@ req2 :> TRUE @@ req3 :> FALSE) @@
    id2 :> (req1 :> FALSE @@ req2 :> FALSE @@ req3 :> FALSE) )
  /\ Fluent9 = (req1 :> TRUE @@ req2 :> TRUE @@ req3 :> FALSE)
  /\ response_sent = {}
...
/\ cexTraceIdx = 6 =>
  ...
  /\ Fluent6 = ( id1 :> (n1 :> TRUE @@ n2 :> FALSE @@ n3 :> TRUE) @@
    id2 :> (n1 :> FALSE @@ n2 :> FALSE @@ n3 :> FALSE) )
  /\ Fluent7 = ( n1 :> (id1 :> TRUE @@ id2 :> FALSE) @@
    n2 :> (id1 :> FALSE @@ id2 :> FALSE) @@
    n3 :> (id1 :> FALSE @@ id2 :> FALSE) )
  /\ Fluent8 = ( id1 :> (req1 :> FALSE @@ req2 :> TRUE @@ req3 :> FALSE) @@
    id2 :> (req1 :> FALSE @@ req2 :> FALSE @@ req3 :> FALSE) )
  /\ Fluent9 = (req1 :> TRUE @@ req2 :> TRUE @@ req3 :> FALSE)
  /\ response_sent = {<<n1, resp1>>}

/\ cexTraceIdx = 7 =>
  /\ request_sent = {<<n1, req1>>, <<n3, req2>>}
  /\ match = {<<req2, resp1>>}
  /\ response_received = {<<n1, resp1>>}
  /\ Fluent10 = ( req1 :> (id1 :> FALSE @@ id2 :> FALSE) @@
    req2 :> (id1 :> TRUE @@ id2 :> FALSE) @@
    req3 :> (id1 :> FALSE @@ id2 :> FALSE) )
  /\ Fluent11 = ( id1 :> (req1 :> TRUE @@ req2 :> TRUE @@ req3 :> FALSE) @@
...
/\ UNCHANGED <<Fluent11,Fluent9,Fluent7,Fluent6,Fluent4,Fluent2,Fluent1,Fluent0>>
/\ CandSep'
/\ cexTraceIdx' = cexTraceIdx + 1
/\ TraceConstraint'
...
/\ UNCHANGED <<Fluent11,Fluent9,Fluent8,Fluent6,Fluent5,Fluent10,Fluent3,Fluent1>>
/\ CandSep'
/\ cexTraceIdx' = cexTraceIdx + 1
/\ TraceConstraint'
