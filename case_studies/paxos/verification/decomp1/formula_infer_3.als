...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT21->T2) + (PT1->T3) + (PT16->T2) + (PT27->T2) + (PT25->T2) + (PT13->T1) + (PT22->T1) + (PT32->T2) + (PT5->T1) + (PT20->T2) + (PT31->T3) + (PT34->T3) + (PT35->T3) + (PT19->T2) + (PT3->T1) + (PT38->T3) + (PT37->T3) + (PT11->T1) + (PT33->T2) + (PT17->T2) + (PT18->T2) + (PT15->T2) + (PT36->T3) + (PT26->T2) + (PT29->T1) + (PT30->T2) + (NT1->T3)
