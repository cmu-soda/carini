...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT9->T1) + (PT1->T2) + (PT18->T1) + (PT17->T2) + (PT11->T1) + (PT8->T0) + (PT14->T1) + (PT5->T0) + (PT15->T1) + (PT3->T0) + (PT10->T1) + (NT1->T3)

	path = (PT9 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba1NUM0v1)) +
