...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT26->T4) + (PT21->T3) + (PT7->T2) + (PT6->T2) + (PT19->T2) + (PT5->T2) + (PT20->T2) + (PT9->T2) + (PT25->T4) + (PT1->T2) + (NT1->T2)

	path = (PT26 -> (T0->Phase1ba1NUM0 + T1->Phase1ba1NUM1 + T2->Phase1ba2NUM0 + T3->Phase1ba2NUM1 + T4->Phase2ba1NUM0v1)) +
