...
fact TraceSemantics {
    // Target formulas
	all s : State, f : TT | f in s.targetSat
	all s : State, f : FF | f not in s.targetSat
	all s : State, f : NotTarget | f in s.targetSat iff (f.child not in s.targetSat)
	all s : State, f : FluentTarget | f in s.targetSat iff
        let flEnv = { env : Env | (~(f.fluent.vars)).(f.flToActParamsMap).(s.act.params) = env.maps } |
    ...
    all s : State, e : Env, a : FlSymAction | e->a in s.initiates iff
        let isInitAct = some a and concreteMatchesSymAction[e,s.act,a] and a.target in s.targetSat |
        let isTermAct = some a and concreteMatchesSymAction[e,s.act,a] and a.target not in s.targetSat |
    ...
    all s : State, e : Env, f : Fluent | e->f in s.formulaSat iff
        ...
        let isTermAct = some a and concreteMatchesSymAction[e,s.act,a] and e->a in s.terminates |
            ...
            (isInitAct) or
            (not isTermAct and some s.prevState and e->f in s.prevState.formulaSat)
...
fun envVarTypes : set(Var->Sort) {
	var2->Seqnum + var1->Node + var0->Key
}
...
one sig var0tok2var1ton1var2toNUM2 extends Env {} {}
one sig var1ton2var0tok1var2toNUM2 extends Env {} {}
one sig var2toNUM1var1ton1var0tok3 extends Env {} {}
one sig var0tok2var2toNUM1var1ton2 extends Env {} {}
one sig var0tok2var1ton1 extends Env {} {}
one sig var1ton2var0tok1 extends Env {} {}
one sig var1ton1var0tok3 extends Env {} {}
one sig var0tok2var1ton2 extends Env {} {}
one sig var2toNUM1var0tok1var1ton1 extends Env {} {}
one sig var0tok3 extends Env {} {}
one sig var0tok1var1ton1var2toNUM2 extends Env {} {}
one sig var1ton2var0tok3 extends Env {} {}
one sig var0tok2var2toNUM1var1ton1 extends Env {} {}
one sig var2toNUM1var1ton2var0tok1 extends Env {} {}
one sig var0tok2 extends Env {} {}
one sig var1ton1var0tok3var2toNUM2 extends Env {} {}
one sig var0tok2var1ton2var2toNUM2 extends Env {} {}
one sig var2toNUM1var1ton2var0tok3 extends Env {} {}
one sig var0tok1 extends Env {} {}
one sig var1ton2var0tok3var2toNUM2 extends Env {} {}
one sig var0tok1var1ton1 extends Env {} {}


fact PartialInstance {
	maps = var0tok2var1ton1var2toNUM2->(var0->k2 + var1->n1 + var2->NUM2) +
		var1ton2var0tok1var2toNUM2->(var1->n2 + var0->k1 + var2->NUM2) +
		var2toNUM1var1ton1var0tok3->(var2->NUM1 + var1->n1 + var0->k3) +
		var0tok2var2toNUM1var1ton2->(var0->k2 + var2->NUM1 + var1->n2) +
		var0tok2var1ton1->(var0->k2 + var1->n1) +
		var1ton2var0tok1->(var1->n2 + var0->k1) +
		var1ton1var0tok3->(var1->n1 + var0->k3) +
		var0tok2var1ton2->(var0->k2 + var1->n2) +
		var2toNUM1var0tok1var1ton1->(var2->NUM1 + var0->k1 + var1->n1) +
		var0tok3->(var0->k3) +
		var0tok1var1ton1var2toNUM2->(var0->k1 + var1->n1 + var2->NUM2) +
		var1ton2var0tok3->(var1->n2 + var0->k3) +
		var0tok2var2toNUM1var1ton1->(var0->k2 + var2->NUM1 + var1->n1) +
		var2toNUM1var1ton2var0tok1->(var2->NUM1 + var1->n2 + var0->k1) +
		var0tok2->(var0->k2) +
		var1ton1var0tok3var2toNUM2->(var1->n1 + var0->k3 + var2->NUM2) +
		var0tok2var1ton2var2toNUM2->(var0->k2 + var1->n2 + var2->NUM2) +
		var2toNUM1var1ton2var0tok3->(var2->NUM1 + var1->n2 + var0->k3) +
		var0tok1->(var0->k1) +
		var1ton2var0tok3var2toNUM2->(var1->n2 + var0->k3 + var2->NUM2) +
...
one sig NegState5 extends NegState {} {
    prevState = PosState3
    act = recv_transfer_msgn2n1k1v1NUM1
}
