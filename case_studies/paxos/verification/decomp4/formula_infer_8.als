...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT4->T2) + (PT6->T2) + (PT11->T2) + (PT5->T2) + (PT9->T2) + (PT8->T2) + (PT10->T2) + (PT3->T2) + (PT1->T2) + (NT1->T2)

	path = (PT4 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2ba1NUM0v1)) +
		(PT6 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2ba1NUM0v1)) +
