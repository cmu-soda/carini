...
one sig RollbackEntriesn3n1 extends Act {} {
	params = (P0->n3 + P1->n1)
}
...
one sig BecomeLeadern1NUM2 extends Act {} {
	params = (P0->n1 + P1->NUM2)
}
one sig BecomeLeadern2NUM1 extends Act {} {
	params = (P0->n2 + P1->NUM1)
}
one sig BecomeLeadern3NUM2 extends Act {} {
	params = (P0->n3 + P1->NUM2)
}
one sig BecomeLeadern1NUM1 extends Act {} {
	params = (P0->n1 + P1->NUM1)
}
one sig BecomeLeadern2NUM2 extends Act {} {
	params = (P0->n2 + P1->NUM2)
}
one sig BecomeLeadern3NUM3 extends Act {} {
	params = (P0->n3 + P1->NUM3)
}

one sig CommitEntry extends BaseName {} {
	paramIdxs = P0 + P1 + P2
	paramTypes = P0->Server + P1->FinNat + P2->FinNat
}
one sig CommitEntryn2NUM1NUM1 extends Act {} {
	params = (P0->n2 + P1->NUM1 + P2->NUM1)
}
one sig CommitEntryn3NUM1NUM3 extends Act {} {
	params = (P0->n3 + P1->NUM1 + P2->NUM3)
}
one sig CommitEntryn2NUM1NUM2 extends Act {} {
	params = (P0->n2 + P1->NUM1 + P2->NUM2)
}
one sig CommitEntryn3NUM1NUM2 extends Act {} {
	params = (P0->n3 + P1->NUM1 + P2->NUM2)
}
...
one sig ClientRequestn3NUM2 extends Act {} {
	params = (P0->n3 + P1->NUM2)
}
...
fact PartialInstance {
	...
	path = (PT1 -> (T0->BecomeLeadern1NUM1 + T1->BecomeLeadern2NUM2 + T2->ClientRequestn2NUM2 + T3->GetEntriesn3n2 + T4->CommitEntryn2NUM1NUM2 + T5->BecomeLeadern3NUM3 + T6->ClientRequestn2NUM2 + T7->RollbackEntriesn1n1 + T8->ClientRequestn2NUM2 + T9->CommitEntryn3NUM1NUM3)) +
		(NT1 -> (T0->BecomeLeadern1NUM2 + T1->BecomeLeadern2NUM1 + T2->ClientRequestn2NUM1 + T3->GetEntriesn3n2 + T4->CommitEntryn2NUM1NUM1 + T5->BecomeLeadern3NUM2 + T6->ClientRequestn1NUM2 + T7->RollbackEntriesn3n1 + T8->ClientRequestn3NUM2 + T9->CommitEntryn3NUM1NUM2))
	...
	baseName = BecomeLeadern1NUM2->BecomeLeader +
		BecomeLeadern1NUM1->BecomeLeader +
		ClientRequestn3NUM2->ClientRequest +
		CommitEntryn3NUM1NUM3->CommitEntry +
		CommitEntryn3NUM1NUM2->CommitEntry +
		ClientRequestn1NUM2->ClientRequest +
		BecomeLeadern2NUM2->BecomeLeader +
		CommitEntryn2NUM1NUM2->CommitEntry +
		CommitEntryn2NUM1NUM1->CommitEntry +
		RollbackEntriesn3n1->RollbackEntries +
		BecomeLeadern2NUM1->BecomeLeader +
		RollbackEntriesn1n1->RollbackEntries +
		BecomeLeadern3NUM2->BecomeLeader +
		BecomeLeadern3NUM3->BecomeLeader +
