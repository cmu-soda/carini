...
one sig var0tov2var2toNUM2var1tov2 extends Env {} {}
one sig var0tov1 extends Env {} {}
one sig var0tov2 extends Env {} {}
one sig var1tov1var0tov1 extends Env {} {}
one sig var1tov1var0tov1var2toNUM2 extends Env {} {}
...
one sig var1tov1var0tov2var2toNUM2 extends Env {} {}
one sig var0tov1var2toNUM2var1tov2 extends Env {} {}
...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT35->T2) + (PT13->T1) + (PT31->T2) + (PT19->T1) + (PT7->T1) + (PT25->T2) + (PT18->T1) + (PT27->T2) + (PT32->T1) + (PT30->T2) + (PT17->T2) + (PT36->T2) + (PT20->T3) + (PT34->T2) + (PT1->T2) + (PT33->T2) + (PT26->T3) + (PT21->T3) + (PT2->T0) + (PT22->T3) + (PT5->T0) + (NT1->T3)

	path = (PT35 -> (T0->Phase2aNUM0v1a2 + T1->Phase2aNUM0v1a1 + T2->Phase2ba1NUM0v1)) +
		(PT13 -> (T0->Phase2aNUM0v1a1 + T1->Phase2ba1NUM0v2)) +
		(PT31 -> (T0->Phase2aNUM1v1a1 + T1->Phase2aNUM2v2a2 + T2->Phase2ba3NUM1v1)) +
	...
	maps = var2toNUM0var1tov1var0tov1->(var2->NUM0 + var1->v1 + var0->v1) +
		var0tov2var2toNUM2var1tov2->(var0->v2 + var2->NUM2 + var1->v2) +
		var0tov1->(var0->v1) +
		var0tov2->(var0->v2) +
		var1tov1var0tov1->(var1->v1 + var0->v1) +
		var1tov1var0tov1var2toNUM2->(var1->v1 + var0->v1 + var2->NUM2) +
		...
		var1tov1var0tov2var2toNUM2->(var1->v1 + var0->v2 + var2->NUM2) +
		var0tov1var2toNUM2var1tov2->(var0->v1 + var2->NUM2 + var1->v2) +
