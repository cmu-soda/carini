...
fun envVarTypes : set(Var->Sort) {
	var3->Key + var2->Value + var1->Value + var0->Key
}
...
one sig var2toV2var1toV2var0toK2var3toK1 extends Env {} {}
one sig var2toV1var1toV2var0toK2var3toK2 extends Env {} {}
one sig var1toV1var2toV2var0toK2var3toK2 extends Env {} {}
one sig var0toK1var2toV2var1toV2var3toK2 extends Env {} {}
one sig var1toV1var0toK2 extends Env {} {}
one sig var0toK1var1toV2 extends Env {} {}
one sig var2toV2var1toV2var0toK2var3toK2 extends Env {} {}
one sig var2toV1var1toV1var0toK2 extends Env {} {}
one sig var2toV1var0toK1var1toV2 extends Env {} {}
one sig var1toV1var0toK1var2toV2 extends Env {} {}
one sig var2toV1var1toV1var0toK1var3toK1 extends Env {} {}
one sig var2toV1var1toV1var0toK1 extends Env {} {}
one sig var2toV1var1toV1var0toK2var3toK1 extends Env {} {}
one sig var2toV1var0toK1var1toV2var3toK1 extends Env {} {}
one sig var1toV1var0toK1var2toV2var3toK1 extends Env {} {}
one sig var2toV1var1toV1var0toK1var3toK2 extends Env {} {}
one sig var1toV2var0toK2 extends Env {} {}
one sig var2toV1var1toV2var0toK2var3toK1 extends Env {} {}
one sig var1toV1var2toV2var0toK2var3toK1 extends Env {} {}
one sig var0toK1var2toV2var1toV2var3toK1 extends Env {} {}
one sig var2toV1var1toV1var0toK2var3toK2 extends Env {} {}
one sig var2toV1var0toK1var1toV2var3toK2 extends Env {} {}
one sig var1toV1var0toK1var2toV2var3toK2 extends Env {} {}
one sig var2toV2var1toV2var0toK2 extends Env {} {}
one sig var2toV1var1toV2var0toK2 extends Env {} {}
one sig var1toV1var2toV2var0toK2 extends Env {} {}
one sig var0toK1var2toV2var1toV2 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT13->T3) + (PT10->T3) + (PT14->T2) + (PT8->T2) + (PT1->T4) + (NT1->T4)
	...
	maps = var0toK1->(var0->K1) +
		...
		var2toV2var1toV2var0toK2var3toK1->(var2->V2 + var1->V2 + var0->K2 + var3->K1) +
		var2toV1var1toV2var0toK2var3toK2->(var2->V1 + var1->V2 + var0->K2 + var3->K2) +
		var1toV1var2toV2var0toK2var3toK2->(var1->V1 + var2->V2 + var0->K2 + var3->K2) +
		var0toK1var2toV2var1toV2var3toK2->(var0->K1 + var2->V2 + var1->V2 + var3->K2) +
		var1toV1var0toK2->(var1->V1 + var0->K2) +
		var0toK1var1toV2->(var0->K1 + var1->V2) +
		var2toV2var1toV2var0toK2var3toK2->(var2->V2 + var1->V2 + var0->K2 + var3->K2) +
		var2toV1var1toV1var0toK2->(var2->V1 + var1->V1 + var0->K2) +
		var2toV1var0toK1var1toV2->(var2->V1 + var0->K1 + var1->V2) +
		var1toV1var0toK1var2toV2->(var1->V1 + var0->K1 + var2->V2) +
		var2toV1var1toV1var0toK1var3toK1->(var2->V1 + var1->V1 + var0->K1 + var3->K1) +
		var2toV1var1toV1var0toK1->(var2->V1 + var1->V1 + var0->K1) +
		var2toV1var1toV1var0toK2var3toK1->(var2->V1 + var1->V1 + var0->K2 + var3->K1) +
		var2toV1var0toK1var1toV2var3toK1->(var2->V1 + var0->K1 + var1->V2 + var3->K1) +
		var1toV1var0toK1var2toV2var3toK1->(var1->V1 + var0->K1 + var2->V2 + var3->K1) +
		var2toV1var1toV1var0toK1var3toK2->(var2->V1 + var1->V1 + var0->K1 + var3->K2) +
		var1toV2var0toK2->(var1->V2 + var0->K2) +
		var2toV1var1toV2var0toK2var3toK1->(var2->V1 + var1->V2 + var0->K2 + var3->K1) +
		var1toV1var2toV2var0toK2var3toK1->(var1->V1 + var2->V2 + var0->K2 + var3->K1) +
		var0toK1var2toV2var1toV2var3toK1->(var0->K1 + var2->V2 + var1->V2 + var3->K1) +
		var2toV1var1toV1var0toK2var3toK2->(var2->V1 + var1->V1 + var0->K2 + var3->K2) +
		var2toV1var0toK1var1toV2var3toK2->(var2->V1 + var0->K1 + var1->V2 + var3->K2) +
		var1toV1var0toK1var2toV2var3toK2->(var1->V1 + var0->K1 + var2->V2 + var3->K2) +
		var2toV2var1toV2var0toK2->(var2->V2 + var1->V2 + var0->K2) +
		var2toV1var1toV2var0toK2->(var2->V1 + var1->V2 + var0->K2) +
		var1toV1var2toV2var0toK2->(var1->V1 + var2->V2 + var0->K2) +
		var0toK1var2toV2var1toV2->(var0->K1 + var2->V2 + var1->V2)
