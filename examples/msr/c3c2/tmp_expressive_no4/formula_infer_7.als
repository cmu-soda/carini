...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT3->T2) + (PT10->T2) + (PT1->T9) + (PT11->T2) + (NT1->T9)

	path = (PT3 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->CommitEntryn1_n1n2_NUM2NUM1NUM1)) +
		...
		(PT11 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->BecomeLeadern1_n1n2_NUM2)) +
