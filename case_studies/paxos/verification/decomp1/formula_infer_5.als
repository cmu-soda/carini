...
fun envVarTypes : set(Var->Sort) {
	var2->Ballot + var1->Ballot + var0->Value
}
...
one sig var1toNUM0var2toNUM0var0tov1 extends Env {} {}
one sig var1toNUM0var2toNUM0var0tov2 extends Env {} {}
one sig var2toNUM0var1toNUM1var0tov1 extends Env {} {}
one sig var1toNUM0var0tov1var2toNUM1 extends Env {} {}
...
one sig var1toNUM1var2toNUM1var0tov2 extends Env {} {}
one sig var1toNUM1var0tov2 extends Env {} {}
one sig var2toNUM0var1toNUM1var0tov2 extends Env {} {}
one sig var1toNUM0var2toNUM1var0tov2 extends Env {} {}
one sig var1toNUM1var0tov1var2toNUM1 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT21->T2) + (PT1->T3) + (PT16->T2) + (PT27->T2) + (PT25->T2) + (PT45->T2) + (PT41->T2) + (PT13->T1) + (PT22->T1) + (PT48->T1) + (PT32->T2) + (PT5->T1) + (PT20->T2) + (PT31->T3) + (PT34->T3) + (PT35->T3) + (PT42->T2) + (PT19->T2) + (PT3->T1) + (PT38->T3) + (PT37->T3) + (PT43->T2) + (PT40->T2) + (PT11->T1) + (PT33->T2) + (PT17->T2) + (PT18->T2) + (PT15->T2) + (PT47->T2) + (PT36->T3) + (PT26->T2) + (PT29->T1) + (PT46->T2) + (PT30->T2) + (NT1->T3)

	path = (PT21 -> (T0->Phase2aNUM1v1a1 + T1->Phase2aNUM0v2a1 + T2->Phase2ba1NUM1v1)) +
	...
	maps = var1toNUM0var2toNUM0var0tov1->(var1->NUM0 + var2->NUM0 + var0->v1) +
		var1toNUM0var2toNUM0var0tov2->(var1->NUM0 + var2->NUM0 + var0->v2) +
		var2toNUM0var1toNUM1var0tov1->(var2->NUM0 + var1->NUM1 + var0->v1) +
		var1toNUM0var0tov1var2toNUM1->(var1->NUM0 + var0->v1 + var2->NUM1) +
		var0tov1->(var0->v1) +
		var0tov2->(var0->v2) +
		var1toNUM0var0tov1->(var1->NUM0 + var0->v1) +
		var1toNUM0var0tov2->(var1->NUM0 + var0->v2) +
		var1toNUM1var0tov1->(var1->NUM1 + var0->v1) +
		var1toNUM1var2toNUM1var0tov2->(var1->NUM1 + var2->NUM1 + var0->v2) +
		var1toNUM1var0tov2->(var1->NUM1 + var0->v2) +
		var2toNUM0var1toNUM1var0tov2->(var2->NUM0 + var1->NUM1 + var0->v2) +
		var1toNUM0var2toNUM1var0tov2->(var1->NUM0 + var2->NUM1 + var0->v2) +
		var1toNUM1var0tov1var2toNUM1->(var1->NUM1 + var0->v1 + var2->NUM1)
