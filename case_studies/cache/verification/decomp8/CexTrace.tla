...
VARIABLES bus_read_for_ownership, bus_transfer, bus_read, Fluent14_22, Fluent13_22, bus_upgrade, cexTraceIdx

vars == <<bus_read_for_ownership, bus_transfer, bus_read, Fluent14_22, Fluent13_22, bus_upgrade, cexTraceIdx>>

TraceConstraint ==
/\ cexTraceIdx = 0 =>
  /\ bus_transfer = (v1 :> FALSE @@ v2 :> FALSE)
  /\ Fluent14_22 = (a1 :> FALSE @@ a2 :> FALSE)
  /\ Fluent13_22 = (a1 :> FALSE @@ a2 :> FALSE)
...
CandSep == (\A var0 \in Address : (Fluent14_22[var0] => ~(Fluent13_22[var0])))
