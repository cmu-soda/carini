...
fun envVarTypes : set(Var->Sort) {
	var2->Node + var1->Value + var0->Value
}
...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT123->T7) + (PT99->T6) + (PT89->T5) + (PT62->T4) + (PT128->T4) + (PT95->T6) + (PT90->T5) + (PT96->T5) + (PT71->T5) + (PT77->T5) + (PT101->T6) + (PT121->T5) + (PT93->T5) + (PT87->T5) + (PT82->T6) + (PT81->T4) + (PT94->T7) + (PT131->T5) + (PT119->T5) + (PT110->T6) + (PT80->T6) + (PT61->T4) + (PT72->T3) + (PT127->T4) + (PT98->T5) + (PT97->T5) + (PT122->T5) + (PT116->T5) + (PT73->T3) + (PT120->T6) + (PT54->T2) + (PT83->T5) + (PT133->T6) + (PT75->T5) + (PT118->T6) + (PT88->T5) + (PT115->T6) + (PT130->T7) + (PT64->T4) + (PT92->T5) + (PT124->T5) + (PT126->T4) + (PT91->T4) + (PT104->T5) + (PT105->T5) + (PT103->T5) + (PT132->T7) + (PT85->T4) + (PT100->T4) + (PT86->T5) + (PT129->T5) + (PT106->T3) + (PT65->T3) + (PT114->T5) + (PT102->T6) + (PT111->T4) + (PT108->T4) + (PT84->T5) + (PT107->T5) + (PT109->T5) + (PT125->T5) + (PT66->T4) + (PT74->T6) + (PT1->T6) + (PT67->T4) + (PT76->T4) + (PT112->T5) + (PT117->T4) + (NT1->T6)
	...
	maps = var1toV1var0toV2->(var1->V1 + var0->V2) +
