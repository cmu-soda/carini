...
TraceConstraint ==
/\ cexTraceIdx = 0 => propose(1,0,v1) /\ err' = err
/\ cexTraceIdx = 1 => cast_vote(n2,v1,1) /\ err' = err
/\ cexTraceIdx = 2 => propose(2,0,v2) /\ err' = err
/\ cexTraceIdx = 3 => cast_vote(n1,v1,1) /\ err' = err
/\ cexTraceIdx = 4 => cast_vote(n1,v2,2) /\ err' = err
/\ cexTraceIdx = 5 => cast_vote(n2,v2,2) /\ err' = TRUE
/\ cexTraceIdx >= 6 => FALSE
