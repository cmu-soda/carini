...
fact PartialInstance {
	...
	path = (PT1 -> (T0->ReshardK1V1N2N1 + T1->RecvTransferMsgN1K1V1 + T2->ReshardK1V1N1N2 + T3->RecvTransferMsgN2K1V1 + T4->ReshardK2V2N2N1 + T5->RecvTransferMsgN1K2V2)) +
		(NT1 -> (T0->ReshardK1V1N2N1 + T1->RecvTransferMsgN1K1V1 + T2->ReshardK1V1N1N2 + T3->RecvTransferMsgN2K1V1 + T4->ReshardK2V2N2N1 + T5->RecvTransferMsgN1K1V2))
	...
	baseName = RecvTransferMsgN1K1V1->RecvTransferMsg +
