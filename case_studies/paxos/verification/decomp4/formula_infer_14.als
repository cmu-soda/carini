...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT21->T3) + (PT15->T2) + (PT17->T2) + (PT7->T2) + (PT6->T2) + (PT11->T2) + (PT18->T2) + (PT5->T2) + (PT16->T2) + (PT9->T2) + (PT1->T2) + (NT1->T2)

	path = (PT21 -> (T0->Phase1ba1NUM0 + T1->Phase1ba1NUM1 + T2->Phase1ba2NUM0 + T3->Phase2ba1NUM0v1)) +
		(PT15 -> (T0->Phase1ba1NUM2 + T1->Phase1ba2NUM2 + T2->Phase2ba3NUM2v1)) +
		(PT17 -> (T0->Phase1ba1NUM2 + T1->Phase1ba3NUM2 + T2->Phase2ba2NUM2v1)) +
		(PT7 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2ba1NUM0v1)) +
