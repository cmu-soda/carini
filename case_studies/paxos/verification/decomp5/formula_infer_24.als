...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT2->T1) + (PT1->T3) + (NT1->T7)

	path = (PT2 -> (T0->Phase2aNUM0v1a1 + T1->Phase2ba1NUM0v1)) +
		(PT1 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2aNUM0v1a1 + T3->Phase2aNUM2v2a1)) +
		(NT1 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2aNUM0v1a1 + T3->Phase2aNUM0v2a1 + T4->Phase2ba1NUM0v1 + T5->Phase2ba1NUM0v2 + T6->Phase2ba2NUM0v1 + T7->Phase2ba2NUM0v2))
