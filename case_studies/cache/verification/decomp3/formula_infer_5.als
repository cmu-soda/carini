...
fun envVarTypes : set(Var->Sort) {
	var2->Value + var1->Core + var0->Value
}
...
one sig var1toc2var2tov1var0tov2 extends Env {} {}
one sig var1toc1var0tov2 extends Env {} {}
one sig var1toc2var0tov1 extends Env {} {}
one sig var1toc1var0tov2var2tov2 extends Env {} {}
one sig var1toc2var0tov1var2tov2 extends Env {} {}
one sig var0tov1 extends Env {} {}
one sig var1toc2var0tov2 extends Env {} {}
one sig var1toc1var0tov1var2tov1 extends Env {} {}
one sig var0tov2 extends Env {} {}
one sig var1toc1var2tov1var0tov2 extends Env {} {}
one sig var1toc2var0tov1var2tov1 extends Env {} {}
one sig var1toc1var0tov1var2tov2 extends Env {} {}
one sig var1toc2var0tov2var2tov2 extends Env {} {}
one sig var1toc1var0tov1 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT34->T4) + (PT1->T8) + (PT11->T4) + (PT42->T4) + (PT13->T4) + (PT38->T5) + (PT28->T6) + (PT27->T7) + (PT39->T7) + (PT51->T5) + (PT37->T5) + (PT8->T6) + (PT31->T4) + (PT36->T4) + (PT18->T4) + (PT44->T5) + (PT21->T5) + (PT48->T5) + (PT6->T3) + (PT12->T3) + (PT40->T7) + (PT32->T5) + (PT33->T5) + (PT9->T4) + (PT45->T5) + (PT49->T6) + (PT14->T3) + (PT35->T6) + (PT46->T5) + (PT10->T4) + (PT17->T4) + (PT19->T4) + (NT1->T8)
	...
	maps = var1toc2var2tov1var0tov2->(var1->c2 + var2->v1 + var0->v2) +
		var1toc1var0tov2->(var1->c1 + var0->v2) +
		var1toc2var0tov1->(var1->c2 + var0->v1) +
		var1toc1var0tov2var2tov2->(var1->c1 + var0->v2 + var2->v2) +
		var1toc2var0tov1var2tov2->(var1->c2 + var0->v1 + var2->v2) +
		var0tov1->(var0->v1) +
		var1toc2var0tov2->(var1->c2 + var0->v2) +
		var1toc1var0tov1var2tov1->(var1->c1 + var0->v1 + var2->v1) +
		var0tov2->(var0->v2) +
		var1toc1var2tov1var0tov2->(var1->c1 + var2->v1 + var0->v2) +
		var1toc2var0tov1var2tov1->(var1->c2 + var0->v1 + var2->v1) +
		var1toc1var0tov1var2tov2->(var1->c1 + var0->v1 + var2->v2) +
		var1toc2var0tov2var2tov2->(var1->c2 + var0->v2 + var2->v2) +
		var1toc1var0tov1->(var1->c1 + var0->v1)
