...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT21->T2) + (PT1->T3) + (PT16->T2) + (PT19->T2) + (PT3->T1) + (PT12->T1) + (PT13->T1) + (PT10->T1) + (PT7->T1) + (PT11->T1) + (PT18->T2) + (PT15->T2) + (PT14->T1) + (PT6->T1) + (PT5->T1) + (PT20->T2) + (PT4->T1) + (NT1->T3)
	...
	maps = var2tov2var1toa2var0toa2->(var2->v2 + var1->a2 + var0->a2) +
