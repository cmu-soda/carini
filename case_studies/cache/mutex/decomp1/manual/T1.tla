...
VARIABLES memory, cache, proc_read, proc_write, bus_in_use, bus_read, bus_read_for_ownership, bus_upgrade, bus_transfer, bus_mode, upgrading, upgraded, state, transfer, read_state, write_state

vars == <<memory, cache, proc_read, proc_write, bus_in_use, bus_read, bus_read_for_ownership, bus_upgrade, bus_transfer, bus_mode, upgrading, upgraded, state, transfer, read_state, write_state>>
