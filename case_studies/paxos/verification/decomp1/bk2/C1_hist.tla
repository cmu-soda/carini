...
VARIABLES msgs2a, msgs2b, Fluent19_1, Fluent14_12, Fluent15_12, Fluent20_1

vars == <<msgs2a, msgs2b, Fluent19_1, Fluent14_12, Fluent15_12, Fluent20_1>>

CandSep ==
/\ \A var0 \in Acceptor : \E var1 \in Value : \A var2 \in Ballot : (Fluent19_1[var2][var0][var1]) => (Fluent20_1[var2][var0])
...
/\ Fluent20_1 = [ x0 \in Ballot |-> [ x1 \in Acceptor |-> FALSE]]
/\ Fluent19_1 = [ x0 \in Ballot |-> [ x1 \in Acceptor |-> [ x2 \in Value |-> FALSE]]]
...
/\ UNCHANGED <<>>
/\ IncSep'
/\ Fluent20_1' = [x0 \in Ballot |-> [x1 \in Acceptor |-> TRUE]]
/\ Fluent19_1' = [[Fluent19_1 EXCEPT ![b] = [x0 \in Acceptor |-> [x1 \in Value |-> FALSE]]] EXCEPT ![b][a][v] = TRUE]
/\ UNCHANGED<<>>
/\ CandSep'
...
/\ IncSep'
/\ Fluent20_1' = [Fluent20_1 EXCEPT ![b][a] = FALSE]
/\ UNCHANGED<<Fluent19_1>>
/\ CandSep'
