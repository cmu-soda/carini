...
one sig recv_transfer_msg extends BaseName {} {
	paramIdxs = P0 + P1 + P2 + P3 + P4
	paramTypes = P0->Node + P1->Node + P2->Key + P3->Value + P4->Seqnum
}
one sig recv_transfer_msgn1n1k1v1NUM1 extends Act {} {
	params = (P0->n1 + P1->n1 + P2->k1 + P3->v1 + P4->NUM1)
}
one sig recv_transfer_msgn1n1k1v1NUM2 extends Act {} {
	params = (P0->n1 + P1->n1 + P2->k1 + P3->v1 + P4->NUM2)
}
one sig recv_transfer_msgn1n2k1v1NUM2 extends Act {} {
	params = (P0->n1 + P1->n2 + P2->k1 + P3->v1 + P4->NUM2)
}
one sig recv_transfer_msgn1n1k1v2NUM1 extends Act {} {
	params = (P0->n1 + P1->n1 + P2->k1 + P3->v2 + P4->NUM1)
}
one sig recv_transfer_msgn1n2k1v1NUM1 extends Act {} {
	params = (P0->n1 + P1->n2 + P2->k1 + P3->v1 + P4->NUM1)
}
one sig recv_transfer_msgn1n1k1v2NUM2 extends Act {} {
	params = (P0->n1 + P1->n1 + P2->k1 + P3->v2 + P4->NUM2)
}
one sig recv_transfer_msgn2n1k1v1NUM1 extends Act {} {
	params = (P0->n2 + P1->n1 + P2->k1 + P3->v1 + P4->NUM1)
}
one sig recv_transfer_msgn2n1k1v1NUM2 extends Act {} {
...
one sig reshardn1n1k1v2NUM2 extends Act {} {
	params = (P0->n1 + P1->n1 + P2->k1 + P3->v2 + P4->NUM2)
}
...
fun envVarTypes : set(Var->Sort) {
	var2->Value + var1->Value + var0->Key
}
...
one sig var0tok2var1tov1var2tov1 extends Env {} {}
one sig var2tov1var0tok1var1tov2 extends Env {} {}
one sig var1tov1var0tok1var2tov2 extends Env {} {}
one sig var1tov1var2tov1var0tok1 extends Env {} {}
one sig var0tok2var1tov1 extends Env {} {}
...
one sig var0tok3var2tov2var1tov2 extends Env {} {}
one sig var0tok3var1tov2 extends Env {} {}
one sig var2tov1var0tok3var1tov2 extends Env {} {}
one sig var1tov1var0tok3var2tov2 extends Env {} {}
one sig var0tok2var2tov2var1tov2 extends Env {} {}
one sig var1tov1var0tok3 extends Env {} {}
one sig var0tok2var1tov2 extends Env {} {}
one sig var1tov1var2tov1var0tok3 extends Env {} {}
one sig var0tok2var2tov1var1tov2 extends Env {} {}
one sig var0tok2var1tov1var2tov2 extends Env {} {}
one sig var0tok1var2tov2var1tov2 extends Env {} {}
one sig var0tok1 extends Env {} {}


fact PartialInstance {
	maps = var0tok2var1tov1var2tov1->(var0->k2 + var1->v1 + var2->v1) +
		var2tov1var0tok1var1tov2->(var2->v1 + var0->k1 + var1->v2) +
		var1tov1var0tok1var2tov2->(var1->v1 + var0->k1 + var2->v2) +
		var1tov1var2tov1var0tok1->(var1->v1 + var2->v1 + var0->k1) +
		var0tok2var1tov1->(var0->k2 + var1->v1) +
		var0tok1var1tov2->(var0->k1 + var1->v2) +
		var1tov1var0tok1->(var1->v1 + var0->k1) +
		var0tok3->(var0->k3) +
		var0tok2->(var0->k2) +
		var0tok3var2tov2var1tov2->(var0->k3 + var2->v2 + var1->v2) +
		var0tok3var1tov2->(var0->k3 + var1->v2) +
		var2tov1var0tok3var1tov2->(var2->v1 + var0->k3 + var1->v2) +
		var1tov1var0tok3var2tov2->(var1->v1 + var0->k3 + var2->v2) +
		var0tok2var2tov2var1tov2->(var0->k2 + var2->v2 + var1->v2) +
		var1tov1var0tok3->(var1->v1 + var0->k3) +
		var0tok2var1tov2->(var0->k2 + var1->v2) +
		var1tov1var2tov1var0tok3->(var1->v1 + var2->v1 + var0->k3) +
		var0tok2var2tov1var1tov2->(var0->k2 + var2->v1 + var1->v2) +
		var0tok2var1tov1var2tov2->(var0->k2 + var1->v1 + var2->v2) +
	...
	baseName = reshardn1n1k2v1NUM2->reshard +
		...
		recv_transfer_msgn1n1k1v2NUM1->recv_transfer_msg +
		recv_transfer_msgn1n1k1v2NUM2->recv_transfer_msg +
		recv_transfer_msgn1n2k1v1NUM1->recv_transfer_msg +
		recv_transfer_msgn2n1k1v1NUM1->recv_transfer_msg +
		recv_transfer_msgn1n2k1v1NUM2->recv_transfer_msg +
		recv_transfer_msgn2n1k1v1NUM2->recv_transfer_msg +
		reshardn1n1k1v2NUM2->reshard +
		reshardn1n1k1v2NUM1->reshard +
		recv_transfer_msgn1n1k1v1NUM2->recv_transfer_msg +
		recv_transfer_msgn1n1k1v1NUM1->recv_transfer_msg
}
...
one sig PosState42 extends PosState {} {
    ...
    act = recv_transfer_msgn2n1k1v1NUM1
}
...
one sig NegState44 extends NegState {} {
    prevState = PosState43
    act = recv_transfer_msgn2n1k1v1NUM2
}

one sig NegState45 extends NegState {} {
    prevState = NegState44
    act = recv_transfer_msgn1n2k1v1NUM1
}
...
one sig PosState7 extends PosState {} {
    prevState = PosState6
    act = recv_transfer_msgn1n1k1v1NUM1
}
...
one sig PosState28 extends PosState {} {
    prevState = PosState27
    act = recv_transfer_msgn1n2k1v1NUM2
}
...
one sig PosState21 extends PosState {} {
    ...
    act = recv_transfer_msgn1n1k1v1NUM2
}
...
one sig PosState31 extends PosState {} {
    ...
    act = recv_transfer_msgn1n1k1v2NUM2
}

one sig PosState32 extends PosState {} {
    prevState = PosState31
    act = recv_transfer_msgn1n2k1v1NUM1
}
...
one sig PosState17 extends PosState {} {
    ...
    act = recv_transfer_msgn1n1k1v2NUM1
}
