...
fact PartialInstance {
	...
	path = (PT1 -> (T0->BecomeLeadern1_n1n2n3_NUM1 + T1->ClientRequestn1NUM1 + T2->BecomeLeadern2_n2n3_NUM2 + T3->ClientRequestn2NUM2 + T4->GetEntriesn3n2 + T5->CommitEntryn2_n2n3_NUM1NUM2NUM2)) +
		(NT1 -> (T0->BecomeLeadern1_n1n2n3_NUM3 + T1->ClientRequestn1NUM3 + T2->BecomeLeadern2_n2n3_NUM2 + T3->ClientRequestn2NUM2 + T4->GetEntriesn3n2 + T5->CommitEntryn2_n2n3_NUM1NUM2NUM3))
