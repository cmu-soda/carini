...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT21->T2) + (PT1->T3) + (PT16->T2) + (PT19->T2) + (PT3->T1) + (PT12->T1) + (PT13->T1) + (PT10->T1) + (PT7->T1) + (PT11->T1) + (PT17->T2) + (PT18->T2) + (PT2->T1) + (PT15->T2) + (PT14->T1) + (PT6->T1) + (PT5->T1) + (PT20->T2) + (PT4->T1) + (NT1->T3)
	...
	path = (PT21 -> (T0->Phase2aNUM1v1a1 + T1->Phase2aNUM0v2a1 + T2->Phase2ba1NUM1v1)) +
		...
		(PT2 -> (T0->Phase2aNUM0v2a1 + T1->Phase2aNUM1v1a1)) +
	...
	maps = var0toNUM0var1toa1var2tov1->(var0->NUM0 + var1->a1 + var2->v1) +
