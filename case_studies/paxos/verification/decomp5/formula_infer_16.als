...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT13->T4) + (PT15->T4) + (PT22->T5) + (PT16->T3) + (PT23->T4) + (PT3->T2) + (PT24->T4) + (PT20->T4) + (PT11->T4) + (PT1->T7) + (PT9->T3) + (PT6->T1) + (PT21->T4) + (PT8->T4) + (PT25->T4) + (PT19->T5) + (PT14->T2) + (PT7->T4) + (PT12->T3) + (PT26->T2) + (PT4->T2) + (NT1->T9)
