...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT1->T6) + (NT1->T7)

	path = (PT1 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->BecomeLeadern2_n1n2_NUM2 + T2->ClientRequestn2NUM2 + T3->ClientRequestn2NUM2 + T4->GetEntriesn1n2 + T5->GetEntriesn3n2 + T6->GetEntriesn1n2)) +
