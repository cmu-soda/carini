...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT6->T1) + (PT18->T1) + (PT7->T1) + (PT19->T2) + (PT17->T2) + (PT1->T1) + (PT16->T2) + (PT23->T1) + (PT21->T1) + (PT25->T2) + (PT26->T2) + (PT24->T2) + (PT5->T0) + (PT22->T1) + (PT20->T1) + (NT1->T2)

	path = (PT6 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba1NUM0v1)) +
		(PT18 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba1NUM0v2)) +
		(PT7 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba1NUM0v1)) +
		(PT19 -> (T0->Phase2aNUM1v1a1 + T1->Phase2aNUM0v2a1 + T2->Phase2ba1NUM1v1)) +
		(PT17 -> (T0->Phase2aNUM0v1a1 + T1->Phase2aNUM0v2a1 + T2->Phase2ba1NUM0v1)) +
		(PT1 -> (T0->Phase2aNUM0v2a1 + T1->Phase2aNUM1v1a1)) +
		(PT16 -> (T0->Phase2aNUM0v2a1 + T1->Phase2aNUM1v1a1 + T2->Phase2ba1NUM1v1)) +
		(PT23 -> (T0->Phase2ba1NUM0v1 + T1->Phase2ba1NUM0v2)) +
		(PT21 -> (T0->Phase2ba1NUM0v1 + T1->Phase2aNUM1v1a1)) +
		(PT25 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba2NUM0v1 + T2->Phase2aNUM1v1a1)) +
		(PT26 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba2NUM0v1 + T2->Phase2aNUM1v1a1)) +
		(PT24 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba2NUM0v1 + T2->Phase2aNUM1v1a1)) +
		(PT5 -> (T0->Phase2ba1NUM0v1)) +
		(PT22 -> (T0->Phase2ba1NUM0v1 + T1->Phase2aNUM1v1a1)) +
		(PT20 -> (T0->Phase2ba1NUM0v1 + T1->Phase2ba1NUM1v1)) +
		(NT1 -> (T0->Phase2aNUM0v2a1 + T1->Phase2aNUM1v1a1 + T2->Phase2ba1NUM0v2))
