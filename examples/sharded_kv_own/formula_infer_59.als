...
fun envVarTypes : set(Var->Sort) {
	var3->Value + var2->Value + var1->Node + var0->Node
}
...
one sig var3toV1var0toN2var2toV1var1toN2 extends Env {} {}
one sig var3toV1var0toN2var2toV2var1toN1 extends Env {} {}
one sig var3toV1var1toN2var2toV2var0toN1 extends Env {} {}
one sig var0toN2var2toV1var1toN1var3toV2 extends Env {} {}
one sig var2toV1var1toN2var0toN1var3toV2 extends Env {} {}
one sig var2toV2var1toN1var0toN1var3toV2 extends Env {} {}
one sig var3toV1var0toN2var1toN2var2toV2 extends Env {} {}
one sig var0toN2var2toV1var1toN2var3toV2 extends Env {} {}
one sig var0toN2var2toV2var1toN1var3toV2 extends Env {} {}
one sig var1toN2var2toV2var0toN1var3toV2 extends Env {} {}
one sig var0toN2var1toN2var2toV2var3toV2 extends Env {} {}
one sig var0toN2var1toN2var2toV2 extends Env {} {}
one sig var0toN2 extends Env {} {}
one sig var0toN2var2toV1var1toN2 extends Env {} {}
one sig var0toN2var2toV2var1toN1 extends Env {} {}
one sig var1toN2var2toV2var0toN1 extends Env {} {}
one sig var0toN1 extends Env {} {}
one sig var0toN2var2toV1var1toN1 extends Env {} {}
one sig var2toV1var1toN2var0toN1 extends Env {} {}
one sig var2toV2var1toN1var0toN1 extends Env {} {}
one sig var2toV1var1toN1var0toN1 extends Env {} {}
one sig var0toN2var1toN2 extends Env {} {}
one sig var1toN1var0toN1 extends Env {} {}
one sig var0toN2var1toN1 extends Env {} {}
one sig var1toN2var0toN1 extends Env {} {}
one sig var3toV1var2toV1var1toN1var0toN1 extends Env {} {}
one sig var3toV1var0toN2var2toV1var1toN1 extends Env {} {}
one sig var3toV1var2toV1var1toN2var0toN1 extends Env {} {}
one sig var3toV1var2toV2var1toN1var0toN1 extends Env {} {}
one sig var2toV1var1toN1var0toN1var3toV2 extends Env {} {}
...
fact PartialInstance {
	...
	maps = var3toV1var0toN2var2toV1var1toN2->(var3->V1 + var0->N2 + var2->V1 + var1->N2) +
		var3toV1var0toN2var2toV2var1toN1->(var3->V1 + var0->N2 + var2->V2 + var1->N1) +
		var3toV1var1toN2var2toV2var0toN1->(var3->V1 + var1->N2 + var2->V2 + var0->N1) +
		var0toN2var2toV1var1toN1var3toV2->(var0->N2 + var2->V1 + var1->N1 + var3->V2) +
		var2toV1var1toN2var0toN1var3toV2->(var2->V1 + var1->N2 + var0->N1 + var3->V2) +
		var2toV2var1toN1var0toN1var3toV2->(var2->V2 + var1->N1 + var0->N1 + var3->V2) +
		var3toV1var0toN2var1toN2var2toV2->(var3->V1 + var0->N2 + var1->N2 + var2->V2) +
		var0toN2var2toV1var1toN2var3toV2->(var0->N2 + var2->V1 + var1->N2 + var3->V2) +
		var0toN2var2toV2var1toN1var3toV2->(var0->N2 + var2->V2 + var1->N1 + var3->V2) +
		var1toN2var2toV2var0toN1var3toV2->(var1->N2 + var2->V2 + var0->N1 + var3->V2) +
		var0toN2var1toN2var2toV2var3toV2->(var0->N2 + var1->N2 + var2->V2 + var3->V2) +
		var0toN2var1toN2var2toV2->(var0->N2 + var1->N2 + var2->V2) +
		var0toN2->(var0->N2) +
		var0toN2var2toV1var1toN2->(var0->N2 + var2->V1 + var1->N2) +
		var0toN2var2toV2var1toN1->(var0->N2 + var2->V2 + var1->N1) +
		var1toN2var2toV2var0toN1->(var1->N2 + var2->V2 + var0->N1) +
		var0toN1->(var0->N1) +
		var0toN2var2toV1var1toN1->(var0->N2 + var2->V1 + var1->N1) +
		var2toV1var1toN2var0toN1->(var2->V1 + var1->N2 + var0->N1) +
		var2toV2var1toN1var0toN1->(var2->V2 + var1->N1 + var0->N1) +
		var2toV1var1toN1var0toN1->(var2->V1 + var1->N1 + var0->N1) +
		var0toN2var1toN2->(var0->N2 + var1->N2) +
		var1toN1var0toN1->(var1->N1 + var0->N1) +
		var0toN2var1toN1->(var0->N2 + var1->N1) +
		var1toN2var0toN1->(var1->N2 + var0->N1) +
		var3toV1var2toV1var1toN1var0toN1->(var3->V1 + var2->V1 + var1->N1 + var0->N1) +
		var3toV1var0toN2var2toV1var1toN1->(var3->V1 + var0->N2 + var2->V1 + var1->N1) +
		var3toV1var2toV1var1toN2var0toN1->(var3->V1 + var2->V1 + var1->N2 + var0->N1) +
		var3toV1var2toV2var1toN1var0toN1->(var3->V1 + var2->V2 + var1->N1 + var0->N1) +
		var2toV1var1toN1var0toN1var3toV2->(var2->V1 + var1->N1 + var0->N1 + var3->V2)
