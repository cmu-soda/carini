...
pred lte[lhs : Atom, rhs : Atom] {
	let containsRel = (NUM0->NUM0 + NUM0->NUM1 + NUM1->NUM1) |
		(lhs->rhs) in containsRel
}


one sig a1, a2, v1, v2, NUM0, NUM1 extends Atom {}
...
one sig Phase2aNUM0v2a2 extends Act {} {
	params = (P0->NUM0 + P1->v2 + P2->a2)
}
...
fact {
	...
	Phase2a in FlSymAction.baseName // the final base name in the neg trace must appear in the sep formula
}


fun envVarTypes : set(Var->Sort) {
	var2->Ballot + var1->Value + var0->Acceptor
}
...
one sig var2toNUM0var1tov1var0toa1 extends Env {} {}
one sig var2toNUM0var1tov1var0toa2 extends Env {} {}
one sig var2toNUM0var0toa1var1tov2 extends Env {} {}
one sig var1tov2var0toa2 extends Env {} {}
one sig var1tov1var0toa1var2toNUM1 extends Env {} {}
one sig var1tov1var0toa1 extends Env {} {}
one sig var2toNUM0var1tov2var0toa2 extends Env {} {}
one sig var1tov1var2toNUM1var0toa2 extends Env {} {}
one sig var0toa1var2toNUM1var1tov2 extends Env {} {}
one sig var2toNUM1var1tov2var0toa2 extends Env {} {}
one sig var1tov1var0toa2 extends Env {} {}
one sig var0toa1var1tov2 extends Env {} {}
one sig var0toa1 extends Env {} {}
one sig var0toa2 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT23->T2) + (PT21->T2) + (PT1->T3) + (PT16->T2) + (PT27->T2) + (PT25->T2) + (PT45->T2) + (PT41->T2) + (PT13->T1) + (PT22->T1) + (PT48->T1) + (PT14->T1) + (PT6->T1) + (PT32->T2) + (PT5->T1) + (PT20->T2) + (PT4->T1) + (PT24->T2) + (PT31->T3) + (PT34->T3) + (PT35->T3) + (PT42->T2) + (PT19->T2) + (PT3->T1) + (PT38->T3) + (PT12->T1) + (PT37->T3) + (PT43->T2) + (PT40->T2) + (PT7->T1) + (PT11->T1) + (PT33->T2) + (PT17->T2) + (PT18->T2) + (PT15->T2) + (PT47->T2) + (PT36->T3) + (PT26->T2) + (PT29->T1) + (PT46->T2) + (PT30->T2) + (NT1->T3)

	path = (PT23 -> (T0->Phase2ba1NUM0v1 + T1->Phase2aNUM1v1a1 + T2->Phase2ba2NUM1v1)) +
		(PT21 -> (T0->Phase2aNUM1v1a1 + T1->Phase2aNUM0v2a1 + T2->Phase2ba1NUM1v1)) +
		(PT1 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba1NUM0v2 + T2->Phase2ba2NUM0v2 + T3->Phase2ba1NUM1v1)) +
		(PT16 -> (T0->Phase2aNUM0v1a1 + T1->Phase2aNUM0v2a1 + T2->Phase2ba1NUM0v1)) +
		(PT27 -> (T0->Phase2ba2NUM0v1 + T1->Phase2ba2NUM0v2 + T2->Phase2aNUM1v2a2)) +
		(PT25 -> (T0->Phase2ba1NUM0v1 + T1->Phase2ba2NUM1v1 + T2->Phase2aNUM1v1a1)) +
		(PT45 -> (T0->Phase2aNUM1v1a1 + T1->Phase2ba1NUM1v1 + T2->Phase2aNUM0v1a2)) +
		(PT41 -> (T0->Phase2ba1NUM0v1 + T1->Phase2ba2NUM0v2 + T2->Phase2aNUM1v1a2)) +
		(PT13 -> (T0->Phase2ba1NUM1v1 + T1->Phase2aNUM1v2a2)) +
		(PT22 -> (T0->Phase2ba1NUM1v2 + T1->Phase2aNUM0v1a2)) +
		(PT48 -> (T0->Phase2aNUM0v2a1 + T1->Phase2aNUM1v2a1)) +
		(PT14 -> (T0->Phase2ba1NUM0v1 + T1->Phase2aNUM0v1a2)) +
		(PT6 -> (T0->Phase2ba1NUM0v1 + T1->Phase2aNUM1v1a1)) +
		(PT32 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba2NUM0v1 + T2->Phase2aNUM1v1a1)) +
		(PT5 -> (T0->Phase2aNUM0v1a1 + T1->Phase2aNUM0v2a1)) +
		(PT20 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba1NUM1v1 + T2->Phase2ba2NUM1v1)) +
		(PT4 -> (T0->Phase2ba1NUM0v1 + T1->Phase2aNUM1v1a1)) +
		(PT24 -> (T0->Phase2ba1NUM1v1 + T1->Phase2ba2NUM0v2 + T2->Phase2aNUM1v2a2)) +
		(PT31 -> (T0->Phase2aNUM1v1a1 + T1->Phase2ba1NUM1v1 + T2->Phase2aNUM1v2a2 + T3->Phase2ba2NUM1v1)) +
		(PT34 -> (T0->Phase2ba1NUM1v1 + T1->Phase2ba2NUM0v1 + T2->Phase2ba2NUM0v2 + T3->Phase2aNUM1v2a2)) +
		(PT35 -> (T0->Phase2aNUM0v2a1 + T1->Phase2aNUM1v1a1 + T2->Phase2ba1NUM1v1 + T3->Phase2ba2NUM1v1)) +
		(PT42 -> (T0->Phase2ba1NUM1v1 + T1->Phase2aNUM1v1a2 + T2->Phase2aNUM0v1a2)) +
		(PT19 -> (T0->Phase2aNUM0v1a1 + T1->Phase2ba1NUM1v2 + T2->Phase2ba2NUM0v2)) +
		(PT3 -> (T0->Phase2aNUM0v1a1 + T1->Phase2aNUM0v2a1)) +
		(PT38 -> (T0->Phase2aNUM1v1a1 + T1->Phase2aNUM1v2a1 + T2->Phase2ba2NUM1v1 + T3->Phase2ba1NUM1v1)) +
		(PT12 -> (T0->Phase2ba1NUM1v1 + T1->Phase2aNUM1v1a2)) +
		(PT37 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba1NUM1v1 + T2->Phase2aNUM1v1a2 + T3->Phase2ba2NUM1v1)) +
		(PT43 -> (T0->Phase2aNUM1v1a1 + T1->Phase2ba1NUM1v1 + T2->Phase2aNUM0v1a2)) +
		(PT40 -> (T0->Phase2ba1NUM0v1 + T1->Phase2ba2NUM0v2 + T2->Phase2aNUM1v1a2)) +
		(PT7 -> (T0->Phase2ba1NUM0v1 + T1->Phase2aNUM1v1a1)) +
		(PT11 -> (T0->Phase2aNUM0v2a1 + T1->Phase2aNUM1v1a1)) +
		(PT33 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba2NUM0v1 + T2->Phase2aNUM1v1a1)) +
		(PT17 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba1NUM1v1 + T2->Phase2aNUM1v1a2)) +
		(PT18 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba1NUM1v2 + T2->Phase2ba2NUM1v1)) +
		(PT15 -> (T0->Phase2aNUM0v1a1 + T1->Phase2ba1NUM0v1 + T2->Phase2aNUM0v2a2)) +
		(PT47 -> (T0->Phase2aNUM0v2a2 + T1->Phase2ba2NUM0v1 + T2->Phase2aNUM1v1a2)) +
		(PT36 -> (T0->Phase2aNUM0v2a1 + T1->Phase2aNUM1v1a1 + T2->Phase2ba2NUM1v1 + T3->Phase2ba1NUM1v1)) +
		(PT26 -> (T0->Phase2ba1NUM0v1 + T1->Phase2ba2NUM0v1 + T2->Phase2aNUM1v1a1)) +
		(PT29 -> (T0->Phase2ba1NUM1v1 + T1->Phase2aNUM0v1a2)) +
		(PT46 -> (T0->Phase2aNUM0v2a2 + T1->Phase2ba2NUM0v2 + T2->Phase2aNUM1v2a2)) +
		(PT30 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba2NUM1v1 + T2->Phase2aNUM1v1a1)) +
		(NT1 -> (T0->Phase2aNUM0v2a1 + T1->Phase2ba1NUM0v2 + T2->Phase2ba2NUM0v2 + T3->Phase2aNUM1v1a1))

	maps = var2toNUM0var1tov1var0toa1->(var2->NUM0 + var1->v1 + var0->a1) +
		var2toNUM0var1tov1var0toa2->(var2->NUM0 + var1->v1 + var0->a2) +
		var2toNUM0var0toa1var1tov2->(var2->NUM0 + var0->a1 + var1->v2) +
		var1tov2var0toa2->(var1->v2 + var0->a2) +
		var1tov1var0toa1var2toNUM1->(var1->v1 + var0->a1 + var2->NUM1) +
		var1tov1var0toa1->(var1->v1 + var0->a1) +
		var2toNUM0var1tov2var0toa2->(var2->NUM0 + var1->v2 + var0->a2) +
		var1tov1var2toNUM1var0toa2->(var1->v1 + var2->NUM1 + var0->a2) +
		var0toa1var2toNUM1var1tov2->(var0->a1 + var2->NUM1 + var1->v2) +
		var2toNUM1var1tov2var0toa2->(var2->NUM1 + var1->v2 + var0->a2) +
		var1tov1var0toa2->(var1->v1 + var0->a2) +
		var0toa1var1tov2->(var0->a1 + var1->v2) +
		var0toa1->(var0->a1) +
		var0toa2->(var0->a2)

	baseName = Phase2aNUM0v2a2->Phase2a +
