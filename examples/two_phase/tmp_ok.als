...
sig Fluent extends Formula {
    ...
    //(no flActions.flToActParamsMap) or (flActions.flToActParamsMap).ParamIdx = vars.Var
...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT1->T0) + (NT1->T4)

	path = (PT1 -> (T0->RcvCommitr2)) +
		(NT1 -> (T0->SndPreparer1 + T1->RcvAbortr1 + T2->SndPreparer2 + T3->SndPreparer3 + T4->RcvCommitr2))
...
fact {
	...
	Root.children.children in Not
	Root.children.children.children in Fluent
	Root.children.children.children.flActions.baseName = RcvCommit
	Root.children.children.children.flActions.value = False
	//#(Root.children.children.children.flActions) = 1
	some a : Root.children.children.children.flActions | no a.flToActParamsMap 
	//no Root.children.children.children.flActions.flToActParamsMap 

    /*
	Root.children.children in Implies
	Root.children.children.left in Fluent
	Root.children.children.left.flActions.baseName = RcvCommit
	//Root.children.children.left.flActions.value = True
	#(Root.children.children.left.flActions) = 1
	no Root.children.children.left.flActions

	Root.children.children.right in Not
	Root.children.children.right.children in Fluent
	Root.children.children.right.children.flActions.baseName = RcvAbort
	#(Root.children.children.right.children.flActions) = 1
    */
}
