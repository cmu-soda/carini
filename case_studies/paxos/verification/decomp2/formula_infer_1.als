...
one sig var2toa3var0tov2var1tov2 extends Env {} {}
...
one sig var2toa3var1tov1var0tov1 extends Env {} {}
...
one sig var2toa3var1tov1var0tov2 extends Env {} {}
one sig var2toa3var0tov1var1tov2 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT13->T1) + (PT7->T1) + (PT25->T2) + (PT17->T2) + (PT11->T1) + (PT23->T2) + (PT20->T3) + (PT15->T1) + (PT24->T2) + (PT10->T1) + (PT1->T2) + (PT26->T3) + (PT21->T3) + (PT8->T0) + (PT22->T3) + (PT14->T1) + (NT1->T3)
	...
	maps = var2toa3var0tov2var1tov2->(var2->a3 + var0->v2 + var1->v2) +
		var1tov1var0tov1var2toa1->(var1->v1 + var0->v1 + var2->a1) +
		var0tov1->(var0->v1) +
		var0tov2->(var0->v2) +
		...
		var2toa3var1tov1var0tov1->(var2->a3 + var1->v1 + var0->v1) +
		...
		var2toa3var1tov1var0tov2->(var2->a3 + var1->v1 + var0->v2) +
		var2toa3var0tov1var1tov2->(var2->a3 + var0->v1 + var1->v2)
