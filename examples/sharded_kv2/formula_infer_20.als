...
fact PartialInstance {
	lastIdx = (PT1->T4) + (NT1->T4)

	path = (PT1 -> (T0->ReshardK2V1N2N1 + T1->RecvTransferMsgN1K2V1 + T2->ReshardK2V2N1N2 + T3->RecvTransferMsgN2K2V2)) +
	...
	baseName = RecvTransferMsgN1K2V1->RecvTransferMsg +
