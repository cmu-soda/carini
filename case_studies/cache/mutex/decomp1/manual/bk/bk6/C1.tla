...
VARIABLES modified, exclusive, shared, invalid, bus_mode, upgrading, upgraded, state, owning, owned, transfer, read_state, write_state

vars == <<modified, exclusive, shared, invalid, bus_mode, upgrading, upgraded, state, owning, owned, transfer, read_state, write_state>>
