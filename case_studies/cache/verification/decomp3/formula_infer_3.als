...
one sig issue_proc_write_invalidc2a2v2 extends Act {} {
	params = (P0->c2 + P1->a2 + P2->v2)
}
...
fun envVarTypes : set(Var->Sort) {
	var2->Value + var1->Core + var0->Address
}
...
one sig var1toc1var2tov1var0toa2 extends Env {} {}
one sig var1toc2var0toa1var2tov1 extends Env {} {}
one sig var1toc1var0toa1var2tov2 extends Env {} {}
one sig var1toc2var2tov1var0toa2 extends Env {} {}
one sig var1toc1var2tov2var0toa2 extends Env {} {}
one sig var1toc2var0toa1var2tov2 extends Env {} {}
one sig var1toc1var0toa2 extends Env {} {}
one sig var1toc2var0toa1 extends Env {} {}
one sig var1toc2var2tov2var0toa2 extends Env {} {}
one sig var1toc1var0toa1 extends Env {} {}
one sig var1toc2var0toa2 extends Env {} {}
one sig var0toa1 extends Env {} {}
one sig var1toc1var0toa1var2tov1 extends Env {} {}
one sig var0toa2 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT1->T8) + (PT2->T4) + (PT3->T2) + (PT8->T4) + (PT6->T4) + (PT11->T3) + (NT1->T8)

	path = (PT1 -> (T0->issue_proc_write_invalidc1a1v1 + T1->do_bus_read_for_ownership_invalidc2a1 + T2->complete_proc_write_invalidc1a1v1 + T3->evict_modifiedc1a1 + T4->issue_proc_read_invalidc1a1 + T5->do_bus_read_invalidc2a1 + T6->complete_proc_read_invalid_exclusivec1a1v1 + T7->issue_proc_write_invalidc2a2v2 + T8->do_bus_read_for_ownership_invalidc1a2)) +
		(PT2 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_invalidc2a1 + T2->complete_proc_read_invalid_exclusivec1a1v1 + T3->issue_proc_write_sharedc1a2v1 + T4->complete_proc_write_invalidc1a2v1)) +
		(PT3 -> (T0->evict_modifiedc2a1 + T1->issue_proc_write_sharedc1a1v1 + T2->complete_proc_write_invalidc1a1v1)) +
		(PT8 -> (T0->issue_proc_write_sharedc1a1v1 + T1->complete_proc_write_invalidc1a1v1 + T2->evict_modifiedc1a1 + T3->issue_proc_read_invalidc2a1 + T4->do_bus_read_invalidc1a1)) +
		(PT6 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_invalidc2a1 + T2->complete_proc_read_invalid_exclusivec1a1v1 + T3->issue_proc_write_sharedc2a1v1 + T4->complete_proc_write_invalidc2a1v1)) +
		(PT11 -> (T0->issue_proc_write_sharedc1a1v1 + T1->complete_proc_write_invalidc1a1v1 + T2->issue_proc_write_sharedc1a2v2 + T3->complete_proc_write_invalidc1a2v2)) +
		(NT1 -> (T0->issue_proc_write_invalidc1a1v1 + T1->do_bus_read_for_ownership_invalidc2a1 + T2->complete_proc_write_invalidc1a1v1 + T3->evict_modifiedc1a1 + T4->issue_proc_read_invalidc1a1 + T5->do_bus_read_invalidc2a1 + T6->complete_proc_read_invalid_exclusivec1a1v1 + T7->issue_proc_write_invalidc2a2v2 + T8->complete_proc_write_invalidc2a1v2))

	maps = var1toc1var2tov1var0toa2->(var1->c1 + var2->v1 + var0->a2) +
		var1toc2var0toa1var2tov1->(var1->c2 + var0->a1 + var2->v1) +
		var1toc1var0toa1var2tov2->(var1->c1 + var0->a1 + var2->v2) +
		var1toc2var2tov1var0toa2->(var1->c2 + var2->v1 + var0->a2) +
		var1toc1var2tov2var0toa2->(var1->c1 + var2->v2 + var0->a2) +
		var1toc2var0toa1var2tov2->(var1->c2 + var0->a1 + var2->v2) +
		var1toc1var0toa2->(var1->c1 + var0->a2) +
		var1toc2var0toa1->(var1->c2 + var0->a1) +
		var1toc2var2tov2var0toa2->(var1->c2 + var2->v2 + var0->a2) +
		var1toc1var0toa1->(var1->c1 + var0->a1) +
		var1toc2var0toa2->(var1->c2 + var0->a2) +
		var0toa1->(var0->a1) +
		var1toc1var0toa1var2tov1->(var1->c1 + var0->a1 + var2->v1) +
		var0toa2->(var0->a2)

	baseName = complete_proc_write_invalidc2a1v2->complete_proc_write_invalid +
		...
		issue_proc_write_invalidc2a2v2->issue_proc_write_invalid
}
