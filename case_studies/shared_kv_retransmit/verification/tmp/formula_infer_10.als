...
one sig reshardn1n2k1v1NUM2 extends Act {} {
	params = (P0->n1 + P1->n2 + P2->k1 + P3->v1 + P4->NUM2)
}
...
one sig var1tok2var2tov1var0tok3 extends Env {} {}
one sig var0tok2var2tov1var1tok3 extends Env {} {}
one sig var1tok1var0tok3var2tov2 extends Env {} {}
one sig var0tok2var1tok2var2tov2 extends Env {} {}
one sig var0tok1var2tov2var1tok3 extends Env {} {}
one sig var2tov1var0tok3var1tok3 extends Env {} {}
one sig var1tok2var0tok3var2tov2 extends Env {} {}
one sig var0tok2var2tov2var1tok3 extends Env {} {}
one sig var0tok3var2tov2var1tok3 extends Env {} {}
one sig var1tok1var2tov1var0tok1 extends Env {} {}
one sig var0tok2var1tok1var2tov1 extends Env {} {}
one sig var1tok2var2tov1var0tok1 extends Env {} {}
one sig var1tok1var0tok1var2tov2 extends Env {} {}
one sig var1tok1var2tov1var0tok3 extends Env {} {}
one sig var0tok2var1tok2var2tov1 extends Env {} {}
one sig var2tov1var0tok1var1tok3 extends Env {} {}
one sig var0tok2var1tok1var2tov2 extends Env {} {}
one sig var1tok2var0tok1var2tov2 extends Env {} {}
...
fact PartialInstance {
	maps = var1tok2var2tov1var0tok3->(var1->k2 + var2->v1 + var0->k3) +
		var0tok2var2tov1var1tok3->(var0->k2 + var2->v1 + var1->k3) +
		var1tok1var0tok3var2tov2->(var1->k1 + var0->k3 + var2->v2) +
		var0tok2var1tok2var2tov2->(var0->k2 + var1->k2 + var2->v2) +
		var0tok1var2tov2var1tok3->(var0->k1 + var2->v2 + var1->k3) +
		var2tov1var0tok3var1tok3->(var2->v1 + var0->k3 + var1->k3) +
		var1tok2var0tok3var2tov2->(var1->k2 + var0->k3 + var2->v2) +
		var0tok2var2tov2var1tok3->(var0->k2 + var2->v2 + var1->k3) +
		var0tok3var2tov2var1tok3->(var0->k3 + var2->v2 + var1->k3) +
		var1tok1var2tov1var0tok1->(var1->k1 + var2->v1 + var0->k1) +
		var0tok2var1tok1var2tov1->(var0->k2 + var1->k1 + var2->v1) +
		var1tok2var2tov1var0tok1->(var1->k2 + var2->v1 + var0->k1) +
		var1tok1var0tok1var2tov2->(var1->k1 + var0->k1 + var2->v2) +
		var1tok1var2tov1var0tok3->(var1->k1 + var2->v1 + var0->k3) +
		var0tok2var1tok2var2tov1->(var0->k2 + var1->k2 + var2->v1) +
		var2tov1var0tok1var1tok3->(var2->v1 + var0->k1 + var1->k3) +
		var0tok2var1tok1var2tov2->(var0->k2 + var1->k1 + var2->v2) +
		var1tok2var0tok1var2tov2->(var1->k2 + var0->k1 + var2->v2) +
	...
	baseName = reshardn2n1k1v1NUM1->reshard +
		reshardn1n1k2v1NUM1->reshard +
		reshardn2n1k1v1NUM2->reshard +
		reshardn1n2k1v1NUM2->reshard +
...
one sig PosState53 extends PosState {} {
    prevState = PosState5
    act = reshardn1n1k1v1NUM2
}

one sig PosState54 extends PosState {} {
    prevState = PosState53
    act = retransmitn2n1k1v1NUM1
}
...
one sig PosState51 extends PosState {} {
    prevState = PosState2
    act = reshardn1n1k2v1NUM1
}

one sig PosState52 extends PosState {} {
    prevState = PosState51
    act = retransmitn1n1k1v1NUM1
}

one sig PosState59 extends PosState {} {
    prevState = PosState2
    act = reshardn1n2k1v1NUM2
}

one sig PosState60 extends PosState {} {
    prevState = PosState59
    act = reshardn2n2k1v1NUM1
}

one sig NegState61 extends NegState {} {
    prevState = PosState60
...
one sig PosState58 extends PosState {} {
    prevState = PosState23
    act = reshardn1n1k1v1NUM2
}
...
one sig PosState55 extends PosState {} {
    prevState = PosState48
    act = retransmitn2n1k1v1NUM1
}
...
one sig PosState57 extends PosState {} {
    prevState = PosState7
...
one sig PosState41 extends PosState {} {
    prevState = PosState40
    act = reshardn1n1k1v1NUM2
}

one sig PosState56 extends PosState {} {
    prevState = PosState40
    act = reshardn2n2k1v1NUM1
}
