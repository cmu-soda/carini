...
fun envVarTypes : set(Var->Sort) {
	var3->Node + var2->Value + var1->Node + var0->Value
}
...
one sig var2toV1var1toN2var3toN1var0toV2 extends Env {} {}
one sig var2toV2var1toN1var3toN1var0toV2 extends Env {} {}
one sig var1toN2var0toV1var2toV2var3toN1 extends Env {} {}
one sig var2toV1var1toN1var0toV2var3toN2 extends Env {} {}
one sig var2toV1var1toN2var0toV1var3toN2 extends Env {} {}
one sig var0toV1var2toV2var1toN1var3toN2 extends Env {} {}
one sig var1toN2var2toV2var3toN1var0toV2 extends Env {} {}
one sig var2toV1var1toN2var0toV2var3toN2 extends Env {} {}
one sig var2toV2var1toN1var0toV2var3toN2 extends Env {} {}
one sig var1toN2var0toV1var2toV2var3toN2 extends Env {} {}
one sig var1toN2var2toV2var0toV2var3toN2 extends Env {} {}
one sig var2toV1var1toN2var0toV2 extends Env {} {}
one sig var2toV2var1toN1var0toV2 extends Env {} {}
one sig var1toN2var0toV1var2toV2 extends Env {} {}
one sig var0toV1 extends Env {} {}
one sig var2toV1var1toN1var0toV2 extends Env {} {}
one sig var2toV1var1toN2var0toV1 extends Env {} {}
one sig var0toV1var2toV2var1toN1 extends Env {} {}
one sig var0toV2 extends Env {} {}
one sig var1toN2var2toV2var0toV2 extends Env {} {}
one sig var1toN2var0toV2 extends Env {} {}
one sig var2toV1var0toV1var1toN1 extends Env {} {}
one sig var2toV1var0toV1var1toN1var3toN1 extends Env {} {}
one sig var0toV1var1toN1 extends Env {} {}
one sig var2toV1var1toN1var3toN1var0toV2 extends Env {} {}
one sig var2toV1var1toN2var0toV1var3toN1 extends Env {} {}
one sig var0toV1var2toV2var1toN1var3toN1 extends Env {} {}
one sig var2toV1var0toV1var1toN1var3toN2 extends Env {} {}
...
fact PartialInstance {
	...
	maps = var2toV1var1toN2var3toN1var0toV2->(var2->V1 + var1->N2 + var3->N1 + var0->V2) +
		var2toV2var1toN1var3toN1var0toV2->(var2->V2 + var1->N1 + var3->N1 + var0->V2) +
		var1toN2var0toV1var2toV2var3toN1->(var1->N2 + var0->V1 + var2->V2 + var3->N1) +
		var2toV1var1toN1var0toV2var3toN2->(var2->V1 + var1->N1 + var0->V2 + var3->N2) +
		var2toV1var1toN2var0toV1var3toN2->(var2->V1 + var1->N2 + var0->V1 + var3->N2) +
		var0toV1var2toV2var1toN1var3toN2->(var0->V1 + var2->V2 + var1->N1 + var3->N2) +
		var1toN2var2toV2var3toN1var0toV2->(var1->N2 + var2->V2 + var3->N1 + var0->V2) +
		var2toV1var1toN2var0toV2var3toN2->(var2->V1 + var1->N2 + var0->V2 + var3->N2) +
		var2toV2var1toN1var0toV2var3toN2->(var2->V2 + var1->N1 + var0->V2 + var3->N2) +
		var1toN2var0toV1var2toV2var3toN2->(var1->N2 + var0->V1 + var2->V2 + var3->N2) +
		var1toN2var2toV2var0toV2var3toN2->(var1->N2 + var2->V2 + var0->V2 + var3->N2) +
		var2toV1var1toN2var0toV2->(var2->V1 + var1->N2 + var0->V2) +
		var2toV2var1toN1var0toV2->(var2->V2 + var1->N1 + var0->V2) +
		var1toN2var0toV1var2toV2->(var1->N2 + var0->V1 + var2->V2) +
		var0toV1->(var0->V1) +
		var2toV1var1toN1var0toV2->(var2->V1 + var1->N1 + var0->V2) +
		var2toV1var1toN2var0toV1->(var2->V1 + var1->N2 + var0->V1) +
		var0toV1var2toV2var1toN1->(var0->V1 + var2->V2 + var1->N1) +
		var0toV2->(var0->V2) +
		var1toN2var2toV2var0toV2->(var1->N2 + var2->V2 + var0->V2) +
		var1toN2var0toV2->(var1->N2 + var0->V2) +
		var2toV1var0toV1var1toN1->(var2->V1 + var0->V1 + var1->N1) +
		var2toV1var0toV1var1toN1var3toN1->(var2->V1 + var0->V1 + var1->N1 + var3->N1) +
		var0toV1var1toN1->(var0->V1 + var1->N1) +
		var2toV1var1toN1var3toN1var0toV2->(var2->V1 + var1->N1 + var3->N1 + var0->V2) +
		var2toV1var1toN2var0toV1var3toN1->(var2->V1 + var1->N2 + var0->V1 + var3->N1) +
		var0toV1var2toV2var1toN1var3toN1->(var0->V1 + var2->V2 + var1->N1 + var3->N1) +
		var2toV1var0toV1var1toN1var3toN2->(var2->V1 + var0->V1 + var1->N1 + var3->N2) +
