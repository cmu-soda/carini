...
one sig CommitEntryn2_n1n2_NUM2NUM2NUM2 extends Act {} {
	params = (P0->n2 + P1->_n1n2_ + P2->NUM2 + P3->NUM2 + P4->NUM2)
}
...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT5->T2) + (PT1->T9) + (PT11->T3) + (NT1->T9)

	path = (PT5 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->CommitEntryn1_n1n2_NUM2NUM1NUM1)) +
		(PT1 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->BecomeLeadern2_n1n2_NUM2 + T2->ClientRequestn2NUM2 + T3->ClientRequestn2NUM2 + T4->GetEntriesn1n2 + T5->GetEntriesn3n2 + T6->GetEntriesn1n2 + T7->CommitEntryn2_n1n2_NUM2NUM2NUM2 + T8->BecomeLeadern1_n1n2n3_NUM3 + T9->ClientRequestn1NUM3)) +
		(PT11 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->BecomeLeadern2_n1n2_NUM2 + T3->GetEntriesn1n1)) +
		(NT1 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->BecomeLeadern2_n1n2_NUM2 + T2->ClientRequestn2NUM2 + T3->ClientRequestn2NUM2 + T4->GetEntriesn1n2 + T5->GetEntriesn3n2 + T6->GetEntriesn1n2 + T7->CommitEntryn2_n1n2_NUM2NUM2NUM2 + T8->BecomeLeadern1_n1n2n3_NUM3 + T9->ClientRequestn1NUM1))
	...
	baseName = BecomeLeadern1_n1n2_NUM1->BecomeLeader +
		CommitEntryn2_n1n2_NUM2NUM2NUM2->CommitEntry +
