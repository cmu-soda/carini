...
fun envVarTypes : set(Var->Sort) {
	var2->Value + var1->Value + var0->Value
}
...
one sig var0tov2var2tov2var1tov2 extends Env {} {}
one sig var2tov1var0tov2var1tov2 extends Env {} {}
one sig var1tov1var0tov2var2tov2 extends Env {} {}
one sig var0tov1var2tov2var1tov2 extends Env {} {}
one sig var1tov1var0tov1 extends Env {} {}
one sig var1tov1var2tov1var0tov2 extends Env {} {}
one sig var0tov1var2tov1var1tov2 extends Env {} {}
one sig var1tov1var0tov1var2tov2 extends Env {} {}
one sig var1tov1var0tov2 extends Env {} {}
one sig var0tov1var1tov2 extends Env {} {}
one sig var0tov2var1tov2 extends Env {} {}
one sig var1tov1var0tov1var2tov1 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT34->T4) + (PT12->T3) + (PT1->T8) + (PT40->T7) + (PT42->T4) + (PT13->T4) + (PT33->T5) + (PT9->T4) + (PT38->T5) + (PT45->T5) + (PT51->T5) + (PT37->T5) + (PT8->T6) + (PT46->T5) + (PT31->T4) + (PT10->T4) + (PT18->T4) + (PT44->T5) + (PT21->T5) + (PT19->T4) + (PT48->T5) + (NT1->T8)
	...
	maps = var0tov1->(var0->v1) +
		var0tov2->(var0->v2) +
		var0tov2var2tov2var1tov2->(var0->v2 + var2->v2 + var1->v2) +
		var2tov1var0tov2var1tov2->(var2->v1 + var0->v2 + var1->v2) +
		var1tov1var0tov2var2tov2->(var1->v1 + var0->v2 + var2->v2) +
		var0tov1var2tov2var1tov2->(var0->v1 + var2->v2 + var1->v2) +
		var1tov1var0tov1->(var1->v1 + var0->v1) +
		var1tov1var2tov1var0tov2->(var1->v1 + var2->v1 + var0->v2) +
		var0tov1var2tov1var1tov2->(var0->v1 + var2->v1 + var1->v2) +
		var1tov1var0tov1var2tov2->(var1->v1 + var0->v1 + var2->v2) +
		var1tov1var0tov2->(var1->v1 + var0->v2) +
		var0tov1var1tov2->(var0->v1 + var1->v2) +
		var0tov2var1tov2->(var0->v2 + var1->v2) +
		var1tov1var0tov1var2tov1->(var1->v1 + var0->v1 + var2->v1)
