...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT9->T3) + (PT8->T2) + (PT1->T5) + (PT2->T2) + (NT1->T5)

	path = (PT9 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V1N1N1 + T2->ReshardK1V1N1N2 + T3->RecvTransferMsgN1K1V1)) +
		(PT8 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V1N1N2 + T2->RecvTransferMsgN1K1V1)) +
		(PT1 -> (T0->OwnN1K1 + T1->PutN1K1V1 + T2->ReshardK1V1N1N1 + T3->RecvTransferMsgN1K1V1 + T4->ReshardK1V1N1N2 + T5->RecvTransferMsgN2K1V1)) +
		(PT2 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V1N1N2 + T2->RecvTransferMsgN1K2V1)) +
		(NT1 -> (T0->OwnN1K1 + T1->PutN1K1V1 + T2->ReshardK1V1N1N1 + T3->RecvTransferMsgN1K1V1 + T4->ReshardK1V1N1N2 + T5->RecvTransferMsgN1K1V1))
