...
one sig reshardn2n1k2v1NUM1 extends Act {} {
	params = (P0->n2 + P1->n1 + P2->k2 + P3->v1 + P4->NUM1)
}
...
one sig retransmitn1n1k2v1NUM1 extends Act {} {
	params = (P0->n1 + P1->n1 + P2->k2 + P3->v1 + P4->NUM1)
}
...
fact PartialInstance {
	...
	baseName = reshardn2n1k1v1NUM1->reshard +
		...
		retransmitn1n1k2v1NUM1->retransmit +
		reshardn1n1k1v1NUM2->reshard +
		retransmitn1n1k1v1NUM1->retransmit +
		reshardn2n1k2v1NUM1->reshard +
