...
fun envVarTypes : set(Var->Sort) {
	var2->Ballot + var1->Acceptor + var0->Quorum
}
...
one sig var1toa3var0to_a1a3_ extends Env {} {}
one sig var0to_a1a2a3_var2toNUM0var1toa1 extends Env {} {}
one sig var0to_a2a3_var1toa2var2toNUM2 extends Env {} {}
one sig var1toa3var2toNUM1var0to_a2a3_ extends Env {} {}
one sig var0to_a1a2a3_var1toa1var2toNUM2 extends Env {} {}
one sig var0to_a1a2a3_var2toNUM0var1toa3 extends Env {} {}
one sig var0to_a1a2a3_var2toNUM1var1toa2 extends Env {} {}
one sig var1toa2var0to_a1a3_var2toNUM2 extends Env {} {}
one sig var1toa3var2toNUM1var0to_a1a3_ extends Env {} {}
one sig var0to_a1a2a3_var1toa3var2toNUM2 extends Env {} {}
one sig var0to_a1a2a3_ extends Env {} {}
one sig var0to_a2a3_ extends Env {} {}
one sig var0to_a1a2_var1toa2 extends Env {} {}
one sig var0to_a1a3_ extends Env {} {}
one sig var1toa1var0to_a1a2_var2toNUM2 extends Env {} {}
one sig var2toNUM0var1toa3var0to_a1a2_ extends Env {} {}
one sig var2toNUM1var0to_a1a2_var1toa2 extends Env {} {}
one sig var1toa3var0to_a1a2_var2toNUM2 extends Env {} {}
one sig var1toa1var0to_a2a3_var2toNUM2 extends Env {} {}
one sig var2toNUM0var1toa2var0to_a1a3_ extends Env {} {}
one sig var2toNUM0var1toa3var0to_a2a3_ extends Env {} {}
one sig var2toNUM1var1toa1var0to_a1a3_ extends Env {} {}
one sig var2toNUM1var0to_a2a3_var1toa2 extends Env {} {}
one sig var1toa1var0to_a2a3_ extends Env {} {}
one sig var0to_a1a2a3_var1toa2 extends Env {} {}
one sig var0to_a1a2_ extends Env {} {}
one sig var2toNUM0var1toa1var0to_a2a3_ extends Env {} {}
one sig var1toa2var0to_a1a3_ extends Env {} {}
one sig var1toa3var0to_a2a3_ extends Env {} {}
one sig var1toa3var0to_a1a3_var2toNUM2 extends Env {} {}
one sig var0to_a1a2a3_var2toNUM0var1toa2 extends Env {} {}
one sig var0to_a1a2a3_var2toNUM1var1toa1 extends Env {} {}
one sig var1toa1var0to_a1a3_var2toNUM2 extends Env {} {}
one sig var2toNUM0var1toa3var0to_a1a3_ extends Env {} {}
one sig var2toNUM1var1toa2var0to_a1a3_ extends Env {} {}
one sig var1toa3var0to_a2a3_var2toNUM2 extends Env {} {}
one sig var0to_a1a2a3_var1toa2var2toNUM2 extends Env {} {}
one sig var1toa3var0to_a1a2_ extends Env {} {}
one sig var0to_a1a2a3_var1toa3var2toNUM1 extends Env {} {}
one sig var2toNUM0var1toa1var0to_a1a2_ extends Env {} {}
one sig var1toa1var0to_a1a2_ extends Env {} {}
one sig var0to_a1a2_var1toa2var2toNUM2 extends Env {} {}
one sig var1toa3var2toNUM1var0to_a1a2_ extends Env {} {}
one sig var2toNUM0var0to_a1a2_var1toa2 extends Env {} {}
one sig var2toNUM1var1toa1var0to_a1a2_ extends Env {} {}
one sig var0to_a1a2a3_var1toa3 extends Env {} {}
one sig var0to_a1a2a3_var1toa1 extends Env {} {}
one sig var1toa1var0to_a1a3_ extends Env {} {}
one sig var0to_a2a3_var1toa2 extends Env {} {}
one sig var2toNUM0var1toa1var0to_a1a3_ extends Env {} {}
one sig var2toNUM0var0to_a2a3_var1toa2 extends Env {} {}
one sig var2toNUM1var1toa1var0to_a2a3_ extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT1->T1) + (PT19->T1) + (PT7->T1) + (PT17->T2) + (PT16->T2) + (PT8->T0) + (PT15->T1) + (PT9->T0) + (PT12->T1) + (NT1->T2)
	...
	maps = var1toa3var0to_a1a3_->(var1->a3 + var0->_a1a3_) +
		var0to_a1a2a3_var2toNUM0var1toa1->(var0->_a1a2a3_ + var2->NUM0 + var1->a1) +
		var0to_a2a3_var1toa2var2toNUM2->(var0->_a2a3_ + var1->a2 + var2->NUM2) +
		var1toa3var2toNUM1var0to_a2a3_->(var1->a3 + var2->NUM1 + var0->_a2a3_) +
		var0to_a1a2a3_var1toa1var2toNUM2->(var0->_a1a2a3_ + var1->a1 + var2->NUM2) +
		var0to_a1a2a3_var2toNUM0var1toa3->(var0->_a1a2a3_ + var2->NUM0 + var1->a3) +
		var0to_a1a2a3_var2toNUM1var1toa2->(var0->_a1a2a3_ + var2->NUM1 + var1->a2) +
		var1toa2var0to_a1a3_var2toNUM2->(var1->a2 + var0->_a1a3_ + var2->NUM2) +
		var1toa3var2toNUM1var0to_a1a3_->(var1->a3 + var2->NUM1 + var0->_a1a3_) +
		var0to_a1a2a3_var1toa3var2toNUM2->(var0->_a1a2a3_ + var1->a3 + var2->NUM2) +
		var0to_a1a2a3_->(var0->_a1a2a3_) +
		var0to_a2a3_->(var0->_a2a3_) +
		var0to_a1a2_var1toa2->(var0->_a1a2_ + var1->a2) +
		var0to_a1a3_->(var0->_a1a3_) +
		var1toa1var0to_a1a2_var2toNUM2->(var1->a1 + var0->_a1a2_ + var2->NUM2) +
		var2toNUM0var1toa3var0to_a1a2_->(var2->NUM0 + var1->a3 + var0->_a1a2_) +
		var2toNUM1var0to_a1a2_var1toa2->(var2->NUM1 + var0->_a1a2_ + var1->a2) +
		var1toa3var0to_a1a2_var2toNUM2->(var1->a3 + var0->_a1a2_ + var2->NUM2) +
		var1toa1var0to_a2a3_var2toNUM2->(var1->a1 + var0->_a2a3_ + var2->NUM2) +
		var2toNUM0var1toa2var0to_a1a3_->(var2->NUM0 + var1->a2 + var0->_a1a3_) +
		var2toNUM0var1toa3var0to_a2a3_->(var2->NUM0 + var1->a3 + var0->_a2a3_) +
		var2toNUM1var1toa1var0to_a1a3_->(var2->NUM1 + var1->a1 + var0->_a1a3_) +
		var2toNUM1var0to_a2a3_var1toa2->(var2->NUM1 + var0->_a2a3_ + var1->a2) +
		var1toa1var0to_a2a3_->(var1->a1 + var0->_a2a3_) +
		var0to_a1a2a3_var1toa2->(var0->_a1a2a3_ + var1->a2) +
		var0to_a1a2_->(var0->_a1a2_) +
		var2toNUM0var1toa1var0to_a2a3_->(var2->NUM0 + var1->a1 + var0->_a2a3_) +
		var1toa2var0to_a1a3_->(var1->a2 + var0->_a1a3_) +
		var1toa3var0to_a2a3_->(var1->a3 + var0->_a2a3_) +
		var1toa3var0to_a1a3_var2toNUM2->(var1->a3 + var0->_a1a3_ + var2->NUM2) +
		var0to_a1a2a3_var2toNUM0var1toa2->(var0->_a1a2a3_ + var2->NUM0 + var1->a2) +
		var0to_a1a2a3_var2toNUM1var1toa1->(var0->_a1a2a3_ + var2->NUM1 + var1->a1) +
		var1toa1var0to_a1a3_var2toNUM2->(var1->a1 + var0->_a1a3_ + var2->NUM2) +
		var2toNUM0var1toa3var0to_a1a3_->(var2->NUM0 + var1->a3 + var0->_a1a3_) +
		var2toNUM1var1toa2var0to_a1a3_->(var2->NUM1 + var1->a2 + var0->_a1a3_) +
		var1toa3var0to_a2a3_var2toNUM2->(var1->a3 + var0->_a2a3_ + var2->NUM2) +
		var0to_a1a2a3_var1toa2var2toNUM2->(var0->_a1a2a3_ + var1->a2 + var2->NUM2) +
		var1toa3var0to_a1a2_->(var1->a3 + var0->_a1a2_) +
		var0to_a1a2a3_var1toa3var2toNUM1->(var0->_a1a2a3_ + var1->a3 + var2->NUM1) +
		var2toNUM0var1toa1var0to_a1a2_->(var2->NUM0 + var1->a1 + var0->_a1a2_) +
		var1toa1var0to_a1a2_->(var1->a1 + var0->_a1a2_) +
		var0to_a1a2_var1toa2var2toNUM2->(var0->_a1a2_ + var1->a2 + var2->NUM2) +
		var1toa3var2toNUM1var0to_a1a2_->(var1->a3 + var2->NUM1 + var0->_a1a2_) +
		var2toNUM0var0to_a1a2_var1toa2->(var2->NUM0 + var0->_a1a2_ + var1->a2) +
		var2toNUM1var1toa1var0to_a1a2_->(var2->NUM1 + var1->a1 + var0->_a1a2_) +
		var0to_a1a2a3_var1toa3->(var0->_a1a2a3_ + var1->a3) +
		var0to_a1a2a3_var1toa1->(var0->_a1a2a3_ + var1->a1) +
		var1toa1var0to_a1a3_->(var1->a1 + var0->_a1a3_) +
		var0to_a2a3_var1toa2->(var0->_a2a3_ + var1->a2) +
		var2toNUM0var1toa1var0to_a1a3_->(var2->NUM0 + var1->a1 + var0->_a1a3_) +
		var2toNUM0var0to_a2a3_var1toa2->(var2->NUM0 + var0->_a2a3_ + var1->a2) +
		var2toNUM1var1toa1var0to_a2a3_->(var2->NUM1 + var1->a1 + var0->_a2a3_)

	baseName = Phase2ba1NUM1v1->Phase2b +
