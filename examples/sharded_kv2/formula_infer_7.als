...
fact PartialInstance {
	lastIdx = (PT1->T6) + (PT11->T6) + (PT13->T4) + (PT3->T4) + (PT7->T5) + (PT2->T4) + (PT8->T5) + (PT12->T2) + (PT4->T4) + (PT10->T5) + (NT1->T6)
	...
	path = (PT1 -> (T0->ReshardK1V1N1N1 + T1->RecvTransferMsgN1K1V1 + T2->ReshardK1V2N1N2 + T3->RecvTransferMsgN2K1V2 + T4->ReshardK2V2N2N1 + T5->RecvTransferMsgN1K2V2)) +
		(PT11 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V2N2N1 + T2->ReshardK1V1N2N2 + T3->RecvTransferMsgN1K1V1 + T4->RecvTransferMsgN1K1V2 + T5->RecvTransferMsgN2K1V1)) +
		(PT13 -> (T0->ReshardK2V1N1N1 + T1->RecvTransferMsgN1K2V1 + T2->ReshardK2V1N1N1 + T3->RecvTransferMsgN1K2V1)) +
		(PT3 -> (T0->ReshardK2V1N1N1 + T1->ReshardK2V2N1N1 + T2->RecvTransferMsgN1K2V1 + T3->RecvTransferMsgN1K2V2)) +
		(PT7 -> (T0->ReshardK1V1N1N1 + T1->ReshardK2V1N1N1 + T2->ReshardK1V1N2N2 + T3->RecvTransferMsgN1K1V1 + T4->RecvTransferMsgN2K1V1)) +
		(PT2 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V2N2N1 + T2->RecvTransferMsgN1K1V1 + T3->RecvTransferMsgN1K1V2)) +
		(PT8 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V1N1N1 + T2->RecvTransferMsgN1K1V1 + T3->ReshardK1V1N1N1 + T4->RecvTransferMsgN1K2V1)) +
		(PT12 -> (T0->ReshardK1V1N2N1 + T1->ReshardK2V1N2N1)) +
		(PT4 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V1N2N2 + T2->RecvTransferMsgN1K1V1 + T3->RecvTransferMsgN2K1V1)) +
		(PT10 -> (T0->ReshardK1V2N2N1 + T1->ReshardK1V1N1N1 + T2->ReshardK2V1N1N1 + T3->RecvTransferMsgN1K1V1 + T4->RecvTransferMsgN1K1V2)) +
