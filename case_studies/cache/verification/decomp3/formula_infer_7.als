...
fun envVarTypes : set(Var->Sort) {
	var2->Core + var1->Value + var0->Value
}
...
one sig var2toc1var0tov2var1tov2 extends Env {} {}
one sig var2toc2var1tov1var0tov2 extends Env {} {}
one sig var2toc2var0tov1var1tov2 extends Env {} {}
one sig var0tov1 extends Env {} {}
one sig var2toc1var1tov1var0tov1 extends Env {} {}
one sig var0tov2 extends Env {} {}
one sig var2toc1var1tov1var0tov2 extends Env {} {}
one sig var2toc1var0tov1var1tov2 extends Env {} {}
one sig var2toc2var1tov1var0tov1 extends Env {} {}
...
one sig var2toc2var0tov2var1tov2 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT1->T8) + (NT1->T8)
	...
	maps = var2toc1var0tov2var1tov2->(var2->c1 + var0->v2 + var1->v2) +
		var2toc2var1tov1var0tov2->(var2->c2 + var1->v1 + var0->v2) +
		var2toc2var0tov1var1tov2->(var2->c2 + var0->v1 + var1->v2) +
		var0tov1->(var0->v1) +
		var2toc1var1tov1var0tov1->(var2->c1 + var1->v1 + var0->v1) +
		var0tov2->(var0->v2) +
		var2toc1var1tov1var0tov2->(var2->c1 + var1->v1 + var0->v2) +
		var2toc1var0tov1var1tov2->(var2->c1 + var0->v1 + var1->v2) +
		var2toc2var1tov1var0tov1->(var2->c2 + var1->v1 + var0->v1) +
		...
		var2toc2var0tov2var1tov2->(var2->c2 + var0->v2 + var1->v2)
