...
one sig Phase1ba3NUM1 extends Act {} {
	params = (P0->a3 + P1->NUM1)
}
...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT6->T2) + (PT11->T2) + (PT18->T2) + (PT5->T2) + (PT22->T3) + (PT13->T3) + (PT23->T3) + (PT10->T2) + (PT3->T2) + (PT25->T4) + (PT1->T2) + (PT26->T4) + (PT24->T3) + (PT21->T3) + (PT15->T2) + (PT17->T2) + (PT4->T2) + (PT27->T4) + (PT12->T3) + (PT16->T2) + (PT9->T2) + (PT8->T2) + (NT1->T2)

	path = (PT6 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2ba1NUM0v1)) +
		(PT11 -> (T0->Phase1ba1NUM2 + T1->Phase1ba2NUM2 + T2->Phase2ba1NUM2v1)) +
		(PT18 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2ba3NUM0v1)) +
		(PT5 -> (T0->Phase1ba1NUM1 + T1->Phase1ba3NUM1 + T2->Phase2ba1NUM1v1)) +
		...
		(PT9 -> (T0->Phase1ba1NUM1 + T1->Phase1ba2NUM1 + T2->Phase2ba1NUM1v1)) +
