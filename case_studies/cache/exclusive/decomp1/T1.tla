...
VARIABLES shared, invalid, proc_read, proc_write, bus_in_use, bus_read, bus_read_for_ownership, bus_upgrade, bus_transfer

vars == <<shared, invalid, proc_read, proc_write, bus_in_use, bus_read, bus_read_for_ownership, bus_upgrade, bus_transfer>>
...
issue_proc_read_invalid(c, a) ==
    ...
    /\ UNCHANGED<<shared, invalid, proc_write, bus_read_for_ownership, bus_upgrade, bus_transfer>>

do_bus_read_invalid(c, a) ==
    /\ bus_read[c][a]
    /\ invalid[c][a]
    /\ bus_read' = [bus_read EXCEPT![c][a] = FALSE]
    /\ UNCHANGED<<shared, invalid, proc_read, proc_write, bus_in_use, bus_read_for_ownership, bus_upgrade, bus_transfer>>
...
issue_proc_write_invalid(c, a, v) ==
    ...
    /\ UNCHANGED<<shared, invalid, proc_read, bus_read, bus_upgrade, bus_transfer>>
...
do_bus_read_for_ownership_invalid(c, a) ==
    ...
    /\ UNCHANGED<<shared, invalid, proc_read, proc_write, bus_in_use, bus_read, bus_upgrade, bus_transfer>>
...
issue_proc_write_shared(c, a, v) ==
    ...
    /\ UNCHANGED<<shared, invalid, proc_read, bus_read, bus_read_for_ownership, bus_transfer>>
