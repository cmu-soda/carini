...
one sig var0toa3var2toNUM2var1tov2 extends Env {} {}
...
one sig var1tov1var0toa1var2toNUM2 extends Env {} {}
one sig var0toa3var2toNUM0var1tov1 extends Env {} {}
...
one sig var1tov1var2toNUM2var0toa2 extends Env {} {}
one sig var0toa1var2toNUM2var1tov2 extends Env {} {}
one sig var0toa3var2toNUM0var1tov2 extends Env {} {}
one sig var0toa3var1tov1var2toNUM1 extends Env {} {}
one sig var2toNUM1var1tov2var0toa2 extends Env {} {}
one sig var0toa3var1tov1var2toNUM2 extends Env {} {}
one sig var2toNUM2var1tov2var0toa2 extends Env {} {}
one sig var0toa3var2toNUM1var1tov2 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT9->T1) + (PT7->T1) + (PT1->T2) + (PT11->T1) + (PT8->T0) + (PT5->T0) + (PT3->T0) + (PT10->T1) + (NT1->T3)
	...
	maps = var0toa3var2toNUM2var1tov2->(var0->a3 + var2->NUM2 + var1->v2) +
		...
		var0toa2->(var0->a2) +
		var0toa3->(var0->a3) +
		var2toNUM0var1tov1var0toa1->(var2->NUM0 + var1->v1 + var0->a1) +
		...
		var1tov1var0toa1var2toNUM2->(var1->v1 + var0->a1 + var2->NUM2) +
		var0toa3var2toNUM0var1tov1->(var0->a3 + var2->NUM0 + var1->v1) +
		...
		var1tov1var2toNUM2var0toa2->(var1->v1 + var2->NUM2 + var0->a2) +
		var0toa1var2toNUM2var1tov2->(var0->a1 + var2->NUM2 + var1->v2) +
		var0toa3var2toNUM0var1tov2->(var0->a3 + var2->NUM0 + var1->v2) +
		var0toa3var1tov1var2toNUM1->(var0->a3 + var1->v1 + var2->NUM1) +
		var2toNUM1var1tov2var0toa2->(var2->NUM1 + var1->v2 + var0->a2) +
		var0toa3var1tov1var2toNUM2->(var0->a3 + var1->v1 + var2->NUM2) +
		var2toNUM2var1tov2var0toa2->(var2->NUM2 + var1->v2 + var0->a2) +
		var0toa3var2toNUM1var1tov2->(var0->a3 + var2->NUM1 + var1->v2)
