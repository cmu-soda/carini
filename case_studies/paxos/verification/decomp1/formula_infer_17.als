...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT23->T2) + (PT21->T2) + (PT1->T3) + (PT27->T2) + (PT25->T2) + (PT45->T2) + (PT41->T2) + (PT22->T1) + (PT48->T1) + (PT14->T1) + (PT6->T1) + (PT32->T2) + (PT20->T2) + (PT4->T1) + (PT24->T2) + (PT31->T3) + (PT34->T3) + (PT35->T3) + (PT42->T2) + (PT19->T2) + (PT38->T3) + (PT12->T1) + (PT37->T3) + (PT43->T2) + (PT40->T2) + (PT7->T1) + (PT11->T1) + (PT33->T2) + (PT17->T2) + (PT18->T2) + (PT15->T2) + (PT47->T2) + (PT36->T3) + (PT26->T2) + (PT29->T1) + (PT46->T2) + (PT30->T2) + (NT1->T3)
