...
fact PartialInstance {
	lastIdx = (PT1->T5) + (PT11->T4) + (PT16->T5) + (PT17->T4) + (PT12->T4) + (PT15->T4) + (PT24->T6) + (PT14->T4) + (PT21->T6) + (PT22->T3) + (PT20->T4) + (PT23->T3) + (NT1->T5)
	...
	path = (PT1 -> (T0->ReshardK1V1N1N1 + T1->RecvTransferMsgN1K1V1 + T2->ReshardK1V1N1N2 + T3->RecvTransferMsgN2K1V1 + T4->ReshardK1V1N1N1)) +
		...
		(NT1 -> (T0->ReshardK1V1N1N1 + T1->RecvTransferMsgN1K1V1 + T2->ReshardK1V1N1N2 + T3->RecvTransferMsgN1K1V1 + T4->RecvTransferMsgN2K1V1))
