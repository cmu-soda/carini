...
VARIABLES cache, memory, Fluent3_6, Fluent2_6, bus_transfer, bus_read, bus_in_use, proc_write, proc_read, bus_read_for_ownership, invalid, modified, bus_upgrade

vars == <<cache, memory, Fluent3_6, Fluent2_6, bus_transfer, bus_read, bus_in_use, proc_write, proc_read, bus_read_for_ownership, invalid, modified, bus_upgrade>>

CandSep ==
\A var0 \in Core : (Fluent2_6[var0]) => (Fluent3_6[var0])
...
/\ Fluent2_6' = [Fluent2_6 EXCEPT ![c] = TRUE]
/\ UNCHANGED<<Fluent3_6>>
/\ CandSep'
