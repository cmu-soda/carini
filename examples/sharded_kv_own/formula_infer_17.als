...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT99->T6) + (PT89->T5) + (PT62->T4) + (PT95->T6) + (PT90->T5) + (PT96->T5) + (PT71->T5) + (PT77->T5) + (PT101->T6) + (PT93->T5) + (PT87->T5) + (PT82->T6) + (PT81->T4) + (PT94->T7) + (PT110->T6) + (PT80->T6) + (PT61->T4) + (PT72->T3) + (PT98->T5) + (PT97->T5) + (PT73->T3) + (PT54->T2) + (PT83->T5) + (PT75->T5) + (PT88->T5) + (PT64->T4) + (PT92->T5) + (PT91->T4) + (PT104->T5) + (PT105->T5) + (PT103->T5) + (PT85->T4) + (PT100->T4) + (PT86->T5) + (PT106->T3) + (PT65->T3) + (PT114->T5) + (PT102->T6) + (PT111->T4) + (PT108->T4) + (PT84->T5) + (PT107->T5) + (PT109->T5) + (PT66->T4) + (PT74->T6) + (PT1->T6) + (PT67->T4) + (PT76->T4) + (PT112->T5) + (NT1->T6)

	path = (PT99 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V2N2N1 + T2->RecvTransferMsgN1K2V1 + T3->PutN1K2V1 + T4->ReshardK2V1N1N2 + T5->RecvTransferMsgN2K2V1 + T6->RecvTransferMsgN1K1V2)) +
	...
	maps = var0toN2var1toV1var2toK1->(var0->N2 + var1->V1 + var2->K1) +
