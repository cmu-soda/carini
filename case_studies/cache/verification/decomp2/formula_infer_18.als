...
fun envVarTypes : set(Var->Sort) {
	var2->Core + var1->Address + var0->Address
}
...
one sig var2toc1var1toa1var0toa2 extends Env {} {}
one sig var2toc1var0toa1var1toa2 extends Env {} {}
one sig var2toc2var0toa1var1toa1 extends Env {} {}
one sig var2toc1var1toa2var0toa2 extends Env {} {}
one sig var2toc2var1toa1var0toa2 extends Env {} {}
one sig var2toc2var0toa1var1toa2 extends Env {} {}
one sig var2toc1var0toa1var1toa1 extends Env {} {}
...
one sig var2toc2var1toa2var0toa2 extends Env {} {}
one sig var0toa2 extends Env {} {}
one sig var1toa2var0toa2 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT50->T5) + (PT52->T5) + (PT25->T4) + (PT49->T4) + (PT55->T6) + (PT32->T4) + (PT60->T5) + (PT15->T3) + (PT1->T9) + (PT35->T4) + (PT36->T4) + (PT29->T3) + (PT53->T4) + (PT44->T2) + (PT57->T6) + (PT56->T6) + (PT22->T4) + (PT48->T6) + (PT39->T4) + (PT12->T3) + (NT1->T9)

	path = (PT50 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_validc2a1v1 + T2->complete_proc_read_invalid_sharedc1a1v1 + T3->issue_proc_write_invalidc1a1v1 + T4->do_bus_read_for_ownership_validc2a1v1 + T5->complete_proc_write_sharedc1a1v1)) +
		(PT52 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_invalidc2a1 + T2->complete_proc_read_invalid_exclusivec1a1v1 + T3->issue_proc_write_sharedc1a1v1 + T4->do_bus_upgradec2a1 + T5->complete_proc_write_sharedc1a1v1)) +
		(PT25 -> (T0->issue_proc_write_invalidc1a1v1 + T1->complete_proc_write_sharedc1a1v1 + T2->issue_proc_read_invalidc1a1 + T3->do_bus_read_validc2a1v1 + T4->complete_proc_read_invalid_sharedc1a1v1)) +
		...
		(PT56 -> (T0->issue_proc_write_invalidc1a1v1 + T1->complete_proc_write_sharedc1a1v1 + T2->issue_proc_write_invalidc1a1v1 + T3->do_bus_read_for_ownership_invalidc2a1 + T4->complete_proc_write_invalidc1a1v1 + T5->issue_proc_read_invalidc1a1 + T6->do_bus_read_validc2a1v1)) +
	...
	maps = var2toc1var1toa1var0toa2->(var2->c1 + var1->a1 + var0->a2) +
		var2toc1var0toa1var1toa2->(var2->c1 + var0->a1 + var1->a2) +
		var2toc2var0toa1var1toa1->(var2->c2 + var0->a1 + var1->a1) +
		var2toc1var1toa2var0toa2->(var2->c1 + var1->a2 + var0->a2) +
		var2toc2var1toa1var0toa2->(var2->c2 + var1->a1 + var0->a2) +
		var2toc2var0toa1var1toa2->(var2->c2 + var0->a1 + var1->a2) +
		var2toc1var0toa1var1toa1->(var2->c1 + var0->a1 + var1->a1) +
		var0toa1var1toa1->(var0->a1 + var1->a1) +
		var0toa1->(var0->a1) +
		var1toa1var0toa2->(var1->a1 + var0->a2) +
		var0toa1var1toa2->(var0->a1 + var1->a2) +
		var2toc2var1toa2var0toa2->(var2->c2 + var1->a2 + var0->a2) +
		var0toa2->(var0->a2) +
