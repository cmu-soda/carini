...
VARIABLES maxVal, msgs1b, Fluent12_9, msgs2b, Fluent13_9, maxVBal

vars == <<maxVal, msgs1b, Fluent12_9, msgs2b, Fluent13_9, maxVBal>>

CandSep ==
\A var0 \in Ballot : \E var1 \in Value : (Fluent12_9[var1][var0]) => (~(Fluent13_9[var1]))
...
/\ msgs1b = {}
/\ msgs2b = {}
/\ Fluent12_9 = [ x0 \in Value |-> [ x1 \in Ballot |-> FALSE]]
/\ Fluent13_9 = [ x0 \in Value |-> FALSE]

Phase1b(a,b) ==
/\ msgs1b' = (msgs1b \cup {<<a,b,maxVBal[a],maxVal[a]>>})
/\ UNCHANGED <<maxVBal,maxVal,msgs2b>>
/\ UNCHANGED<<Fluent12_9, Fluent13_9>>
/\ CandSep'
...
/\ Fluent12_9' = [Fluent12_9 EXCEPT ![v][b] = TRUE]
/\ Fluent13_9' = [Fluent13_9 EXCEPT ![v] = TRUE]
/\ UNCHANGED<<>>
/\ CandSep'
