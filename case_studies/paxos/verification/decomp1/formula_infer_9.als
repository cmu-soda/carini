...
fun envVarTypes : set(Var->Sort) {
	var2->Acceptor + var1->Value + var0->Ballot
}
...
one sig var0toNUM0var1tov1var2toa1 extends Env {} {}
one sig var0toNUM1 extends Env {} {}
one sig var0toNUM0var1tov1 extends Env {} {}
one sig var1tov1var0toNUM1var2toa1 extends Env {} {}
one sig var0toNUM0var2toa1var1tov2 extends Env {} {}
one sig var2toa2var0toNUM0var1tov1 extends Env {} {}
one sig var1tov1var0toNUM1 extends Env {} {}
one sig var0toNUM0var1tov2 extends Env {} {}
one sig var0toNUM1var2toa1var1tov2 extends Env {} {}
one sig var0toNUM0 extends Env {} {}
one sig var2toa2var1tov1var0toNUM1 extends Env {} {}
one sig var2toa2var0toNUM0var1tov2 extends Env {} {}
one sig var2toa2var0toNUM1var1tov2 extends Env {} {}
one sig var0toNUM1var1tov2 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT23->T2) + (PT21->T2) + (PT1->T3) + (PT16->T2) + (PT27->T2) + (PT25->T2) + (PT13->T1) + (PT22->T1) + (PT14->T1) + (PT6->T1) + (PT32->T2) + (PT5->T1) + (PT20->T2) + (PT4->T1) + (PT24->T2) + (PT31->T3) + (PT34->T3) + (PT35->T3) + (PT19->T2) + (PT3->T1) + (PT38->T3) + (PT12->T1) + (PT37->T3) + (PT7->T1) + (PT11->T1) + (PT33->T2) + (PT17->T2) + (PT18->T2) + (PT15->T2) + (PT36->T3) + (PT26->T2) + (PT29->T1) + (PT30->T2) + (NT1->T3)
	...
	maps = var0toNUM0var1tov1var2toa1->(var0->NUM0 + var1->v1 + var2->a1) +
		var0toNUM1->(var0->NUM1) +
		var0toNUM0var1tov1->(var0->NUM0 + var1->v1) +
		var1tov1var0toNUM1var2toa1->(var1->v1 + var0->NUM1 + var2->a1) +
		var0toNUM0var2toa1var1tov2->(var0->NUM0 + var2->a1 + var1->v2) +
		var2toa2var0toNUM0var1tov1->(var2->a2 + var0->NUM0 + var1->v1) +
		var1tov1var0toNUM1->(var1->v1 + var0->NUM1) +
		var0toNUM0var1tov2->(var0->NUM0 + var1->v2) +
		var0toNUM1var2toa1var1tov2->(var0->NUM1 + var2->a1 + var1->v2) +
		var0toNUM0->(var0->NUM0) +
		var2toa2var1tov1var0toNUM1->(var2->a2 + var1->v1 + var0->NUM1) +
		var2toa2var0toNUM0var1tov2->(var2->a2 + var0->NUM0 + var1->v2) +
		var2toa2var0toNUM1var1tov2->(var2->a2 + var0->NUM1 + var1->v2) +
