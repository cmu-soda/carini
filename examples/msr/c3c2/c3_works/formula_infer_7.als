...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT15->T3) + (PT12->T3) + (PT1->T6) + (PT3->T2) + (NT1->T7)

	path = (PT15 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->BecomeLeadern1_n1n3_NUM2 + T3->ClientRequestn1NUM2)) +
		(PT12 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->BecomeLeadern2_n1n2_NUM2 + T3->ClientRequestn2NUM2)) +
