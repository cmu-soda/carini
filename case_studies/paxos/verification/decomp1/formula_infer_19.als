...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT23->T2) + (PT28->T2) + (PT21->T2) + (PT1->T3) + (PT27->T2) + (PT25->T2) + (PT10->T1) + (PT22->T1) + (PT14->T1) + (PT6->T1) + (PT20->T2) + (PT4->T1) + (PT24->T2) + (PT31->T3) + (PT19->T2) + (PT12->T1) + (PT7->T1) + (PT11->T1) + (PT17->T2) + (PT18->T2) + (PT15->T2) + (PT26->T2) + (PT29->T1) + (PT30->T2) + (NT1->T3)
	...
	maps = var2toNUM0var1toa2var0toa2->(var2->NUM0 + var1->a2 + var0->a2) +
