...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT23->T2) + (PT24->T2) + (PT31->T3) + (PT34->T3) + (PT21->T2) + (PT35->T3) + (PT1->T3) + (PT19->T2) + (PT38->T3) + (PT27->T2) + (PT25->T2) + (PT12->T1) + (PT37->T3) + (PT7->T1) + (PT11->T1) + (PT18->T2) + (PT14->T1) + (PT6->T1) + (PT36->T3) + (PT26->T2) + (PT20->T2) + (PT4->T1) + (PT30->T2) + (NT1->T3)
	...
	maps = var0toa1var1toa1var2toa1->(var0->a1 + var1->a1 + var2->a1) +
	...
	baseName = Phase2aNUM0v2a1->Phase2a +
