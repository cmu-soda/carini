...
fact PartialInstance {
	...
	path = (PT1 -> (T0->RcvPreparer1 + T1->RcvPreparer2 + T2->RcvPreparer3 + T3->SndAbortr1 + T4->SndAbortr1)) +
		(PT2 -> (T0->RcvPreparer1 + T1->RcvPreparer2 + T2->RcvPreparer3 + T3->SndCommitr1)) +
		(NT1 -> (T0->RcvPreparer1 + T1->RcvPreparer2 + T2->RcvPreparer3 + T3->SndAbortr1 + T4->SndCommitr2))
	...
	baseName = SndCommitr2->SndCommit +
		SndAbortr1->SndAbort +
