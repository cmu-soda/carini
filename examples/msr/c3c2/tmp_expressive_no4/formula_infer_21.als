...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT15->T3) + (PT3->T2) + (PT16->T3) + (PT10->T2) + (PT1->T9) + (NT1->T9)

	path = (PT15 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->BecomeLeadern1_n1n3_NUM2 + T3->CommitEntryn1_n1n3_NUM1NUM2NUM2)) +
		(PT3 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->CommitEntryn1_n1n2_NUM2NUM1NUM1)) +
		(PT16 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->BecomeLeadern1_n1n2_NUM2 + T3->CommitEntryn1_n1n2_NUM1NUM2NUM2)) +
		(PT10 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->BecomeLeadern2_n2n3_NUM2 + T2->ClientRequestn1NUM1)) +
