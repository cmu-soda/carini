...
fun envVarTypes : set(Var->Sort) {
	var2->Quorum + var1->Acceptor + var0->Value
}
...
one sig var2to_a1a2_var0tov2var1toa2 extends Env {} {}
one sig var1toa3var2to_a1a2_var0tov1 extends Env {} {}
one sig var1toa3var0tov2 extends Env {} {}
one sig var1toa3var2to_a1a2_var0tov2 extends Env {} {}
one sig var2to_a1a2_var0tov1var1toa1 extends Env {} {}
one sig var2to_a1a2_var1toa1var0tov2 extends Env {} {}
one sig var2to_a1a2_var0tov1var1toa2 extends Env {} {}
...
one sig var2to_a1a2a3_var0tov2var1toa2 extends Env {} {}
one sig var2to_a1a2a3_var1toa3var0tov1 extends Env {} {}
one sig var2to_a1a2a3_var1toa3var0tov2 extends Env {} {}
one sig var2to_a1a2a3_var1toa1var0tov2 extends Env {} {}
one sig var2to_a1a2a3_var0tov1var1toa2 extends Env {} {}
one sig var2to_a1a3_var1toa3var0tov2 extends Env {} {}
one sig var0tov1 extends Env {} {}
one sig var2to_a1a3_var0tov2var1toa2 extends Env {} {}
one sig var2to_a1a3_var1toa3var0tov1 extends Env {} {}
one sig var2to_a2a3_var0tov2var1toa2 extends Env {} {}
one sig var1toa3var0tov1var2to_a2a3_ extends Env {} {}
one sig var0tov2 extends Env {} {}
one sig var2to_a1a3_var1toa1var0tov2 extends Env {} {}
one sig var2to_a1a3_var0tov1var1toa2 extends Env {} {}
one sig var2to_a1a2a3_var0tov1var1toa1 extends Env {} {}
one sig var1toa3var2to_a2a3_var0tov2 extends Env {} {}
one sig var1toa1var2to_a2a3_var0tov2 extends Env {} {}
one sig var0tov1var2to_a2a3_var1toa2 extends Env {} {}
one sig var2to_a1a3_var0tov1var1toa1 extends Env {} {}
one sig var0tov1var1toa1var2to_a2a3_ extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT1->T1) + (PT7->T1) + (PT4->T1) + (PT8->T0) + (PT11->T0) + (NT1->T2)

	path = (PT1 -> (T0->Phase2aNUM0v1a1_a1a3_ + T1->Phase2aNUM1v2a2_a1a2_)) +
		(PT7 -> (T0->Phase2aNUM0v2a2_a1a2_ + T1->Phase2ba1NUM0v1)) +
		(PT4 -> (T0->Phase2aNUM1v1a1_a1a2_ + T1->Phase2ba1NUM1v1)) +
		(PT8 -> (T0->Phase2ba1NUM0v1)) +
		(PT11 -> (T0->Phase2ba1NUM0v1)) +
		(NT1 -> (T0->Phase2aNUM0v1a1_a1a3_ + T1->Phase2aNUM1v2a2_a1a2_ + T2->Phase2ba1NUM0v1))

	maps = var2to_a1a2_var0tov2var1toa2->(var2->_a1a2_ + var0->v2 + var1->a2) +
		var1toa3var2to_a1a2_var0tov1->(var1->a3 + var2->_a1a2_ + var0->v1) +
		var1toa3var0tov2->(var1->a3 + var0->v2) +
		var1toa3var2to_a1a2_var0tov2->(var1->a3 + var2->_a1a2_ + var0->v2) +
		var2to_a1a2_var0tov1var1toa1->(var2->_a1a2_ + var0->v1 + var1->a1) +
		var2to_a1a2_var1toa1var0tov2->(var2->_a1a2_ + var1->a1 + var0->v2) +
		var2to_a1a2_var0tov1var1toa2->(var2->_a1a2_ + var0->v1 + var1->a2) +
		...
		var2to_a1a2a3_var0tov2var1toa2->(var2->_a1a2a3_ + var0->v2 + var1->a2) +
		var2to_a1a2a3_var1toa3var0tov1->(var2->_a1a2a3_ + var1->a3 + var0->v1) +
		var2to_a1a2a3_var1toa3var0tov2->(var2->_a1a2a3_ + var1->a3 + var0->v2) +
		var2to_a1a2a3_var1toa1var0tov2->(var2->_a1a2a3_ + var1->a1 + var0->v2) +
		var2to_a1a2a3_var0tov1var1toa2->(var2->_a1a2a3_ + var0->v1 + var1->a2) +
		var2to_a1a3_var1toa3var0tov2->(var2->_a1a3_ + var1->a3 + var0->v2) +
		var0tov1->(var0->v1) +
		var2to_a1a3_var0tov2var1toa2->(var2->_a1a3_ + var0->v2 + var1->a2) +
		var2to_a1a3_var1toa3var0tov1->(var2->_a1a3_ + var1->a3 + var0->v1) +
		var2to_a2a3_var0tov2var1toa2->(var2->_a2a3_ + var0->v2 + var1->a2) +
		var1toa3var0tov1var2to_a2a3_->(var1->a3 + var0->v1 + var2->_a2a3_) +
		var0tov2->(var0->v2) +
		var2to_a1a3_var1toa1var0tov2->(var2->_a1a3_ + var1->a1 + var0->v2) +
		var2to_a1a3_var0tov1var1toa2->(var2->_a1a3_ + var0->v1 + var1->a2) +
		var2to_a1a2a3_var0tov1var1toa1->(var2->_a1a2a3_ + var0->v1 + var1->a1) +
		var1toa3var2to_a2a3_var0tov2->(var1->a3 + var2->_a2a3_ + var0->v2) +
		var1toa1var2to_a2a3_var0tov2->(var1->a1 + var2->_a2a3_ + var0->v2) +
		var0tov1var2to_a2a3_var1toa2->(var0->v1 + var2->_a2a3_ + var1->a2) +
		var2to_a1a3_var0tov1var1toa1->(var2->_a1a3_ + var0->v1 + var1->a1) +
		var0tov1var1toa1var2to_a2a3_->(var0->v1 + var1->a1 + var2->_a2a3_)
