...
one sig do_bus_upgradec2a1 extends Act {} {
	params = (P0->c2 + P1->a1)
}
...
one sig complete_proc_read_invalid_sharedc1a1v2 extends Act {} {
	params = (P0->c1 + P1->a1 + P2->v2)
}
one sig complete_proc_read_invalid_sharedc1a1v1 extends Act {} {
	params = (P0->c1 + P1->a1 + P2->v1)
}
...
one sig do_bus_read_for_ownership_validc2a1v1 extends Act {} {
	params = (P0->c2 + P1->a1 + P2->v1)
}
...
one sig complete_proc_write_sharedc1a1v2 extends Act {} {
	params = (P0->c1 + P1->a1 + P2->v2)
}
one sig complete_proc_write_sharedc2a1v1 extends Act {} {
	params = (P0->c2 + P1->a1 + P2->v1)
}
...
one sig do_bus_read_validc2a1v2 extends Act {} {
	params = (P0->c2 + P1->a1 + P2->v2)
}
one sig do_bus_read_validc2a1v1 extends Act {} {
	params = (P0->c2 + P1->a1 + P2->v1)
}
...
fact {
	...
	complete_proc_write_shared in FlSymAction.baseName // the final base name in the neg trace must appear in the sep formula
}


fun envVarTypes : set(Var->Sort) {
	var2->Core + var1->Address + var0->Core
}
...
one sig var2toc2var0toc2var1toa2 extends Env {} {}
one sig var0toc2var2toc1var1toa2 extends Env {} {}
one sig var0toc2var1toa1 extends Env {} {}
one sig var0toc1 extends Env {} {}
one sig var0toc1var1toa2 extends Env {} {}
one sig var2toc2var0toc2var1toa1 extends Env {} {}
one sig var2toc2var0toc1var1toa2 extends Env {} {}
one sig var0toc1var1toa1 extends Env {} {}
one sig var0toc2var2toc1var1toa1 extends Env {} {}
one sig var2toc1var0toc1var1toa2 extends Env {} {}
one sig var0toc2 extends Env {} {}
one sig var2toc2var0toc1var1toa1 extends Env {} {}
one sig var0toc2var1toa2 extends Env {} {}
one sig var2toc1var0toc1var1toa1 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT70->T7) + (PT50->T5) + (PT67->T5) + (PT55->T6) + (PT32->T4) + (PT60->T5) + (PT15->T3) + (PT62->T5) + (PT64->T5) + (PT69->T7) + (PT29->T3) + (PT44->T2) + (PT57->T6) + (PT22->T4) + (PT12->T3) + (PT71->T7) + (PT49->T4) + (PT1->T9) + (PT35->T4) + (PT36->T4) + (PT53->T4) + (PT48->T6) + (PT39->T4) + (NT1->T9)

	path = (PT70 -> (T0->issue_proc_write_invalidc1a1v1 + T1->complete_proc_write_sharedc1a1v1 + T2->issue_proc_write_invalidc1a1v1 + T3->do_bus_read_for_ownership_invalidc2a1 + T4->complete_proc_write_invalidc1a1v1 + T5->issue_proc_read_invalidc1a1 + T6->do_bus_read_validc2a1v1 + T7->complete_proc_read_invalid_sharedc1a1v1)) +
		(PT50 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_validc2a1v1 + T2->complete_proc_read_invalid_sharedc1a1v1 + T3->issue_proc_write_invalidc1a1v1 + T4->do_bus_read_for_ownership_validc2a1v1 + T5->complete_proc_write_sharedc1a1v1)) +
		(PT67 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_invalidc2a1 + T2->complete_proc_read_invalid_exclusivec1a1v1 + T3->issue_proc_write_sharedc1a1v1 + T4->do_bus_upgradec2a1 + T5->complete_proc_write_sharedc1a1v1)) +
		(PT55 -> (T0->issue_proc_write_invalidc1a1v1 + T1->complete_proc_write_sharedc1a1v1 + T2->issue_proc_write_sharedc1a1v1 + T3->do_bus_read_for_ownership_invalidc2a1 + T4->complete_proc_write_invalidc1a1v1 + T5->issue_proc_write_sharedc2a1v1 + T6->complete_proc_write_invalidc2a1v1)) +
		(PT32 -> (T0->issue_proc_write_invalidc1a1v1 + T1->do_bus_read_for_ownership_validc2a1v1 + T2->complete_proc_write_sharedc1a1v1 + T3->issue_proc_write_invalidc2a1v1 + T4->complete_proc_write_sharedc2a1v1)) +
		(PT60 -> (T0->issue_proc_write_invalidc1a1v1 + T1->complete_proc_write_sharedc1a1v1 + T2->issue_proc_read_invalidc1a1 + T3->do_bus_read_validc2a1v1 + T4->do_bus_read_for_ownership_invalidc2a1 + T5->complete_proc_read_invalid_sharedc1a1v1)) +
		(PT15 -> (T0->issue_proc_write_invalidc1a1v1 + T1->complete_proc_write_sharedc1a1v1 + T2->issue_proc_read_invalidc1a1 + T3->do_bus_read_for_ownership_invalidc2a1)) +
		(PT62 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_validc2a1v1 + T2->complete_proc_read_invalid_sharedc1a1v1 + T3->issue_proc_write_sharedc1a1v1 + T4->do_bus_upgradec2a1 + T5->complete_proc_write_sharedc1a1v1)) +
		(PT64 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_validc2a1v1 + T2->complete_proc_read_invalid_sharedc1a1v1 + T3->issue_proc_write_sharedc1a1v2 + T4->do_bus_upgradec2a1 + T5->complete_proc_write_sharedc1a1v2)) +
		(PT69 -> (T0->issue_proc_write_invalidc1a1v1 + T1->complete_proc_write_sharedc1a1v1 + T2->issue_proc_read_invalidc1a1 + T3->do_bus_read_validc2a1v1 + T4->complete_proc_read_invalid_sharedc1a1v1 + T5->issue_proc_write_invalidc1a1v1 + T6->do_bus_read_for_ownership_invalidc2a1 + T7->complete_proc_write_invalidc1a1v1)) +
		(PT29 -> (T0->issue_proc_write_invalidc1a1v1 + T1->complete_proc_write_sharedc1a1v1 + T2->issue_proc_read_invalidc1a1 + T3->do_bus_read_for_ownership_validc2a1v1)) +
		(PT44 -> (T0->issue_proc_write_sharedc1a1v1 + T1->do_bus_upgradec2a1 + T2->complete_proc_write_sharedc1a1v1)) +
		(PT57 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_validc2a1v1 + T2->complete_proc_read_invalid_sharedc1a1v1 + T3->issue_proc_write_invalidc1a1v1 + T4->complete_proc_write_sharedc1a1v1 + T5->issue_proc_write_invalidc2a1v1 + T6->do_bus_read_for_ownership_validc1a1v1)) +
		(PT22 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_validc2a1v2 + T2->complete_proc_read_invalid_sharedc1a1v2 + T3->issue_proc_write_invalidc1a1v1 + T4->complete_proc_write_sharedc1a1v1)) +
		(PT12 -> (T0->issue_proc_write_invalidc1a1v1 + T1->complete_proc_write_sharedc1a1v1 + T2->issue_proc_write_invalidc2a1v1 + T3->do_bus_read_for_ownership_validc1a1v1)) +
		(PT71 -> (T0->issue_proc_write_invalidc1a1v1 + T1->complete_proc_write_sharedc1a1v1 + T2->issue_proc_read_invalidc1a1 + T3->do_bus_read_invalidc2a1 + T4->do_bus_read_for_ownership_validc2a1v1 + T5->complete_proc_read_invalid_sharedc1a1v1 + T6->issue_proc_write_sharedc1a1v1 + T7->complete_proc_write_invalidc1a1v1)) +
		(PT49 -> (T0->issue_proc_write_invalidc1a1v1 + T1->do_bus_read_for_ownership_invalidc2a1 + T2->complete_proc_write_sharedc1a1v1 + T3->issue_proc_write_invalidc1a1v1 + T4->do_bus_read_for_ownership_validc2a1v1)) +
		(PT1 -> (T0->issue_proc_write_invalidc1a1v1 + T1->do_bus_read_for_ownership_invalidc2a1 + T2->complete_proc_write_invalidc1a1v1 + T3->issue_proc_write_invalidc2a1v2 + T4->do_bus_read_for_ownership_validc1a1v1 + T5->complete_proc_write_invalidc2a1v2 + T6->issue_proc_read_invalidc1a1 + T7->do_bus_read_validc2a1v2 + T8->complete_proc_read_invalid_sharedc1a1v2 + T9->issue_proc_read_invalidc1a2)) +
		(PT35 -> (T0->issue_proc_write_invalidc1a1v1 + T1->do_bus_read_for_ownership_validc2a1v1 + T2->complete_proc_write_invalidc1a1v1 + T3->issue_proc_write_invalidc2a1v1 + T4->complete_proc_write_sharedc2a1v1)) +
		(PT36 -> (T0->issue_proc_write_invalidc1a1v1 + T1->complete_proc_write_sharedc1a1v1 + T2->issue_proc_write_invalidc2a1v1 + T3->do_bus_read_for_ownership_validc2a1v1 + T4->complete_proc_write_sharedc2a1v1)) +
		(PT53 -> (T0->issue_proc_write_sharedc1a1v1 + T1->complete_proc_write_invalidc1a1v1 + T2->issue_proc_write_invalidc1a1v1 + T3->do_bus_upgradec2a1 + T4->complete_proc_write_sharedc1a1v1)) +
		(PT48 -> (T0->issue_proc_write_invalidc1a1v1 + T1->complete_proc_write_sharedc1a1v1 + T2->issue_proc_write_invalidc1a1v1 + T3->do_bus_read_for_ownership_invalidc2a1 + T4->complete_proc_write_invalidc1a1v1 + T5->issue_proc_write_sharedc1a1v2 + T6->complete_proc_write_invalidc1a1v2)) +
		(PT39 -> (T0->issue_proc_write_invalidc1a1v1 + T1->do_bus_read_for_ownership_invalidc2a1 + T2->complete_proc_write_invalidc1a1v1 + T3->issue_proc_write_invalidc1a1v1 + T4->complete_proc_write_sharedc1a1v1)) +
		(NT1 -> (T0->issue_proc_write_invalidc1a1v1 + T1->do_bus_read_for_ownership_invalidc2a1 + T2->complete_proc_write_invalidc1a1v1 + T3->issue_proc_write_invalidc2a1v2 + T4->do_bus_read_for_ownership_validc1a1v1 + T5->complete_proc_write_invalidc2a1v2 + T6->issue_proc_read_invalidc1a1 + T7->do_bus_read_validc2a1v2 + T8->complete_proc_read_invalid_sharedc1a1v2 + T9->complete_proc_write_sharedc1a1v1))

	maps = var2toc2var0toc2var1toa2->(var2->c2 + var0->c2 + var1->a2) +
		var0toc2var2toc1var1toa2->(var0->c2 + var2->c1 + var1->a2) +
		var0toc2var1toa1->(var0->c2 + var1->a1) +
		var0toc1->(var0->c1) +
		var0toc1var1toa2->(var0->c1 + var1->a2) +
		var2toc2var0toc2var1toa1->(var2->c2 + var0->c2 + var1->a1) +
		var2toc2var0toc1var1toa2->(var2->c2 + var0->c1 + var1->a2) +
		var0toc1var1toa1->(var0->c1 + var1->a1) +
		var0toc2var2toc1var1toa1->(var0->c2 + var2->c1 + var1->a1) +
		var2toc1var0toc1var1toa2->(var2->c1 + var0->c1 + var1->a2) +
		var0toc2->(var0->c2) +
		var2toc2var0toc1var1toa1->(var2->c2 + var0->c1 + var1->a1) +
		var0toc2var1toa2->(var0->c2 + var1->a2) +
		var2toc1var0toc1var1toa1->(var2->c1 + var0->c1 + var1->a1)

	baseName = issue_proc_write_invalidc2a1v1->issue_proc_write_invalid +
		issue_proc_write_invalidc2a1v2->issue_proc_write_invalid +
		complete_proc_write_sharedc1a1v2->complete_proc_write_shared +
		...
		complete_proc_write_sharedc2a1v1->complete_proc_write_shared +
		complete_proc_read_invalid_sharedc1a1v2->complete_proc_read_invalid_shared +
		issue_proc_write_sharedc1a1v2->issue_proc_write_shared +
		complete_proc_read_invalid_sharedc1a1v1->complete_proc_read_invalid_shared +
		do_bus_read_for_ownership_validc2a1v1->do_bus_read_for_ownership_valid +
		...
		do_bus_read_validc2a1v1->do_bus_read_valid +
		do_bus_read_validc2a1v2->do_bus_read_valid +
		do_bus_upgradec2a1->do_bus_upgrade +
...
one sig PT53 extends PosTrace {} {}
one sig PT48 extends PosTrace {} {}
