...
fact PartialInstance {
	lastIdx = (PT7->T4) + (PT4->T4) + (PT5->T4) + (PT8->T3) + (PT2->T4) + (PT1->T4) + (NT1->T4)

	path = (PT7 -> (T0->ReshardK1V1N1N1 + T1->ReshardK2V1N1N1 + T2->RecvTransferMsgN1K1V1 + T3->RecvTransferMsgN1K2V1)) +
		(PT4 -> (T0->ReshardK1V1N1N1 + T1->ReshardK2V2N1N1 + T2->RecvTransferMsgN1K1V1 + T3->RecvTransferMsgN1K2V2)) +
		(PT5 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V2N2N1 + T2->RecvTransferMsgN1K1V1 + T3->RecvTransferMsgN1K1V2)) +
		(PT8 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V1N1N2 + T2->RecvTransferMsgN1K1V1)) +
		(PT2 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V2N2N1 + T2->RecvTransferMsgN1K2V1 + T3->RecvTransferMsgN1K1V2)) +
		(PT1 -> (T0->ReshardK1V1N1N1 + T1->RecvTransferMsgN1K1V1 + T2->ReshardK1V1N1N2 + T3->RecvTransferMsgN2K1V1)) +
