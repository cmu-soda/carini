...
fun envVarTypes : set(Var->Sort) {
	var3->Key + var2->Key + var1->Node + var0->Value
}
...
one sig var1toN2var0toV2var3toK2var2toK2 extends Env {} {}
one sig var0toV1 extends Env {} {}
one sig var0toV2 extends Env {} {}
one sig var1toN2var0toV2var2toK2var3toK1 extends Env {} {}
one sig var1toN2var0toV2var2toK2 extends Env {} {}
one sig var1toN2var0toV2var3toK2var2toK1 extends Env {} {}
one sig var1toN1var0toV2var3toK2var2toK2 extends Env {} {}
one sig var1toN2var0toV1var3toK2var2toK2 extends Env {} {}
one sig var1toN2var0toV2var2toK1var3toK1 extends Env {} {}
one sig var1toN1var0toV2var2toK2var3toK1 extends Env {} {}
one sig var1toN2var0toV1var2toK2var3toK1 extends Env {} {}
one sig var1toN1var0toV2var3toK2var2toK1 extends Env {} {}
one sig var1toN2var0toV1var3toK2var2toK1 extends Env {} {}
one sig var0toV1var1toN1var3toK2var2toK2 extends Env {} {}
one sig var1toN1var0toV2var2toK1var3toK1 extends Env {} {}
one sig var1toN2var0toV1var2toK1var3toK1 extends Env {} {}
one sig var0toV1var1toN1var2toK2var3toK1 extends Env {} {}
one sig var0toV1var1toN1var3toK2var2toK1 extends Env {} {}
one sig var0toV1var1toN1var2toK1var3toK1 extends Env {} {}
one sig var1toN1var0toV2var2toK1 extends Env {} {}
one sig var1toN2var0toV1var2toK1 extends Env {} {}
one sig var0toV1var1toN1var2toK2 extends Env {} {}
one sig var1toN2var0toV2 extends Env {} {}
one sig var0toV1var1toN1var2toK1 extends Env {} {}
one sig var1toN2var0toV2var2toK1 extends Env {} {}
one sig var1toN1var0toV2var2toK2 extends Env {} {}
one sig var1toN2var0toV1var2toK2 extends Env {} {}
one sig var0toV1var1toN1 extends Env {} {}
one sig var1toN1var0toV2 extends Env {} {}
one sig var1toN2var0toV1 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT15->T3) + (PT13->T3) + (PT10->T3) + (PT6->T2) + (PT14->T2) + (PT12->T3) + (PT1->T4) + (PT11->T3) + (NT1->T4)

	path = (PT15 -> (T0->ReshardK2V2N1N1 + T1->OwnN1K1 + T2->ReshardK1V1N1N1 + T3->RecvTransferMsgN1K2V2)) +
		(PT13 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V1N2N2 + T2->RecvTransferMsgN1K1V1 + T3->OwnN1K2)) +
		(PT10 -> (T0->ReshardK1V1N1N1 + T1->ReshardK2V1N1N1 + T2->ReshardK2V1N1N2 + T3->RecvTransferMsgN1K1V1)) +
		(PT6 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V2N2N2 + T2->RecvTransferMsgN1K1V1)) +
		(PT14 -> (T0->ReshardK2V1N1N1 + T1->ReshardK2V1N1N2 + T2->RecvTransferMsgN1K2V1)) +
		(PT12 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V1N2N2 + T2->RecvTransferMsgN1K2V1 + T3->OwnN1K2)) +
		(PT1 -> (T0->OwnN1K1 + T1->ReshardK1V1N1N1 + T2->RecvTransferMsgN1K1V1 + T3->ReshardK1V1N1N2 + T4->RecvTransferMsgN2K1V1)) +
		(PT11 -> (T0->ReshardK1V1N1N1 + T1->ReshardK2V1N1N2 + T2->RecvTransferMsgN1K1V1 + T3->OwnN1K1)) +
		(NT1 -> (T0->OwnN1K1 + T1->ReshardK1V1N1N1 + T2->RecvTransferMsgN1K1V1 + T3->ReshardK1V1N1N2 + T4->RecvTransferMsgN1K1V1))

	maps = var1toN2var0toV2var3toK2var2toK2->(var1->N2 + var0->V2 + var3->K2 + var2->K2) +
		var0toV1->(var0->V1) +
		var0toV2->(var0->V2) +
		var1toN2var0toV2var2toK2var3toK1->(var1->N2 + var0->V2 + var2->K2 + var3->K1) +
		var1toN2var0toV2var2toK2->(var1->N2 + var0->V2 + var2->K2) +
		var1toN2var0toV2var3toK2var2toK1->(var1->N2 + var0->V2 + var3->K2 + var2->K1) +
		var1toN1var0toV2var3toK2var2toK2->(var1->N1 + var0->V2 + var3->K2 + var2->K2) +
		var1toN2var0toV1var3toK2var2toK2->(var1->N2 + var0->V1 + var3->K2 + var2->K2) +
		var1toN2var0toV2var2toK1var3toK1->(var1->N2 + var0->V2 + var2->K1 + var3->K1) +
		var1toN1var0toV2var2toK2var3toK1->(var1->N1 + var0->V2 + var2->K2 + var3->K1) +
		var1toN2var0toV1var2toK2var3toK1->(var1->N2 + var0->V1 + var2->K2 + var3->K1) +
		var1toN1var0toV2var3toK2var2toK1->(var1->N1 + var0->V2 + var3->K2 + var2->K1) +
		var1toN2var0toV1var3toK2var2toK1->(var1->N2 + var0->V1 + var3->K2 + var2->K1) +
		var0toV1var1toN1var3toK2var2toK2->(var0->V1 + var1->N1 + var3->K2 + var2->K2) +
		var1toN1var0toV2var2toK1var3toK1->(var1->N1 + var0->V2 + var2->K1 + var3->K1) +
		var1toN2var0toV1var2toK1var3toK1->(var1->N2 + var0->V1 + var2->K1 + var3->K1) +
		var0toV1var1toN1var2toK2var3toK1->(var0->V1 + var1->N1 + var2->K2 + var3->K1) +
		var0toV1var1toN1var3toK2var2toK1->(var0->V1 + var1->N1 + var3->K2 + var2->K1) +
		var0toV1var1toN1var2toK1var3toK1->(var0->V1 + var1->N1 + var2->K1 + var3->K1) +
		var1toN1var0toV2var2toK1->(var1->N1 + var0->V2 + var2->K1) +
		var1toN2var0toV1var2toK1->(var1->N2 + var0->V1 + var2->K1) +
		var0toV1var1toN1var2toK2->(var0->V1 + var1->N1 + var2->K2) +
		var1toN2var0toV2->(var1->N2 + var0->V2) +
		var0toV1var1toN1var2toK1->(var0->V1 + var1->N1 + var2->K1) +
		var1toN2var0toV2var2toK1->(var1->N2 + var0->V2 + var2->K1) +
		var1toN1var0toV2var2toK2->(var1->N1 + var0->V2 + var2->K2) +
		var1toN2var0toV1var2toK2->(var1->N2 + var0->V1 + var2->K2) +
		var0toV1var1toN1->(var0->V1 + var1->N1) +
		var1toN1var0toV2->(var1->N1 + var0->V2) +
		var1toN2var0toV1->(var1->N2 + var0->V1)
