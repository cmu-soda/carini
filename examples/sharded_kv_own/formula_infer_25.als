...
fact {
	...
	Put in FlSymAction.baseName // the final base name in the neg trace must appear in the sep formula
}
...
fact PartialInstance {
	...
	path = (PT1 -> (T0->OwnN1K1 + T1->PutN1K1V1 + T2->ReshardK1V1N1N1 + T3->RecvTransferMsgN1K1V1 + T4->OwnN2K2 + T5->PutN2K2V1)) +
		(NT1 -> (T0->OwnN1K1 + T1->PutN1K1V1 + T2->ReshardK1V1N1N1 + T3->RecvTransferMsgN1K1V1 + T4->OwnN2K2 + T5->PutN2K1V1))
