...
fun envVarTypes : set(Var->Sort) {
	var2->Ballot + var1->Ballot + var0->Acceptor
}
...
one sig var1toNUM0var2toNUM0var0toa1 extends Env {} {}
one sig var1toNUM0var2toNUM0var0toa2 extends Env {} {}
one sig var2toNUM0var1toNUM1var0toa1 extends Env {} {}
one sig var1toNUM0var0toa1var2toNUM1 extends Env {} {}
one sig var1toNUM0var0toa1var2toNUM2 extends Env {} {}
one sig var2toNUM0var0toa1var1toNUM2 extends Env {} {}
one sig var0toa3var1toNUM0var2toNUM0 extends Env {} {}
one sig var2toNUM0var1toNUM1var0toa2 extends Env {} {}
one sig var1toNUM0var2toNUM1var0toa2 extends Env {} {}
one sig var1toNUM1var0toa1var2toNUM1 extends Env {} {}
...
one sig var0toa3var1toNUM2var2toNUM2 extends Env {} {}
one sig var0toa3 extends Env {} {}
one sig var1toNUM2var0toa2 extends Env {} {}
one sig var0toa3var1toNUM1 extends Env {} {}
one sig var1toNUM0var2toNUM2var0toa2 extends Env {} {}
one sig var1toNUM1var0toa1var2toNUM2 extends Env {} {}
one sig var2toNUM0var1toNUM2var0toa2 extends Env {} {}
one sig var0toa3var2toNUM0var1toNUM1 extends Env {} {}
one sig var0toa1var2toNUM1var1toNUM2 extends Env {} {}
one sig var0toa3var1toNUM0var2toNUM1 extends Env {} {}
one sig var1toNUM1var2toNUM1var0toa2 extends Env {} {}
one sig var0toa1var1toNUM2var2toNUM2 extends Env {} {}
one sig var0toa3var1toNUM0var2toNUM2 extends Env {} {}
one sig var1toNUM1var2toNUM2var0toa2 extends Env {} {}
one sig var0toa3var2toNUM0var1toNUM2 extends Env {} {}
one sig var2toNUM1var1toNUM2var0toa2 extends Env {} {}
one sig var0toa3var1toNUM1var2toNUM1 extends Env {} {}
one sig var1toNUM2var2toNUM2var0toa2 extends Env {} {}
one sig var0toa3var1toNUM1var2toNUM2 extends Env {} {}
one sig var0toa3var2toNUM1var1toNUM2 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT12->T1) + (PT4->T1) + (PT1->T4) + (PT13->T2) + (PT10->T2) + (PT14->T2) + (PT7->T1) + (PT2->T0) + (PT8->T1) + (NT1->T4)

	path = (PT12 -> (T0->Phase1ba1NUM1 + T1->Phase2ba1NUM1v1)) +
		(PT4 -> (T0->Phase1ba1NUM0 + T1->Phase2ba1NUM1v1)) +
		(PT1 -> (T0->Phase1ba1NUM0 + T1->Phase1ba1NUM2 + T2->Phase1ba2NUM0 + T3->Phase1ba2NUM2 + T4->Phase2ba1NUM2v1)) +
		(PT13 -> (T0->Phase1ba1NUM0 + T1->Phase1ba1NUM2 + T2->Phase2ba2NUM0v1)) +
		(PT10 -> (T0->Phase1ba1NUM1 + T1->Phase1ba1NUM2 + T2->Phase2ba2NUM1v1)) +
		(PT14 -> (T0->Phase1ba1NUM0 + T1->Phase2ba1NUM0v2 + T2->Phase1ba1NUM2)) +
		(PT7 -> (T0->Phase1ba1NUM2 + T1->Phase2ba2NUM0v1)) +
		(PT2 -> (T0->Phase2ba1NUM0v1)) +
		(PT8 -> (T0->Phase1ba1NUM1 + T1->Phase2ba1NUM2v1)) +
		(NT1 -> (T0->Phase1ba1NUM0 + T1->Phase1ba1NUM2 + T2->Phase1ba2NUM0 + T3->Phase1ba2NUM2 + T4->Phase2ba1NUM0v1))

	maps = var1toNUM0var2toNUM0var0toa1->(var1->NUM0 + var2->NUM0 + var0->a1) +
		var1toNUM0var2toNUM0var0toa2->(var1->NUM0 + var2->NUM0 + var0->a2) +
		var2toNUM0var1toNUM1var0toa1->(var2->NUM0 + var1->NUM1 + var0->a1) +
		var1toNUM0var0toa1var2toNUM1->(var1->NUM0 + var0->a1 + var2->NUM1) +
		var1toNUM0var0toa1var2toNUM2->(var1->NUM0 + var0->a1 + var2->NUM2) +
		var2toNUM0var0toa1var1toNUM2->(var2->NUM0 + var0->a1 + var1->NUM2) +
		var0toa3var1toNUM0var2toNUM0->(var0->a3 + var1->NUM0 + var2->NUM0) +
		var2toNUM0var1toNUM1var0toa2->(var2->NUM0 + var1->NUM1 + var0->a2) +
		var1toNUM0var2toNUM1var0toa2->(var1->NUM0 + var2->NUM1 + var0->a2) +
		var1toNUM1var0toa1var2toNUM1->(var1->NUM1 + var0->a1 + var2->NUM1) +
		...
		var0toa3var1toNUM2var2toNUM2->(var0->a3 + var1->NUM2 + var2->NUM2) +
		var0toa3->(var0->a3) +
		var1toNUM2var0toa2->(var1->NUM2 + var0->a2) +
		var0toa3var1toNUM1->(var0->a3 + var1->NUM1) +
		var1toNUM0var2toNUM2var0toa2->(var1->NUM0 + var2->NUM2 + var0->a2) +
		var1toNUM1var0toa1var2toNUM2->(var1->NUM1 + var0->a1 + var2->NUM2) +
		var2toNUM0var1toNUM2var0toa2->(var2->NUM0 + var1->NUM2 + var0->a2) +
		var0toa3var2toNUM0var1toNUM1->(var0->a3 + var2->NUM0 + var1->NUM1) +
		var0toa1var2toNUM1var1toNUM2->(var0->a1 + var2->NUM1 + var1->NUM2) +
		var0toa3var1toNUM0var2toNUM1->(var0->a3 + var1->NUM0 + var2->NUM1) +
		var1toNUM1var2toNUM1var0toa2->(var1->NUM1 + var2->NUM1 + var0->a2) +
		var0toa1var1toNUM2var2toNUM2->(var0->a1 + var1->NUM2 + var2->NUM2) +
		var0toa3var1toNUM0var2toNUM2->(var0->a3 + var1->NUM0 + var2->NUM2) +
		var1toNUM1var2toNUM2var0toa2->(var1->NUM1 + var2->NUM2 + var0->a2) +
		var0toa3var2toNUM0var1toNUM2->(var0->a3 + var2->NUM0 + var1->NUM2) +
		var2toNUM1var1toNUM2var0toa2->(var2->NUM1 + var1->NUM2 + var0->a2) +
		var0toa3var1toNUM1var2toNUM1->(var0->a3 + var1->NUM1 + var2->NUM1) +
		var1toNUM2var2toNUM2var0toa2->(var1->NUM2 + var2->NUM2 + var0->a2) +
		var0toa3var1toNUM1var2toNUM2->(var0->a3 + var1->NUM1 + var2->NUM2) +
		var0toa3var2toNUM1var1toNUM2->(var0->a3 + var2->NUM1 + var1->NUM2)

	baseName = Phase2ba1NUM0v2->Phase2b +
