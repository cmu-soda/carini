...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT14->T3) + (PT5->T2) + (PT3->T2) + (PT19->T5) + (PT12->T2) + (PT18->T3) + (PT9->T2) + (PT16->T2) + (PT2->T2) + (PT20->T4) + (PT13->T2) + (PT1->T1) + (PT21->T5) + (PT17->T2) + (PT7->T2) + (PT15->T3) + (NT1->T1)

	path = (PT14 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2ba1NUM0v1 + T3->Phase2ba2NUM0v1)) +
		(PT5 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2ba1NUM0v1)) +
		(PT3 -> (T0->Phase1ba1NUM1 + T1->Phase1ba2NUM1 + T2->Phase2ba1NUM1v1)) +
		(PT19 -> (T0->Phase1ba1NUM0 + T1->Phase1ba1NUM1 + T2->Phase1ba2NUM0 + T3->Phase1ba2NUM1 + T4->Phase2ba2NUM0v1 + T5->Phase2ba1NUM1v1)) +
		(PT12 -> (T0->Phase1ba1NUM1 + T1->Phase1ba2NUM1 + T2->Phase2ba2NUM1v1)) +
		(PT18 -> (T0->Phase1ba1NUM1 + T1->Phase1ba2NUM1 + T2->Phase2ba1NUM1v1 + T3->Phase2ba2NUM1v1)) +
		(PT9 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2ba1NUM0v2)) +
		(PT16 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2ba2NUM0v1)) +
		(PT2 -> (T0->Phase1ba1NUM0 + T1->Phase1ba3NUM0 + T2->Phase2ba1NUM0v1)) +
		(PT20 -> (T0->Phase1ba1NUM1 + T1->Phase1ba2NUM1 + T2->Phase1ba1NUM2 + T3->Phase2ba1NUM1v1 + T4->Phase2ba2NUM1v1)) +
		(PT13 -> (T0->Phase1ba1NUM1 + T1->Phase1ba2NUM1 + T2->Phase2ba2NUM1v1)) +
		(PT1 -> (T0->Phase1ba1NUM1 + T1->Phase1ba2NUM1)) +
		(PT21 -> (T0->Phase1ba1NUM1 + T1->Phase1ba1NUM2 + T2->Phase1ba2NUM2 + T3->Phase1ba2NUM1 + T4->Phase2ba1NUM1v1 + T5->Phase2ba2NUM2v1)) +
		(PT17 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2ba2NUM0v1)) +
		(PT7 -> (T0->Phase1ba1NUM0 + T1->Phase1ba3NUM0 + T2->Phase2ba1NUM0v1)) +
		(PT15 -> (T0->Phase1ba1NUM2 + T1->Phase1ba2NUM2 + T2->Phase2ba1NUM2v1 + T3->Phase2ba2NUM2v1)) +
		(NT1 -> (T0->Phase1ba1NUM1 + T1->Phase2ba1NUM1v1))
