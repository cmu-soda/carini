...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT1->T1) + (PT3->T2) + (PT11->T2) + (PT7->T2) + (PT2->T2) + (PT10->T2) + (NT1->T1)

	path = (PT1 -> (T0->Phase1ba1NUM1 + T1->Phase1ba2NUM1)) +
		(PT3 -> (T0->Phase1ba1NUM2 + T1->Phase1ba2NUM2 + T2->Phase2ba1NUM2v1)) +
		(PT11 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2ba1NUM0v1)) +
		(PT7 -> (T0->Phase1ba1NUM0 + T1->Phase1ba3NUM0 + T2->Phase2ba1NUM0v1)) +
		(PT2 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2ba1NUM0v1)) +
		(PT10 -> (T0->Phase1ba1NUM1 + T1->Phase1ba2NUM1 + T2->Phase2ba1NUM1v1)) +
		(NT1 -> (T0->Phase1ba1NUM1 + T1->Phase2ba2NUM0v1))
