...
one sig var1toV1var0toV2var2toK1 extends Env {} {}
one sig var0toV1var1toV2var2toK1 extends Env {} {}
one sig var1toV1var0toV1var2toK2 extends Env {} {}
one sig var1toV1var0toV1var2toK1 extends Env {} {}
one sig var1toV1var0toV1 extends Env {} {}
one sig var1toV2var0toV2 extends Env {} {}
one sig var0toV1 extends Env {} {}
one sig var1toV2var0toV2var2toK2 extends Env {} {}
one sig var0toV2 extends Env {} {}
one sig var1toV2var0toV2var2toK1 extends Env {} {}
one sig var1toV1var0toV2var2toK2 extends Env {} {}
one sig var0toV1var1toV2var2toK2 extends Env {} {}


fact PartialInstance {
	lastIdx = (PT4->T5) + (PT7->T2) + (PT6->T4) + (PT2->T2) + (PT1->T4) + (PT8->T4) + (NT1->T4)

	path = (PT4 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V1N1N1 + T2->ReshardK1V2N2N1 + T3->RecvTransferMsgN1K1V1 + T4->RecvTransferMsgN1K2V1)) +
		(PT7 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V2N1N1)) +
		(PT6 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V1N1N1 + T2->RecvTransferMsgN1K1V1 + T3->RecvTransferMsgN1K2V1)) +
		(PT2 -> (T0->ReshardK1V2N2N1 + T1->ReshardK1V1N1N1)) +
		(PT1 -> (T0->ReshardK2V1N2N1 + T1->RecvTransferMsgN1K2V1 + T2->ReshardK2V2N1N2 + T3->RecvTransferMsgN2K2V2)) +
		(PT8 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V1N2N2 + T2->RecvTransferMsgN1K1V1 + T3->RecvTransferMsgN2K1V1)) +
		(NT1 -> (T0->ReshardK2V1N2N1 + T1->RecvTransferMsgN1K2V1 + T2->ReshardK2V2N1N2 + T3->RecvTransferMsgN2K2V1))

	maps = var1toV1var0toV2->(var1->V1 + var0->V2) +
		var0toV1var1toV2->(var0->V1 + var1->V2) +
		var1toV1var0toV2var2toK1->(var1->V1 + var0->V2 + var2->K1) +
		var0toV1var1toV2var2toK1->(var0->V1 + var1->V2 + var2->K1) +
		var1toV1var0toV1var2toK2->(var1->V1 + var0->V1 + var2->K2) +
		var1toV1var0toV1var2toK1->(var1->V1 + var0->V1 + var2->K1) +
		var1toV1var0toV1->(var1->V1 + var0->V1) +
		var1toV2var0toV2->(var1->V2 + var0->V2) +
		var0toV1->(var0->V1) +
		var1toV2var0toV2var2toK2->(var1->V2 + var0->V2 + var2->K2) +
		var0toV2->(var0->V2) +
		var1toV2var0toV2var2toK1->(var1->V2 + var0->V2 + var2->K1) +
		var1toV1var0toV2var2toK2->(var1->V1 + var0->V2 + var2->K2) +
		var0toV1var1toV2var2toK2->(var0->V1 + var1->V2 + var2->K2)
	...
	baseName = ReshardK1V2N2N1->Reshard +
		...
		RecvTransferMsgN2K2V2->RecvTransferMsg +
