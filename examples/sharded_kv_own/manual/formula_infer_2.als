...
sig FlSymAction {
    ...
    initiation : Act->Env->Fluent,
    termination : Act->Env->Fluent,
...
fact {
    all a : Act, e : Env, s : FlSymAction, f : Fluent |
    // sPrev is the symbolic action with the previous (lower) priority
    let sPrev = {s' : FlSymAction | s'.flActIdx.next = s.flActIdx} |
    // merge previous mappings using ++ to maintain priority
    let prioritizedParamsMap = sPrev.flToActParamsMap ++ s.flToActParamsMap |
        a->e->f in s.initiation iff
        s in f.flActions and (
            // init fluents, both usual and mutex
            (s.value = True and a.baseName = s.baseName and (~(f.vars)).(prioritizedParamsMap).(a.params) in e.maps)
            or
            // mutex init fluents
            (s.mutexFl = True and s.value = False and a.baseName = s.baseName and (~(f.vars)).(prioritizedParamsMap).(a.params) not in e.maps))
    ...
    // merge previous mappings using ++ to maintain priority
    let prioritizedParamsMap = sPrev.flToActParamsMap ++ s.flToActParamsMap |
        a->e->f in s.termination iff
        s in f.flActions and (
            // init fluents, both usual and mutex
            (s.value = False and a.baseName = s.baseName and (~(f.vars)).(prioritizedParamsMap).(a.params) in e.maps)
            or
            // mutex init fluents
            (s.mutexFl = True and s.value = True and a.baseName = s.baseName and (~(f.vars)).(prioritizedParamsMap).(a.params) not in e.maps))
}
...
pred isInitAct[a : Act, e : Env, f : Fluent] {
    let flActCategory = { s : f.flActions | s.baseName = a.baseName } |
        a->e->f in highestPriorityFlAct[flActCategory].initiation
}

// does this action terminate the fluent?
pred isTermAct[a : Act, e : Env, f : Fluent] {
    let flActCategory = { s : f.flActions | s.baseName = a.baseName } |
        a->e->f in highestPriorityFlAct[flActCategory].termination
}
...
fun rangeFlActionIdx[f : FlActionIdx] : set FlActionIdx {
	f.*(~FlActionIdxOrder/next)
}
...
fun envVarTypes : set(Var->Sort) {
	var3->Key + var2->Node + var1->Node + var0->Key
}
...
one sig var0toK1var1toN1var2toN1var3toK1 extends Env {} {}
...
one sig var1toN2var2toN1var0toK2var3toK1 extends Env {} {}
one sig var2toN2var1toN1var0toK2var3toK1 extends Env {} {}
one sig var2toN2var0toK1var1toN2var3toK1 extends Env {} {}
one sig var2toN2var1toN2var0toK2 extends Env {} {}
one sig var1toN1var2toN1var0toK2var3toK2 extends Env {} {}
one sig var0toK1var1toN2var2toN1var3toK2 extends Env {} {}
one sig var2toN2var0toK1var1toN1var3toK2 extends Env {} {}
one sig var1toN1var2toN1var0toK2var3toK1 extends Env {} {}
one sig var0toK1var1toN2var2toN1var3toK1 extends Env {} {}
one sig var2toN2var0toK1var1toN1var3toK1 extends Env {} {}
one sig var0toK1var1toN1var2toN1var3toK2 extends Env {} {}
one sig var0toK1var1toN1 extends Env {} {}
one sig var2toN2var1toN2var0toK2var3toK1 extends Env {} {}
one sig var1toN2var2toN1var0toK2var3toK2 extends Env {} {}
one sig var2toN2var1toN1var0toK2var3toK2 extends Env {} {}
one sig var2toN2var0toK1var1toN2var3toK2 extends Env {} {}
one sig var1toN1var0toK2 extends Env {} {}
one sig var0toK1var1toN2 extends Env {} {}
one sig var1toN2var0toK2 extends Env {} {}
one sig var2toN2var1toN2var0toK2var3toK2 extends Env {} {}
...
fact PartialInstance {
	...
	maps = var0toK1->(var0->K1) +
		...
		var0toK1var1toN1var2toN1var3toK1->(var0->K1 + var1->N1 + var2->N1 + var3->K1) +
		...
		var1toN2var2toN1var0toK2var3toK1->(var1->N2 + var2->N1 + var0->K2 + var3->K1) +
		var2toN2var1toN1var0toK2var3toK1->(var2->N2 + var1->N1 + var0->K2 + var3->K1) +
		var2toN2var0toK1var1toN2var3toK1->(var2->N2 + var0->K1 + var1->N2 + var3->K1) +
		var2toN2var1toN2var0toK2->(var2->N2 + var1->N2 + var0->K2) +
		var1toN1var2toN1var0toK2var3toK2->(var1->N1 + var2->N1 + var0->K2 + var3->K2) +
		var0toK1var1toN2var2toN1var3toK2->(var0->K1 + var1->N2 + var2->N1 + var3->K2) +
		var2toN2var0toK1var1toN1var3toK2->(var2->N2 + var0->K1 + var1->N1 + var3->K2) +
		var1toN1var2toN1var0toK2var3toK1->(var1->N1 + var2->N1 + var0->K2 + var3->K1) +
		var0toK1var1toN2var2toN1var3toK1->(var0->K1 + var1->N2 + var2->N1 + var3->K1) +
		var2toN2var0toK1var1toN1var3toK1->(var2->N2 + var0->K1 + var1->N1 + var3->K1) +
		var0toK1var1toN1var2toN1var3toK2->(var0->K1 + var1->N1 + var2->N1 + var3->K2) +
		var0toK1var1toN1->(var0->K1 + var1->N1) +
		var2toN2var1toN2var0toK2var3toK1->(var2->N2 + var1->N2 + var0->K2 + var3->K1) +
		var1toN2var2toN1var0toK2var3toK2->(var1->N2 + var2->N1 + var0->K2 + var3->K2) +
		var2toN2var1toN1var0toK2var3toK2->(var2->N2 + var1->N1 + var0->K2 + var3->K2) +
		var2toN2var0toK1var1toN2var3toK2->(var2->N2 + var0->K1 + var1->N2 + var3->K2) +
		var1toN1var0toK2->(var1->N1 + var0->K2) +
		var0toK1var1toN2->(var0->K1 + var1->N2) +
		var1toN2var0toK2->(var1->N2 + var0->K2) +
		var2toN2var1toN2var0toK2var3toK2->(var2->N2 + var1->N2 + var0->K2 + var3->K2)
