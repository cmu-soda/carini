...
VARIABLES err, request_sent, response_sent, match, response_received, Fluent9_7, cexTraceIdx, Fluent8_7

vars == <<err, request_sent, response_sent, match, response_received, Fluent9_7, cexTraceIdx, Fluent8_7>>

NoErr == err = FALSE

CandSep == (\A var0 \in DbRequestId : (Fluent9_7[var0] => Fluent8_7[var0]))
...
/\ Fluent8_7' = [Fluent8_7 EXCEPT![i] = TRUE]
/\ UNCHANGED <<Fluent9_7>>
/\ CandSep'
/\ cexTraceIdx' = cexTraceIdx + 1
...
/\ (<<r,p>> \in match)
/\ UNCHANGED <<match,request_sent,response_sent,response_received>>
/\ Fluent9_7' = [Fluent9_7 EXCEPT![i] = TRUE]
/\ UNCHANGED <<Fluent8_7>>
/\ CandSep'
/\ cexTraceIdx' = cexTraceIdx + 1
...
/\ response_sent = {}
/\ response_received = {}
/\ Fluent9_7 = [x0 \in DbRequestId |-> FALSE]
/\ Fluent8_7 = [x0 \in DbRequestId |-> FALSE]
/\ cexTraceIdx = 0
/\ err = FALSE
...
/\ cexTraceIdx = 1 => NewRequest(n3,req2) /\ err' = err
/\ cexTraceIdx = 2 => ServerProcessRequest(n1,req1,id1) /\ err' = err
/\ cexTraceIdx = 3 => ServerProcessRequest(n3,req2,id2) /\ err' = err
/\ cexTraceIdx = 4 => DbProcessRequest(id1,req1,resp1) /\ err' = err
/\ cexTraceIdx = 5 => DbProcessRequest(id2,req2,resp2) /\ err' = err
/\ cexTraceIdx = 6 => ServerProcessDbResponse(n1,id1,resp2) /\ err' = err
/\ cexTraceIdx = 7 => ReceiveResponse(n1,resp2) /\ err' = TRUE
/\ cexTraceIdx >= 8 => FALSE
