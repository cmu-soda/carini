...
one sig Phase1ba2NUM2 extends Act {} {
	params = (P0->a2 + P1->NUM2)
}
...
one sig Phase1ba3NUM2 extends Act {} {
	params = (P0->a3 + P1->NUM2)
}
one sig Phase1ba1NUM0 extends Act {} {
	params = (P0->a1 + P1->NUM0)
}
one sig Phase1ba3NUM0 extends Act {} {
	params = (P0->a3 + P1->NUM0)
}
...
one sig Phase2ba3NUM2v1 extends Act {} {
	params = (P0->a3 + P1->NUM2 + P2->v1)
}
...
fun envVarTypes : set(Var->Sort) {
	var2->Ballot + var1->Acceptor + var0->Ballot
}
...
one sig var0toNUM0var2toNUM0var1toa1 extends Env {} {}
one sig var2toNUM0var0toNUM1var1toa1 extends Env {} {}
one sig var0toNUM0var2toNUM0var1toa2 extends Env {} {}
one sig var0toNUM0var2toNUM1var1toa1 extends Env {} {}
one sig var0toNUM1 extends Env {} {}
one sig var0toNUM0var1toa1var2toNUM2 extends Env {} {}
one sig var0toNUM2 extends Env {} {}
one sig var2toNUM0var1toa1var0toNUM2 extends Env {} {}
one sig var2toNUM0var0toNUM1var1toa2 extends Env {} {}
one sig var0toNUM0var2toNUM0var1toa3 extends Env {} {}
one sig var0toNUM1var2toNUM1var1toa1 extends Env {} {}
one sig var0toNUM0var2toNUM1var1toa2 extends Env {} {}
...
one sig var1toa3var0toNUM2var2toNUM2 extends Env {} {}
one sig var0toNUM2var1toa2 extends Env {} {}
one sig var1toa3var0toNUM1 extends Env {} {}
one sig var0toNUM1var1toa1var2toNUM2 extends Env {} {}
one sig var0toNUM0var1toa2var2toNUM2 extends Env {} {}
one sig var2toNUM0var0toNUM2var1toa2 extends Env {} {}
one sig var2toNUM0var1toa3var0toNUM1 extends Env {} {}
one sig var2toNUM1var1toa1var0toNUM2 extends Env {} {}
one sig var0toNUM1var2toNUM1var1toa2 extends Env {} {}
one sig var0toNUM0var1toa3var2toNUM1 extends Env {} {}
one sig var0toNUM0 extends Env {} {}
one sig var1toa1var0toNUM2var2toNUM2 extends Env {} {}
one sig var0toNUM1var1toa2var2toNUM2 extends Env {} {}
one sig var0toNUM0var1toa3var2toNUM2 extends Env {} {}
one sig var2toNUM0var1toa3var0toNUM2 extends Env {} {}
one sig var2toNUM1var0toNUM2var1toa2 extends Env {} {}
one sig var1toa3var0toNUM1var2toNUM1 extends Env {} {}
one sig var0toNUM2var1toa2var2toNUM2 extends Env {} {}
one sig var1toa3var0toNUM1var2toNUM2 extends Env {} {}
one sig var1toa3var2toNUM1var0toNUM2 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT11->T2) + (PT18->T2) + (PT22->T3) + (PT13->T3) + (PT23->T3) + (PT10->T2) + (PT3->T2) + (PT25->T4) + (PT1->T2) + (PT26->T4) + (PT24->T3) + (PT21->T3) + (PT15->T2) + (PT17->T2) + (PT4->T2) + (PT27->T4) + (PT12->T3) + (PT16->T2) + (PT8->T2) + (NT1->T2)

	path = (PT11 -> (T0->Phase1ba1NUM2 + T1->Phase1ba2NUM2 + T2->Phase2ba1NUM2v1)) +
		(PT18 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2ba3NUM0v1)) +
		(PT22 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase1ba1NUM2 + T3->Phase2ba1NUM0v1)) +
		(PT13 -> (T0->Phase1ba1NUM1 + T1->Phase1ba2NUM1 + T2->Phase1ba1NUM2 + T3->Phase2ba1NUM1v1)) +
		(PT23 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase1ba1NUM2 + T3->Phase2ba1NUM0v1)) +
		(PT10 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2ba1NUM0v1)) +
		(PT3 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2ba1NUM0v1)) +
		(PT25 -> (T0->Phase1ba1NUM1 + T1->Phase1ba1NUM2 + T2->Phase1ba2NUM1 + T3->Phase2ba1NUM1v1 + T4->Phase1ba2NUM2)) +
		(PT1 -> (T0->Phase1ba1NUM0 + T1->Phase1ba1NUM1 + T2->Phase1ba3NUM0)) +
		(PT26 -> (T0->Phase1ba1NUM0 + T1->Phase1ba1NUM1 + T2->Phase1ba2NUM0 + T3->Phase1ba2NUM1 + T4->Phase2ba1NUM0v1)) +
		(PT24 -> (T0->Phase1ba1NUM0 + T1->Phase1ba1NUM2 + T2->Phase1ba2NUM0 + T3->Phase2ba3NUM0v1)) +
		(PT21 -> (T0->Phase1ba1NUM0 + T1->Phase1ba1NUM1 + T2->Phase1ba2NUM0 + T3->Phase2ba1NUM0v1)) +
		(PT15 -> (T0->Phase1ba1NUM2 + T1->Phase1ba2NUM2 + T2->Phase2ba3NUM2v1)) +
		(PT17 -> (T0->Phase1ba1NUM2 + T1->Phase1ba3NUM2 + T2->Phase2ba2NUM2v1)) +
		(PT4 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2ba1NUM0v1)) +
		(PT27 -> (T0->Phase1ba1NUM0 + T1->Phase1ba1NUM1 + T2->Phase1ba2NUM0 + T3->Phase1ba2NUM1 + T4->Phase2ba1NUM0v1)) +
		(PT12 -> (T0->Phase1ba1NUM0 + T1->Phase1ba1NUM1 + T2->Phase1ba2NUM0 + T3->Phase2ba1NUM0v1)) +
		(PT16 -> (T0->Phase1ba1NUM0 + T1->Phase1ba2NUM0 + T2->Phase2ba3NUM0v1)) +
		(PT8 -> (T0->Phase1ba1NUM0 + T1->Phase1ba3NUM0 + T2->Phase2ba1NUM0v1)) +
		(NT1 -> (T0->Phase1ba1NUM0 + T1->Phase1ba1NUM1 + T2->Phase2ba2NUM0v1))

	maps = var0toNUM0var2toNUM0var1toa1->(var0->NUM0 + var2->NUM0 + var1->a1) +
		var2toNUM0var0toNUM1var1toa1->(var2->NUM0 + var0->NUM1 + var1->a1) +
		var0toNUM0var2toNUM0var1toa2->(var0->NUM0 + var2->NUM0 + var1->a2) +
		var0toNUM0var2toNUM1var1toa1->(var0->NUM0 + var2->NUM1 + var1->a1) +
		var0toNUM1->(var0->NUM1) +
		var0toNUM0var1toa1var2toNUM2->(var0->NUM0 + var1->a1 + var2->NUM2) +
		var0toNUM2->(var0->NUM2) +
		var2toNUM0var1toa1var0toNUM2->(var2->NUM0 + var1->a1 + var0->NUM2) +
		var2toNUM0var0toNUM1var1toa2->(var2->NUM0 + var0->NUM1 + var1->a2) +
		var0toNUM0var2toNUM0var1toa3->(var0->NUM0 + var2->NUM0 + var1->a3) +
		var0toNUM1var2toNUM1var1toa1->(var0->NUM1 + var2->NUM1 + var1->a1) +
		var0toNUM0var2toNUM1var1toa2->(var0->NUM0 + var2->NUM1 + var1->a2) +
		...
		var1toa3var0toNUM2var2toNUM2->(var1->a3 + var0->NUM2 + var2->NUM2) +
		var0toNUM2var1toa2->(var0->NUM2 + var1->a2) +
		var1toa3var0toNUM1->(var1->a3 + var0->NUM1) +
		var0toNUM1var1toa1var2toNUM2->(var0->NUM1 + var1->a1 + var2->NUM2) +
		var0toNUM0var1toa2var2toNUM2->(var0->NUM0 + var1->a2 + var2->NUM2) +
		var2toNUM0var0toNUM2var1toa2->(var2->NUM0 + var0->NUM2 + var1->a2) +
		var2toNUM0var1toa3var0toNUM1->(var2->NUM0 + var1->a3 + var0->NUM1) +
		var2toNUM1var1toa1var0toNUM2->(var2->NUM1 + var1->a1 + var0->NUM2) +
		var0toNUM1var2toNUM1var1toa2->(var0->NUM1 + var2->NUM1 + var1->a2) +
		var0toNUM0var1toa3var2toNUM1->(var0->NUM0 + var1->a3 + var2->NUM1) +
		var0toNUM0->(var0->NUM0) +
		var1toa1var0toNUM2var2toNUM2->(var1->a1 + var0->NUM2 + var2->NUM2) +
		var0toNUM1var1toa2var2toNUM2->(var0->NUM1 + var1->a2 + var2->NUM2) +
		var0toNUM0var1toa3var2toNUM2->(var0->NUM0 + var1->a3 + var2->NUM2) +
		var2toNUM0var1toa3var0toNUM2->(var2->NUM0 + var1->a3 + var0->NUM2) +
		var2toNUM1var0toNUM2var1toa2->(var2->NUM1 + var0->NUM2 + var1->a2) +
		var1toa3var0toNUM1var2toNUM1->(var1->a3 + var0->NUM1 + var2->NUM1) +
		var0toNUM2var1toa2var2toNUM2->(var0->NUM2 + var1->a2 + var2->NUM2) +
		var1toa3var0toNUM1var2toNUM2->(var1->a3 + var0->NUM1 + var2->NUM2) +
		var1toa3var2toNUM1var0toNUM2->(var1->a3 + var2->NUM1 + var0->NUM2)

	baseName = Phase1ba2NUM1->Phase1b +
		Phase1ba2NUM2->Phase1b +
		Phase1ba2NUM0->Phase1b +
		Phase1ba3NUM0->Phase1b +
		Phase2ba1NUM1v1->Phase2b +
		Phase2ba1NUM0v1->Phase2b +
		Phase1ba3NUM2->Phase1b +
		Phase2ba1NUM2v1->Phase2b +
		Phase1ba1NUM2->Phase1b +
		Phase2ba2NUM0v1->Phase2b +
		Phase1ba1NUM0->Phase1b +
		Phase2ba3NUM2v1->Phase2b +
