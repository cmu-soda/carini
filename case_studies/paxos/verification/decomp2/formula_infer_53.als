...
fun envVarTypes : set(Var->Sort) {
	var2->Acceptor + var1->Acceptor + var0->Value
}
...
one sig var1toa3var0tov2 extends Env {} {}
one sig var0tov2var1toa2 extends Env {} {}
one sig var1toa3var0tov1 extends Env {} {}
one sig var0tov1var1toa1 extends Env {} {}
one sig var1toa1var0tov2 extends Env {} {}
one sig var0tov1var1toa2 extends Env {} {}
one sig var2toa2var1toa3var0tov2 extends Env {} {}
one sig var2toa3var0tov2var1toa2 extends Env {} {}
one sig var2toa3var1toa3var0tov1 extends Env {} {}
one sig var2toa3var1toa3var0tov2 extends Env {} {}
one sig var0tov1 extends Env {} {}
one sig var0tov2 extends Env {} {}
one sig var1toa3var2toa1var0tov2 extends Env {} {}
one sig var2toa2var0tov2var1toa2 extends Env {} {}
one sig var2toa2var1toa3var0tov1 extends Env {} {}
one sig var2toa3var1toa1var0tov2 extends Env {} {}
one sig var2toa3var0tov1var1toa2 extends Env {} {}
one sig var1toa1var2toa1var0tov2 extends Env {} {}
one sig var0tov1var2toa1var1toa2 extends Env {} {}
one sig var2toa2var0tov1var1toa1 extends Env {} {}
one sig var2toa1var0tov2var1toa2 extends Env {} {}
one sig var1toa3var0tov1var2toa1 extends Env {} {}
one sig var2toa2var1toa1var0tov2 extends Env {} {}
one sig var2toa2var0tov1var1toa2 extends Env {} {}
one sig var2toa3var0tov1var1toa1 extends Env {} {}
one sig var0tov1var1toa1var2toa1 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT19->T1) + (PT17->T2) + (PT13->T1) + (PT30->T2) + (PT18->T2) + (PT15->T1) + (PT31->T2) + (PT1->T1) + (PT28->T2) + (PT16->T2) + (PT27->T2) + (PT8->T0) + (PT29->T1) + (NT1->T2)
	...
	maps = var1toa3var0tov2->(var1->a3 + var0->v2) +
		var0tov2var1toa2->(var0->v2 + var1->a2) +
		var1toa3var0tov1->(var1->a3 + var0->v1) +
		var0tov1var1toa1->(var0->v1 + var1->a1) +
		var1toa1var0tov2->(var1->a1 + var0->v2) +
		var0tov1var1toa2->(var0->v1 + var1->a2) +
		var2toa2var1toa3var0tov2->(var2->a2 + var1->a3 + var0->v2) +
		var2toa3var0tov2var1toa2->(var2->a3 + var0->v2 + var1->a2) +
		var2toa3var1toa3var0tov1->(var2->a3 + var1->a3 + var0->v1) +
		var2toa3var1toa3var0tov2->(var2->a3 + var1->a3 + var0->v2) +
		var0tov1->(var0->v1) +
		var0tov2->(var0->v2) +
		var1toa3var2toa1var0tov2->(var1->a3 + var2->a1 + var0->v2) +
		var2toa2var0tov2var1toa2->(var2->a2 + var0->v2 + var1->a2) +
		var2toa2var1toa3var0tov1->(var2->a2 + var1->a3 + var0->v1) +
		var2toa3var1toa1var0tov2->(var2->a3 + var1->a1 + var0->v2) +
		var2toa3var0tov1var1toa2->(var2->a3 + var0->v1 + var1->a2) +
		var1toa1var2toa1var0tov2->(var1->a1 + var2->a1 + var0->v2) +
		var0tov1var2toa1var1toa2->(var0->v1 + var2->a1 + var1->a2) +
		var2toa2var0tov1var1toa1->(var2->a2 + var0->v1 + var1->a1) +
		var2toa1var0tov2var1toa2->(var2->a1 + var0->v2 + var1->a2) +
		var1toa3var0tov1var2toa1->(var1->a3 + var0->v1 + var2->a1) +
		var2toa2var1toa1var0tov2->(var2->a2 + var1->a1 + var0->v2) +
		var2toa2var0tov1var1toa2->(var2->a2 + var0->v1 + var1->a2) +
		var2toa3var0tov1var1toa1->(var2->a3 + var0->v1 + var1->a1) +
		var0tov1var1toa1var2toa1->(var0->v1 + var1->a1 + var2->a1)

	baseName = Phase2aNUM1v2a3_a1a3_->Phase2a +
