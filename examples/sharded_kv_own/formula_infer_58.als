...
fun envVarTypes : set(Var->Sort) {
	var3->Node + var2->Node + var1->Value + var0->Value
}
...
one sig var1toV2var3toN1var0toV2var2toN1 extends Env {} {}
one sig var2toN2var1toV1var3toN1var0toV2 extends Env {} {}
one sig var2toN2var0toV1var1toV2var3toN1 extends Env {} {}
one sig var1toV1var0toV2var2toN1var3toN2 extends Env {} {}
one sig var0toV1var1toV2var2toN1var3toN2 extends Env {} {}
one sig var2toN2var1toV1var0toV1var3toN2 extends Env {} {}
one sig var2toN2var1toV2var3toN1var0toV2 extends Env {} {}
one sig var1toV2var0toV2var2toN1var3toN2 extends Env {} {}
one sig var2toN2var1toV1var0toV2var3toN2 extends Env {} {}
one sig var2toN2var0toV1var1toV2var3toN2 extends Env {} {}
one sig var2toN2var1toV2var0toV2var3toN2 extends Env {} {}
one sig var1toV2var0toV2var2toN1 extends Env {} {}
one sig var2toN2var1toV1var0toV2 extends Env {} {}
one sig var2toN2var0toV1var1toV2 extends Env {} {}
one sig var0toV1 extends Env {} {}
one sig var1toV1var0toV2var2toN1 extends Env {} {}
one sig var0toV1var1toV2var2toN1 extends Env {} {}
one sig var2toN2var1toV1var0toV1 extends Env {} {}
one sig var0toV2 extends Env {} {}
one sig var2toN2var1toV2var0toV2 extends Env {} {}
one sig var1toV1var0toV2 extends Env {} {}
one sig var0toV1var1toV2 extends Env {} {}
one sig var1toV1var0toV1 extends Env {} {}
one sig var1toV2var0toV2 extends Env {} {}
one sig var1toV1var0toV1var2toN1 extends Env {} {}
one sig var1toV1var0toV1var3toN1var2toN1 extends Env {} {}
one sig var1toV1var3toN1var0toV2var2toN1 extends Env {} {}
one sig var0toV1var1toV2var3toN1var2toN1 extends Env {} {}
one sig var2toN2var1toV1var0toV1var3toN1 extends Env {} {}
one sig var1toV1var0toV1var2toN1var3toN2 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT1->T5) + (NT1->T5)

	path = (PT1 -> (T0->OwnN1K1 + T1->ReshardK1V1N1N1 + T2->RecvTransferMsgN1K1V1 + T3->ReshardK1V1N1N2 + T4->RecvTransferMsgN2K1V1 + T5->ReshardK1V1N1N1)) +
	...
	maps = var1toV2var3toN1var0toV2var2toN1->(var1->V2 + var3->N1 + var0->V2 + var2->N1) +
		var2toN2var1toV1var3toN1var0toV2->(var2->N2 + var1->V1 + var3->N1 + var0->V2) +
		var2toN2var0toV1var1toV2var3toN1->(var2->N2 + var0->V1 + var1->V2 + var3->N1) +
		var1toV1var0toV2var2toN1var3toN2->(var1->V1 + var0->V2 + var2->N1 + var3->N2) +
		var0toV1var1toV2var2toN1var3toN2->(var0->V1 + var1->V2 + var2->N1 + var3->N2) +
		var2toN2var1toV1var0toV1var3toN2->(var2->N2 + var1->V1 + var0->V1 + var3->N2) +
		var2toN2var1toV2var3toN1var0toV2->(var2->N2 + var1->V2 + var3->N1 + var0->V2) +
		var1toV2var0toV2var2toN1var3toN2->(var1->V2 + var0->V2 + var2->N1 + var3->N2) +
		var2toN2var1toV1var0toV2var3toN2->(var2->N2 + var1->V1 + var0->V2 + var3->N2) +
		var2toN2var0toV1var1toV2var3toN2->(var2->N2 + var0->V1 + var1->V2 + var3->N2) +
		var2toN2var1toV2var0toV2var3toN2->(var2->N2 + var1->V2 + var0->V2 + var3->N2) +
		var1toV2var0toV2var2toN1->(var1->V2 + var0->V2 + var2->N1) +
		var2toN2var1toV1var0toV2->(var2->N2 + var1->V1 + var0->V2) +
		var2toN2var0toV1var1toV2->(var2->N2 + var0->V1 + var1->V2) +
		var0toV1->(var0->V1) +
		var1toV1var0toV2var2toN1->(var1->V1 + var0->V2 + var2->N1) +
		var0toV1var1toV2var2toN1->(var0->V1 + var1->V2 + var2->N1) +
		var2toN2var1toV1var0toV1->(var2->N2 + var1->V1 + var0->V1) +
		var0toV2->(var0->V2) +
		var2toN2var1toV2var0toV2->(var2->N2 + var1->V2 + var0->V2) +
		var1toV1var0toV2->(var1->V1 + var0->V2) +
		var0toV1var1toV2->(var0->V1 + var1->V2) +
		var1toV1var0toV1->(var1->V1 + var0->V1) +
		var1toV2var0toV2->(var1->V2 + var0->V2) +
		var1toV1var0toV1var2toN1->(var1->V1 + var0->V1 + var2->N1) +
		var1toV1var0toV1var3toN1var2toN1->(var1->V1 + var0->V1 + var3->N1 + var2->N1) +
		var1toV1var3toN1var0toV2var2toN1->(var1->V1 + var3->N1 + var0->V2 + var2->N1) +
		var0toV1var1toV2var3toN1var2toN1->(var0->V1 + var1->V2 + var3->N1 + var2->N1) +
		var2toN2var1toV1var0toV1var3toN1->(var2->N2 + var1->V1 + var0->V1 + var3->N1) +
		var1toV1var0toV1var2toN1var3toN2->(var1->V1 + var0->V1 + var2->N1 + var3->N2)
