...
VARIABLES Fluent9, currentTerm, Fluent8, Fluent7, Fluent6, Fluent5, Fluent10, Fluent4, Fluent3, Fluent2, Fluent1, Fluent0, CommitEntryMutFl, BecomeLeaderMutFl

vars == <<Fluent9, currentTerm, Fluent8, Fluent7, Fluent6, Fluent5, Fluent10, Fluent4, Fluent3, Fluent2, Fluent1, Fluent0, CommitEntryMutFl, BecomeLeaderMutFl>>
...
/\ \A var0 \in Server : CommitEntryMutFl[var0] => BecomeLeaderMutFl[var0]
...
/\ UNCHANGED<<Fluent7, Fluent5, Fluent10, Fluent4, Fluent3, CommitEntryMutFl, BecomeLeaderMutFl>>
/\ CandSep'
...
/\ BecomeLeaderMutFl' = [[ x0 \in Server |-> FALSE] EXCEPT![i] = TRUE]
/\ CommitEntryMutFl' = [ x0 \in Server |-> FALSE]
...
/\ CommitEntryMutFl' = [[ x0 \in Server |-> FALSE] EXCEPT![i] = TRUE]
/\ UNCHANGED<<Fluent9, Fluent8, Fluent6, Fluent10, Fluent4, BecomeLeaderMutFl>>
/\ CandSep'
...
UpdateTerms(i,j) ==
/\ UpdateTermsExpr(i,j)
/\ UNCHANGED<<Fluent9, Fluent8, Fluent7, Fluent6, Fluent5, Fluent10, Fluent4, Fluent3, CommitEntryMutFl, BecomeLeaderMutFl>>
/\ CandSep'
/\ UNCHANGED<<Fluent2, Fluent1, Fluent0>>
/\ CandSep'
...
/\ CommitEntryMutFl = [ x0 \in Server |-> FALSE]
/\ BecomeLeaderMutFl = [ x0 \in Server |-> FALSE]
