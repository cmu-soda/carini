...
pred initiation[e : Env, a : Act, f : Fluent, si : FlActionIdx] {
    let s = { s : f.flActions | s.baseName = a.baseName and s.flActIdx = si } |
        initiationAct[e,a,f,s]
}

pred initiationAct[e : Env, a : Act, f : Fluent, s : FlSymAction] {
    (~(f.vars)).(s.flToActParamsMap).(a.params) in e.maps
    and
    (s.target in FlTargetBool and s.target.bValue = True)
}

pred termination[e : Env, a : Act, f : Fluent, si : FlActionIdx] {
    let s = { s : f.flActions | s.baseName = a.baseName and s.flActIdx = si } |
        terminationAct[e,a,f,s]
}

pred terminationAct[e : Env, a : Act, f : Fluent, s : FlSymAction] {
    (~(f.vars)).(s.flToActParamsMap).(a.params) in e.maps
    and
    (s.target in FlTargetBool and s.target.bValue = False)
}
...
abstract sig FlTarget {
    paramsMap : set(ParamIdx->ParamIdx)
}

sig FlTargetBool extends FlTarget {
    bValue : Bool
} {
    no paramsMap
}

// update to represent a Fluent (not an FlSymAction)
sig FlTargetFluent extends FlTarget {
    fValue : FlSymAction
} {
    paramsMap = fValue.flToActParamsMap
}
...
sig FlSymAction {
    ...
    target : FlTarget, // the update (init v. term) for this fluent
...
abstract sig Trace {
	...
	all e : Env, i : Idx, f : Fluent | e->i->f in satisfies iff
        ...
        let a = i.path |
        let flAct = ... | # highest priority fl act
            # get the fluent's value given the args specified in e
            (no i.prev and f.initially = True) or
            (flAct.target in Formula and some i.prev and e->i.prev->flAct.target in satisfies) or
            (flAct.target in LayeredAssgn and some i.prev and e->i.prev->flAct.target in satisfies)
...
for 8 Formula, 5 FlSymAction, 5 FlTarget
...
one sig var0toN2var2toV1var1toK1 extends Env {} {}
one sig var2toV1var0toN1var1toK2 extends Env {} {}
one sig var2toV2var0toN1var1toK1 extends Env {} {}
one sig var2toV1var0toN1var1toK1 extends Env {} {}
one sig var0toN2var2toV1var1toK2 extends Env {} {}
one sig var0toN2var2toV2var1toK1 extends Env {} {}
one sig var2toV2var0toN1var1toK2 extends Env {} {}
...
one sig var0toN2var2toV2var1toK2 extends Env {} {}
one sig var0toN2var1toK2 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT28->T3) + (PT27->T2) + (PT19->T2) + (PT29->T2) + (PT35->T3) + (PT25->T3) + (PT20->T2) + (PT1->T2) + (PT22->T1) + (PT24->T3) + (PT21->T1) + (PT31->T3) + (PT26->T3) + (PT32->T3) + (PT30->T3) + (NT1->T4)

	path = (PT28 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V1N1N1 + T2->ReshardK1V1N1N2 + T3->RecvTransferMsgN1K1V1)) +
		(PT27 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V1N1N2 + T2->RecvTransferMsgN1K1V1)) +
		(PT19 -> (T0->ReshardK1V1N1N1 + T1->ReshardK2V1N1N1 + T2->RecvTransferMsgN1K1V1)) +
		(PT29 -> (T0->ReshardK2V1N1N1 + T1->ReshardK2V1N1N2 + T2->RecvTransferMsgN1K2V1)) +
		(PT35 -> (T0->ReshardK1V1N2N1 + T1->ReshardK1V1N1N2 + T2->RecvTransferMsgN1K1V1 + T3->RecvTransferMsgN2K1V1)) +
		(PT25 -> (T0->ReshardK1V1N1N1 + T1->ReshardK1V1N2N2 + T2->RecvTransferMsgN1K1V1 + T3->RecvTransferMsgN2K1V1)) +
		(PT20 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V1N1N1 + T2->RecvTransferMsgN1K1V1)) +
		(PT1 -> (T0->ReshardK1V1N2N1 + T1->RecvTransferMsgN1K1V1 + T2->ReshardK1V1N1N2)) +
		(PT22 -> (T0->ReshardK1V2N1N1 + T1->RecvTransferMsgN1K1V2)) +
		(PT24 -> (T0->ReshardK1V1N2N2 + T1->ReshardK1V1N1N1 + T2->RecvTransferMsgN1K1V1 + T3->RecvTransferMsgN2K1V1)) +
		(PT21 -> (T0->ReshardK1V1N1N1 + T1->RecvTransferMsgN1K1V1)) +
		(PT31 -> (T0->ReshardK1V1N2N1 + T1->ReshardK1V1N1N2 + T2->RecvTransferMsgN2K1V1 + T3->RecvTransferMsgN1K1V1)) +
		(PT26 -> (T0->ReshardK2V1N1N1 + T1->ReshardK1V1N2N2 + T2->RecvTransferMsgN2K1V1 + T3->RecvTransferMsgN1K2V1)) +
		(PT32 -> (T0->ReshardK2V1N2N1 + T1->ReshardK1V1N1N2 + T2->RecvTransferMsgN2K1V1 + T3->RecvTransferMsgN1K2V1)) +
		(PT30 -> (T0->ReshardK2V1N2N1 + T1->ReshardK2V1N1N2 + T2->RecvTransferMsgN1K2V1 + T3->RecvTransferMsgN2K2V1)) +
		(NT1 -> (T0->ReshardK1V1N2N1 + T1->RecvTransferMsgN1K1V1 + T2->ReshardK1V1N1N2 + T3->RecvTransferMsgN1K1V1 + T4->RecvTransferMsgN2K1V1))

	maps = var0toN2var2toV1var1toK1->(var0->N2 + var2->V1 + var1->K1) +
		var2toV1var0toN1var1toK2->(var2->V1 + var0->N1 + var1->K2) +
		var2toV2var0toN1var1toK1->(var2->V2 + var0->N1 + var1->K1) +
		var2toV1var0toN1var1toK1->(var2->V1 + var0->N1 + var1->K1) +
		var0toN2var2toV1var1toK2->(var0->N2 + var2->V1 + var1->K2) +
		var0toN2var2toV2var1toK1->(var0->N2 + var2->V2 + var1->K1) +
		var2toV2var0toN1var1toK2->(var2->V2 + var0->N1 + var1->K2) +
		var0toN2->(var0->N2) +
		var0toN1var1toK1->(var0->N1 + var1->K1) +
		var0toN1->(var0->N1) +
		var0toN2var1toK1->(var0->N2 + var1->K1) +
		var0toN1var1toK2->(var0->N1 + var1->K2) +
		var0toN2var2toV2var1toK2->(var0->N2 + var2->V2 + var1->K2) +
		var0toN2var1toK2->(var0->N2 + var1->K2)

	baseName = ReshardK1V2N1N1->Reshard +
