...
one sig complete_proc_write_invalidc2a2v1 extends Act {} {
	params = (P0->c2 + P1->a2 + P2->v1)
}
...
one sig evict_modifiedc2a1 extends Act {} {
	params = (P0->c2 + P1->a1)
}
...
one sig evict_exclusive_or_sharedc1a1 extends Act {} {
	params = (P0->c1 + P1->a1)
}
...
fun envVarTypes : set(Var->Sort) {
	var2->Address + var1->Address + var0->Value
}
...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT34->T4) + (PT1->T8) + (PT11->T4) + (PT42->T4) + (PT13->T4) + (PT7->T4) + (PT38->T5) + (PT39->T7) + (PT51->T5) + (PT37->T5) + (PT26->T3) + (PT23->T3) + (PT8->T6) + (PT31->T4) + (PT18->T4) + (PT44->T5) + (PT21->T5) + (PT50->T6) + (PT48->T5) + (PT12->T3) + (PT40->T7) + (PT15->T5) + (PT33->T5) + (PT9->T4) + (PT45->T5) + (PT35->T6) + (PT46->T5) + (PT10->T4) + (PT19->T4) + (PT43->T5) + (NT1->T8)
	...
	path = (PT34 -> (T0->issue_proc_write_sharedc1a1v1 + T1->complete_proc_write_invalidc1a1v1 + T2->evict_modifiedc1a1 + T3->issue_proc_write_sharedc1a1v2 + T4->complete_proc_write_invalidc1a1v2)) +
		...
		(PT42 -> (T0->issue_proc_write_sharedc1a1v1 + T1->complete_proc_write_invalidc1a1v1 + T2->issue_proc_write_invalidc2a1v1 + T3->do_bus_read_for_ownership_validc1a1v2 + T4->complete_proc_write_invalidc2a1v1)) +
		...
		(PT7 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_invalidc2a1 + T2->complete_proc_read_invalid_exclusivec1a1v1 + T3->issue_proc_write_sharedc2a1v1 + T4->complete_proc_write_invalidc2a1v1)) +
		...
		(PT51 -> (T0->issue_proc_write_sharedc1a1v1 + T1->complete_proc_write_invalidc1a1v1 + T2->issue_proc_read_invalidc1a2 + T3->do_bus_read_invalidc2a2 + T4->complete_proc_read_invalid_exclusivec1a2v2 + T5->issue_proc_write_invalidc2a1v1)) +
		...
		(PT26 -> (T0->evict_modifiedc2a1 + T1->issue_proc_write_invalidc1a1v2 + T2->do_bus_read_for_ownership_invalidc2a1 + T3->complete_proc_write_invalidc1a1v2)) +
		(PT23 -> (T0->evict_modifiedc2a1 + T1->issue_proc_write_invalidc1a1v1 + T2->do_bus_read_for_ownership_invalidc2a1 + T3->complete_proc_write_invalidc1a1v1)) +
		...
		(PT44 -> (T0->issue_proc_write_invalidc1a1v1 + T1->do_bus_read_for_ownership_invalidc2a1 + T2->complete_proc_write_invalidc1a1v1 + T3->issue_proc_write_invalidc1a2v2 + T4->do_bus_read_for_ownership_invalidc2a2 + T5->complete_proc_write_invalidc1a2v2)) +
		...
		(PT50 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_invalidc2a1 + T2->complete_proc_read_invalid_exclusivec1a1v1 + T3->evict_modifiedc1a1 + T4->issue_proc_write_invalidc1a1v1 + T5->do_bus_read_for_ownership_invalidc2a1 + T6->complete_proc_write_invalidc1a1v1)) +
		(PT48 -> (T0->issue_proc_write_invalidc1a1v1 + T1->do_bus_read_for_ownership_invalidc2a1 + T2->complete_proc_write_invalidc1a1v1 + T3->issue_proc_write_invalidc2a1v2 + T4->do_bus_read_for_ownership_validc1a1v1 + T5->complete_proc_write_invalidc2a1v2)) +
		...
		(PT15 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_invalidc2a1 + T2->complete_proc_read_invalid_exclusivec1a1v1 + T3->issue_proc_write_invalidc2a1v1 + T4->do_bus_read_for_ownership_validc1a1v1 + T5->complete_proc_write_invalidc2a1v1)) +
		...
		(PT45 -> (T0->issue_proc_read_invalidc1a1 + T1->do_bus_read_invalidc2a1 + T2->complete_proc_read_invalid_exclusivec1a1v1 + T3->issue_proc_write_invalidc1a2v2 + T4->do_bus_read_for_ownership_invalidc2a2 + T5->complete_proc_write_invalidc1a2v2)) +
		...
		(PT46 -> (T0->issue_proc_write_invalidc1a1v1 + T1->do_bus_read_for_ownership_invalidc2a1 + T2->complete_proc_write_invalidc1a1v1 + T3->issue_proc_write_invalidc2a2v1 + T4->do_bus_read_for_ownership_invalidc1a2 + T5->complete_proc_write_invalidc2a2v1)) +
		...
		(PT43 -> (T0->issue_proc_write_sharedc1a1v1 + T1->complete_proc_write_invalidc1a1v1 + T2->evict_exclusive_or_sharedc1a1 + T3->issue_proc_read_invalidc1a1 + T4->do_bus_read_invalidc2a1 + T5->complete_proc_read_invalid_exclusivec1a1v1)) +
	...
	baseName = issue_proc_write_invalidc2a1v1->issue_proc_write_invalid +
		...
		complete_proc_write_invalidc2a2v1->complete_proc_write_invalid +
		...
		evict_modifiedc2a1->evict_modified +
		evict_modifiedc1a2->evict_modified +
		evict_exclusive_or_sharedc1a1->evict_exclusive_or_shared +
