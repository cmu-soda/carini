...
for 8 Formula, 5 FlSymAction, 5 Target
...
pred lte[lhs : Atom, rhs : Atom] {
	let containsRel = (NUM0->NUM0 + NUM0->NUM1 + NUM0->NUM2 + NUM0->NUM3 + NUM0->NUM5 + NUM0->NUM8 + NUM1->NUM1 + NUM1->NUM2 + NUM1->NUM3 + NUM1->NUM5 + NUM1->NUM8 + NUM2->NUM2 + NUM2->NUM3 + NUM2->NUM5 + NUM2->NUM8 + NUM3->NUM3 + NUM3->NUM5 + NUM3->NUM8 + NUM5->NUM5 + NUM5->NUM8 + NUM8->NUM8) |
		(lhs->rhs) in containsRel
}


one sig NUM8, NUM2, NUM3, NUM5, NUM0, NUM1 extends Atom {}

one sig Node extends Sort {} {
	atoms = NUM2 + NUM0 + NUM1
	numericSort = True
}
one sig Id extends Sort {} {
	atoms = NUM8 + NUM3 + NUM5
	numericSort = True
}

one sig Delete extends BaseName {} {
	paramIdxs = P0 + P1
	paramTypes = P0->Node + P1->Id
}
one sig DeleteNUM0NUM5 extends Act {} {
	params = (P0->NUM0 + P1->NUM5)
}
one sig DeleteNUM1NUM5 extends Act {} {
	params = (P0->NUM1 + P1->NUM5)
}
one sig DeleteNUM0NUM3 extends Act {} {
	params = (P0->NUM0 + P1->NUM3)
}
one sig DeleteNUM2NUM5 extends Act {} {
	params = (P0->NUM2 + P1->NUM5)
}
one sig DeleteNUM1NUM3 extends Act {} {
	params = (P0->NUM1 + P1->NUM3)
}
one sig DeleteNUM2NUM3 extends Act {} {
	params = (P0->NUM2 + P1->NUM3)
}

one sig Propagate extends BaseName {} {
	paramIdxs = P0 + P1
	paramTypes = P0->Node + P1->Id
}
one sig PropagateNUM1NUM3 extends Act {} {
	params = (P0->NUM1 + P1->NUM3)
}
one sig PropagateNUM2NUM3 extends Act {} {
	params = (P0->NUM2 + P1->NUM3)
}

one sig Send extends BaseName {} {
	paramIdxs = P0 + P1
	paramTypes = P0->Node + P1->Id
}
one sig SendNUM0NUM5 extends Act {} {
	params = (P0->NUM0 + P1->NUM5)
}
one sig SendNUM1NUM5 extends Act {} {
	params = (P0->NUM1 + P1->NUM5)
}
one sig SendNUM0NUM3 extends Act {} {
	params = (P0->NUM0 + P1->NUM3)
}
one sig SendNUM1NUM3 extends Act {} {
	params = (P0->NUM1 + P1->NUM3)
}
one sig SendNUM2NUM3 extends Act {} {
	params = (P0->NUM2 + P1->NUM3)
}


fun envVarTypes : set(Var->Sort) {
	var2->Node + var1->Id + var0->Id
}
...
one sig var1toNUM3var2toNUM0var0toNUM5 extends Env {} {}
one sig var0toNUM3var2toNUM0var1toNUM5 extends Env {} {}
one sig var0toNUM3var1toNUM3 extends Env {} {}
one sig var0toNUM3var1toNUM3var2toNUM0 extends Env {} {}
one sig var1toNUM3var0toNUM5 extends Env {} {}
one sig var0toNUM3var1toNUM5 extends Env {} {}
one sig var0toNUM3var1toNUM3var2toNUM1 extends Env {} {}
one sig var2toNUM1var0toNUM8var1toNUM8 extends Env {} {}
one sig var0toNUM8var1toNUM8 extends Env {} {}
one sig var0toNUM8var1toNUM8var2toNUM2 extends Env {} {}
one sig var0toNUM5 extends Env {} {}
one sig var2toNUM0var0toNUM8var1toNUM8 extends Env {} {}
one sig var2toNUM1var1toNUM8var0toNUM5 extends Env {} {}
one sig var2toNUM1var0toNUM8var1toNUM5 extends Env {} {}
one sig var1toNUM8var0toNUM5var2toNUM2 extends Env {} {}
one sig var0toNUM8var1toNUM5var2toNUM2 extends Env {} {}
one sig var0toNUM5var1toNUM5var2toNUM2 extends Env {} {}
one sig var1toNUM8var0toNUM5 extends Env {} {}
one sig var0toNUM8var1toNUM5 extends Env {} {}
one sig var0toNUM3var2toNUM1var1toNUM8 extends Env {} {}
one sig var1toNUM3var2toNUM1var0toNUM8 extends Env {} {}
one sig var0toNUM8 extends Env {} {}
one sig var0toNUM3var1toNUM8var2toNUM2 extends Env {} {}
one sig var1toNUM3var0toNUM8var2toNUM2 extends Env {} {}
one sig var2toNUM0var1toNUM8var0toNUM5 extends Env {} {}
one sig var2toNUM0var0toNUM8var1toNUM5 extends Env {} {}
one sig var0toNUM3var2toNUM0var1toNUM8 extends Env {} {}
one sig var1toNUM3var2toNUM0var0toNUM8 extends Env {} {}
one sig var2toNUM1var0toNUM5var1toNUM5 extends Env {} {}
one sig var0toNUM5var1toNUM5 extends Env {} {}
one sig var1toNUM3var2toNUM1var0toNUM5 extends Env {} {}
one sig var0toNUM3var2toNUM1var1toNUM5 extends Env {} {}
one sig var1toNUM3var0toNUM5var2toNUM2 extends Env {} {}
one sig var0toNUM3var1toNUM5var2toNUM2 extends Env {} {}
one sig var0toNUM3var1toNUM8 extends Env {} {}
one sig var1toNUM3var0toNUM8 extends Env {} {}
one sig var2toNUM0var0toNUM5var1toNUM5 extends Env {} {}


fact PartialInstance {
	maps = var0toNUM3->(var0->NUM3) +
		var0toNUM3var1toNUM3var2toNUM2->(var0->NUM3 + var1->NUM3 + var2->NUM2) +
		var1toNUM3var2toNUM0var0toNUM5->(var1->NUM3 + var2->NUM0 + var0->NUM5) +
		var0toNUM3var2toNUM0var1toNUM5->(var0->NUM3 + var2->NUM0 + var1->NUM5) +
		var0toNUM3var1toNUM3->(var0->NUM3 + var1->NUM3) +
		var0toNUM3var1toNUM3var2toNUM0->(var0->NUM3 + var1->NUM3 + var2->NUM0) +
		var1toNUM3var0toNUM5->(var1->NUM3 + var0->NUM5) +
		var0toNUM3var1toNUM5->(var0->NUM3 + var1->NUM5) +
		var0toNUM3var1toNUM3var2toNUM1->(var0->NUM3 + var1->NUM3 + var2->NUM1) +
		var2toNUM1var0toNUM8var1toNUM8->(var2->NUM1 + var0->NUM8 + var1->NUM8) +
		var0toNUM8var1toNUM8->(var0->NUM8 + var1->NUM8) +
		var0toNUM8var1toNUM8var2toNUM2->(var0->NUM8 + var1->NUM8 + var2->NUM2) +
		var0toNUM5->(var0->NUM5) +
		var2toNUM0var0toNUM8var1toNUM8->(var2->NUM0 + var0->NUM8 + var1->NUM8) +
		var2toNUM1var1toNUM8var0toNUM5->(var2->NUM1 + var1->NUM8 + var0->NUM5) +
		var2toNUM1var0toNUM8var1toNUM5->(var2->NUM1 + var0->NUM8 + var1->NUM5) +
		var1toNUM8var0toNUM5var2toNUM2->(var1->NUM8 + var0->NUM5 + var2->NUM2) +
		var0toNUM8var1toNUM5var2toNUM2->(var0->NUM8 + var1->NUM5 + var2->NUM2) +
		var0toNUM5var1toNUM5var2toNUM2->(var0->NUM5 + var1->NUM5 + var2->NUM2) +
		var1toNUM8var0toNUM5->(var1->NUM8 + var0->NUM5) +
		var0toNUM8var1toNUM5->(var0->NUM8 + var1->NUM5) +
		var0toNUM3var2toNUM1var1toNUM8->(var0->NUM3 + var2->NUM1 + var1->NUM8) +
		var1toNUM3var2toNUM1var0toNUM8->(var1->NUM3 + var2->NUM1 + var0->NUM8) +
		var0toNUM8->(var0->NUM8) +
		var0toNUM3var1toNUM8var2toNUM2->(var0->NUM3 + var1->NUM8 + var2->NUM2) +
		var1toNUM3var0toNUM8var2toNUM2->(var1->NUM3 + var0->NUM8 + var2->NUM2) +
		var2toNUM0var1toNUM8var0toNUM5->(var2->NUM0 + var1->NUM8 + var0->NUM5) +
		var2toNUM0var0toNUM8var1toNUM5->(var2->NUM0 + var0->NUM8 + var1->NUM5) +
		var0toNUM3var2toNUM0var1toNUM8->(var0->NUM3 + var2->NUM0 + var1->NUM8) +
		var1toNUM3var2toNUM0var0toNUM8->(var1->NUM3 + var2->NUM0 + var0->NUM8) +
		var2toNUM1var0toNUM5var1toNUM5->(var2->NUM1 + var0->NUM5 + var1->NUM5) +
		var0toNUM5var1toNUM5->(var0->NUM5 + var1->NUM5) +
		var1toNUM3var2toNUM1var0toNUM5->(var1->NUM3 + var2->NUM1 + var0->NUM5) +
		var0toNUM3var2toNUM1var1toNUM5->(var0->NUM3 + var2->NUM1 + var1->NUM5) +
		var1toNUM3var0toNUM5var2toNUM2->(var1->NUM3 + var0->NUM5 + var2->NUM2) +
		var0toNUM3var1toNUM5var2toNUM2->(var0->NUM3 + var1->NUM5 + var2->NUM2) +
		var0toNUM3var1toNUM8->(var0->NUM3 + var1->NUM8) +
		var1toNUM3var0toNUM8->(var1->NUM3 + var0->NUM8) +
		var2toNUM0var0toNUM5var1toNUM5->(var2->NUM0 + var0->NUM5 + var1->NUM5)

	baseName = DeleteNUM2NUM5->Delete +
		DeleteNUM2NUM3->Delete +
		SendNUM1NUM5->Send +
		SendNUM1NUM3->Send +
		SendNUM0NUM3->Send +
		DeleteNUM0NUM3->Delete +
		PropagateNUM1NUM3->Propagate +
		DeleteNUM0NUM5->Delete +
		SendNUM2NUM3->Send +
		PropagateNUM2NUM3->Propagate +
		SendNUM0NUM5->Send +
		DeleteNUM1NUM3->Delete +
		DeleteNUM1NUM5->Delete
}
...
one sig PosState24 extends PosState {} {
    ...
    act = PropagateNUM1NUM3
}

one sig PosState25 extends PosState {} {
    prevState = PosState24
    act = DeleteNUM2NUM3
}
...
one sig NegState29 extends NegState {} {
    prevState = PosState2
    act = DeleteNUM0NUM5
}
