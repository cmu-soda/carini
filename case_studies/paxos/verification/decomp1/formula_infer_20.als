...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT10->T1) + (PT1->T3) + (PT7->T1) + (PT11->T1) + (PT2->T1) + (PT6->T1) + (PT4->T1) + (NT1->T3)

	path = (PT10 -> (T0->Phase2aNUM1v1a1 + T1->Phase2aNUM1v2a1)) +
	...
	maps = var1toNUM1var2toa1var0toa2->(var1->NUM1 + var2->a1 + var0->a2) +
