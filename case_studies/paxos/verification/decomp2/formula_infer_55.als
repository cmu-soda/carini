...
fun envVarTypes : set(Var->Sort) {
	var2->Quorum + var1->Acceptor + var0->Acceptor
}
...
one sig var0toa3var2to_a1a2_var1toa1 extends Env {} {}
one sig var2to_a1a2_var1toa2var0toa2 extends Env {} {}
one sig var1toa3var2to_a1a2_var0toa1 extends Env {} {}
one sig var0toa3var1toa3 extends Env {} {}
one sig var0toa3var2to_a1a2_var1toa2 extends Env {} {}
one sig var1toa3var2to_a1a2_var0toa2 extends Env {} {}
one sig var0toa3var1toa3var2to_a1a2_ extends Env {} {}
one sig var0toa1var1toa1var2to_a2a3_ extends Env {} {}
one sig var1toa1var2to_a2a3_var0toa2 extends Env {} {}
one sig var0toa1var2to_a2a3_var1toa2 extends Env {} {}
one sig var2to_a1a3_var0toa1var1toa1 extends Env {} {}
one sig var0toa1 extends Env {} {}
one sig var2to_a1a3_var1toa1var0toa2 extends Env {} {}
one sig var2to_a1a3_var0toa1var1toa2 extends Env {} {}
one sig var0toa3var1toa1var2to_a2a3_ extends Env {} {}
one sig var2to_a2a3_var1toa2var0toa2 extends Env {} {}
one sig var1toa3var0toa1var2to_a2a3_ extends Env {} {}
one sig var2to_a1a3_var0toa3var1toa1 extends Env {} {}
one sig var2to_a1a3_var1toa2var0toa2 extends Env {} {}
one sig var2to_a1a3_var1toa3var0toa1 extends Env {} {}
one sig var0toa3var2to_a2a3_var1toa2 extends Env {} {}
one sig var1toa3var2to_a2a3_var0toa2 extends Env {} {}
one sig var0toa2 extends Env {} {}
one sig var2to_a1a2a3_var0toa1var1toa1 extends Env {} {}
one sig var2to_a1a3_var0toa3var1toa2 extends Env {} {}
one sig var2to_a1a3_var1toa3var0toa2 extends Env {} {}
one sig var0toa3var1toa3var2to_a2a3_ extends Env {} {}
one sig var0toa3 extends Env {} {}
one sig var2to_a1a2a3_var1toa1var0toa2 extends Env {} {}
one sig var2to_a1a2a3_var0toa1var1toa2 extends Env {} {}
one sig var2to_a1a2a3_var0toa3var1toa1 extends Env {} {}
one sig var2to_a1a2a3_var1toa2var0toa2 extends Env {} {}
one sig var2to_a1a2a3_var1toa3var0toa1 extends Env {} {}
one sig var2to_a1a3_var0toa3var1toa3 extends Env {} {}
one sig var2to_a1a2a3_var0toa3var1toa2 extends Env {} {}
one sig var2to_a1a2a3_var1toa3var0toa2 extends Env {} {}
one sig var0toa1var1toa1 extends Env {} {}
one sig var2to_a1a2a3_var0toa3var1toa3 extends Env {} {}
one sig var2to_a1a2_var0toa1var1toa1 extends Env {} {}
one sig var1toa1var0toa2 extends Env {} {}
one sig var0toa1var1toa2 extends Env {} {}
one sig var2to_a1a2_var1toa1var0toa2 extends Env {} {}
one sig var2to_a1a2_var0toa1var1toa2 extends Env {} {}
...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT19->T1) + (PT14->T1) + (PT23->T2) + (PT26->T2) + (PT30->T2) + (PT15->T1) + (PT11->T0) + (PT31->T2) + (PT1->T1) + (PT7->T1) + (PT28->T2) + (PT27->T2) + (PT8->T0) + (PT21->T2) + (PT24->T2) + (NT1->T2)

	path = (PT19 -> (T0->Phase2aNUM0v2a1_a1a2_ + T1->Phase2ba1NUM0v1)) +
		(PT14 -> (T0->Phase2aNUM1v1a1_a1a2_ + T1->Phase2ba1NUM1v1)) +
	...
	maps = var0toa3var1toa2->(var0->a3 + var1->a2) +
		...
		var0toa3var2to_a1a2_var1toa1->(var0->a3 + var2->_a1a2_ + var1->a1) +
		var2to_a1a2_var1toa2var0toa2->(var2->_a1a2_ + var1->a2 + var0->a2) +
		var1toa3var2to_a1a2_var0toa1->(var1->a3 + var2->_a1a2_ + var0->a1) +
		var0toa3var1toa3->(var0->a3 + var1->a3) +
		var0toa3var2to_a1a2_var1toa2->(var0->a3 + var2->_a1a2_ + var1->a2) +
		var1toa3var2to_a1a2_var0toa2->(var1->a3 + var2->_a1a2_ + var0->a2) +
		var0toa3var1toa3var2to_a1a2_->(var0->a3 + var1->a3 + var2->_a1a2_) +
		var0toa1var1toa1var2to_a2a3_->(var0->a1 + var1->a1 + var2->_a2a3_) +
		var1toa1var2to_a2a3_var0toa2->(var1->a1 + var2->_a2a3_ + var0->a2) +
		var0toa1var2to_a2a3_var1toa2->(var0->a1 + var2->_a2a3_ + var1->a2) +
		var2to_a1a3_var0toa1var1toa1->(var2->_a1a3_ + var0->a1 + var1->a1) +
		var0toa1->(var0->a1) +
		var2to_a1a3_var1toa1var0toa2->(var2->_a1a3_ + var1->a1 + var0->a2) +
		var2to_a1a3_var0toa1var1toa2->(var2->_a1a3_ + var0->a1 + var1->a2) +
		var0toa3var1toa1var2to_a2a3_->(var0->a3 + var1->a1 + var2->_a2a3_) +
		var2to_a2a3_var1toa2var0toa2->(var2->_a2a3_ + var1->a2 + var0->a2) +
		var1toa3var0toa1var2to_a2a3_->(var1->a3 + var0->a1 + var2->_a2a3_) +
		var2to_a1a3_var0toa3var1toa1->(var2->_a1a3_ + var0->a3 + var1->a1) +
		var2to_a1a3_var1toa2var0toa2->(var2->_a1a3_ + var1->a2 + var0->a2) +
		var2to_a1a3_var1toa3var0toa1->(var2->_a1a3_ + var1->a3 + var0->a1) +
		var0toa3var2to_a2a3_var1toa2->(var0->a3 + var2->_a2a3_ + var1->a2) +
		var1toa3var2to_a2a3_var0toa2->(var1->a3 + var2->_a2a3_ + var0->a2) +
		var0toa2->(var0->a2) +
		var2to_a1a2a3_var0toa1var1toa1->(var2->_a1a2a3_ + var0->a1 + var1->a1) +
		var2to_a1a3_var0toa3var1toa2->(var2->_a1a3_ + var0->a3 + var1->a2) +
		var2to_a1a3_var1toa3var0toa2->(var2->_a1a3_ + var1->a3 + var0->a2) +
		var0toa3var1toa3var2to_a2a3_->(var0->a3 + var1->a3 + var2->_a2a3_) +
		var0toa3->(var0->a3) +
		var2to_a1a2a3_var1toa1var0toa2->(var2->_a1a2a3_ + var1->a1 + var0->a2) +
		var2to_a1a2a3_var0toa1var1toa2->(var2->_a1a2a3_ + var0->a1 + var1->a2) +
		var2to_a1a2a3_var0toa3var1toa1->(var2->_a1a2a3_ + var0->a3 + var1->a1) +
		var2to_a1a2a3_var1toa2var0toa2->(var2->_a1a2a3_ + var1->a2 + var0->a2) +
		var2to_a1a2a3_var1toa3var0toa1->(var2->_a1a2a3_ + var1->a3 + var0->a1) +
		var2to_a1a3_var0toa3var1toa3->(var2->_a1a3_ + var0->a3 + var1->a3) +
		var2to_a1a2a3_var0toa3var1toa2->(var2->_a1a2a3_ + var0->a3 + var1->a2) +
		var2to_a1a2a3_var1toa3var0toa2->(var2->_a1a2a3_ + var1->a3 + var0->a2) +
		var0toa1var1toa1->(var0->a1 + var1->a1) +
		var2to_a1a2a3_var0toa3var1toa3->(var2->_a1a2a3_ + var0->a3 + var1->a3) +
		var2to_a1a2_var0toa1var1toa1->(var2->_a1a2_ + var0->a1 + var1->a1) +
		var1toa1var0toa2->(var1->a1 + var0->a2) +
		var0toa1var1toa2->(var0->a1 + var1->a2) +
		var2to_a1a2_var1toa1var0toa2->(var2->_a1a2_ + var1->a1 + var0->a2) +
		var2to_a1a2_var0toa1var1toa2->(var2->_a1a2_ + var0->a1 + var1->a2) +
