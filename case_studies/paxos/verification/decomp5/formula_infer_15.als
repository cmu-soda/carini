...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT3->T2) + (PT5->T3) + (PT7->T4) + (PT1->T7) + (PT6->T1) + (PT4->T2) + (PT8->T4) + (NT1->T9)

	path = (PT3 -> (T0->Phase1ba1NUM0 + T1->Phase2aNUM0v1a2 + T2->Phase2ba1NUM0v1)) +
		(PT5 -> (T0->Phase2aNUM0v1a1 + T1->Phase2aNUM1v2a3 + T2->Phase2ba1NUM0v1 + T3->Phase2ba1NUM1v2)) +
