...
fun envVarTypes : set(Var->Sort) {
	var2->Address + var1->Address + var0->Core
}
...
one sig var0toc2var1toa1var2toa1 extends Env {} {}
one sig var0toc1var2toa1var1toa2 extends Env {} {}
one sig var2toa2var0toc1var1toa1 extends Env {} {}
one sig var0toc2var2toa1var1toa2 extends Env {} {}
one sig var2toa2var0toc2var1toa1 extends Env {} {}
one sig var2toa2var0toc1var1toa2 extends Env {} {}
one sig var0toc2var1toa1 extends Env {} {}
one sig var0toc1 extends Env {} {}
one sig var0toc1var1toa2 extends Env {} {}
one sig var0toc1var1toa1var2toa1 extends Env {} {}
one sig var0toc1var1toa1 extends Env {} {}
one sig var0toc2 extends Env {} {}
one sig var0toc2var1toa2 extends Env {} {}
one sig var2toa2var0toc2var1toa2 extends Env {} {}


fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT34->T4) + (PT1->T8) + (PT11->T4) + (PT28->T6) + (PT27->T7) + (PT39->T7) + (PT26->T3) + (PT23->T3) + (PT31->T4) + (PT36->T4) + (PT44->T5) + (PT21->T5) + (PT50->T6) + (PT48->T5) + (PT6->T3) + (PT40->T7) + (PT32->T5) + (PT9->T4) + (PT49->T6) + (PT14->T3) + (PT35->T6) + (PT46->T5) + (PT10->T4) + (PT17->T4) + (PT43->T5) + (NT1->T8)
	...
	maps = var0toc2var1toa1var2toa1->(var0->c2 + var1->a1 + var2->a1) +
		var0toc1var2toa1var1toa2->(var0->c1 + var2->a1 + var1->a2) +
		var2toa2var0toc1var1toa1->(var2->a2 + var0->c1 + var1->a1) +
		var0toc2var2toa1var1toa2->(var0->c2 + var2->a1 + var1->a2) +
		var2toa2var0toc2var1toa1->(var2->a2 + var0->c2 + var1->a1) +
		var2toa2var0toc1var1toa2->(var2->a2 + var0->c1 + var1->a2) +
		var0toc2var1toa1->(var0->c2 + var1->a1) +
		var0toc1->(var0->c1) +
		var0toc1var1toa2->(var0->c1 + var1->a2) +
		var0toc1var1toa1var2toa1->(var0->c1 + var1->a1 + var2->a1) +
		var0toc1var1toa1->(var0->c1 + var1->a1) +
		var0toc2->(var0->c2) +
		var0toc2var1toa2->(var0->c2 + var1->a2) +
		var2toa2var0toc2var1toa2->(var2->a2 + var0->c2 + var1->a2)
